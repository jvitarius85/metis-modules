...
<form method="post" class="mw-settings-form" data-metis-settings-form="1">
    <?php metis_nonce_field( 'metis_save_settings_help', 'metis_settings_nonce' ); ?>
    <div class="mw-settings-card">
        <div class="mw-settings-header"><h2>Help Availability</h2></div>
        <div class="mw-settings-body">
            <label class="mw-accessibility-option"><input type="checkbox" name="help_enabled" value="1" <?php checked( $help_enabled ); ?>> Enable contextual help mode</label>
            <label class="mw-accessibility-option"><input type="checkbox" name="walkthrough_enabled" value="1" <?php checked( $walkthrough_enabled ); ?>> Enable guided walkthroughs</label>
