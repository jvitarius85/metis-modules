...
if ( $donor_id === '' ) : ?>
    ...
    <a href="<?php echo esc_url( $base_url . '/donors/' ); ?>" class="mw-btn mw-btn-xs">← Back to Donors</a>
    <?php return;
endif;
...
<h1 class="mw-page-title"><?php echo esc_html( $full_name ?: $donor->email ?: 'Donor' ); ?></h1>
<p class="mw-subtitle">Detailed giving history for this donor.</p>
<p><a href="<?php echo esc_url( $base_url . '/donors/' ); ?>" class="mw-btn mw-btn-xs">← Back to Donors</a></p>

<!-- SUMMARY CARD -->
<div class="mw-premium-row mw-donor-summary">
    <div class="mw-premium-cell">
        <div class="mw-muted mw-label">Name</div>
        <div class="mw-value"><?php echo esc_html( $full_name ?: '—' ); ?></div>
    </div>
    <div class="mw-premium-cell">
        <div class="mw-muted mw-label">Email</div>
        <div class="mw-value"><?php echo esc_html( $donor->email ?: '—' ); ?></div>
    </div>
    <div class="mw-premium-cell">
    ...
    <?php if ( ! empty( $transactions ) ) : ?>
        ...
        ?>
            <div class="mw-premium-row mw-donor-tx-row"
                 ...
                 tabindex="0">
                <div class="mw-premium-cell"><?php echo esc_html( $display_date ); ?></div>
                <div class="mw-premium-cell"><?php echo esc_html( $campaign ); ?></div>
                <div class="mw-premium-cell"><?php echo esc_html( metis_platform_label( $t->platform ) ); ?></div>
