        ...
        modal.innerHTML = '' +
            '<div class="mw-modal metis-help-search-modal__dialog">' +
                ...
                '<div class="mw-modal-body">' +
                    '<input type="search" class="mw-input metis-help-search-modal__input" placeholder="Search help topics, docs, or walkthroughs">' +
                    '<div class="metis-help-search-modal__results"></div>' +
                '</div>' +
            '</div>';

        document.body.appendChild(modal);
        if (window.Metis && Metis.modal) {
            Metis.modal.init(modal);
        }
