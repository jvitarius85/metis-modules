...
$cssPath = __DIR__ . '/metis-errors.css';
$inlineCss = is_readable( $cssPath ) ? (string) file_get_contents( $cssPath ) : '';
if ( $inlineCss === '' ) {
...
$logoPath = __DIR__ . '/metis-shield-logo.png';
$logoSrc = '/assets/error-pages/metis-shield-logo.png';
