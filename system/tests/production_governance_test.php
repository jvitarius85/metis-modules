...
$assert( str_contains( $websiteThemeService, 'menuPresetConfig' ) && str_contains( $websiteThemeService, "'h_glide'" ) && str_contains( $websiteThemeService, '$menu_mobile_breakpoint = 980' ) && ! str_contains( $websiteThemeService, 'legacyMenuStyleFromLayout' ) && ! str_contains( $websiteRenderer, 'metis-menu-mobile-overlay' ) && ! str_contains( $websiteRenderer, 'data-metis-nav-mobile-type' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_glide' ) && str_contains( $websiteRenderer, 'codepenGlideMenuCss' ) && str_contains( $websiteRenderer, ':last-child::after' ) && str_contains( $websiteRenderer, '#e91e63' ) && str_contains( $websiteRenderer, 'flex:0 0 auto' ) && str_contains( $websiteRenderer, 'font-size:max(var(--metis-menu-font-size' ) && str_contains( $websiteRenderer, 'white-space:nowrap' ) && str_contains( $websiteRenderer, 'gap:0 !important' ) && str_contains( $websiteRenderer, 'cubic-bezier(1,.49,.09,1.29)' ) && str_contains( $websiteRenderer, '150 * $position' ) && str_contains( $websiteRenderer, 'isHomepageComparablePath' ) && str_contains( $websiteThemeView, 'metis-theme-menu-preview-row' ) && str_contains( $websiteThemeView, "removeClass('is-active is-active-ancestor')" ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_glide' ) && ! str_contains( $websitePublicNavigation, 'setupGlideMenus' ) && ! str_contains( $websitePublicNavigation, 'item.offsetWidth' ), 'Public website renderer must render Glide Gradient as a governed preset with original CodePen tint, content-aware desktop sizing, homepage-active suppression, and no JavaScript geometry writes.' );
$assert( str_contains( $websiteThemeView, "'h_marker_dropdown' => 'Marker Dropdown'" ) && str_contains( $websiteThemeService, "'h_marker_dropdown'" ) && str_contains( $websiteRenderer, 'markerDropdownMenuCss' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_marker_dropdown' ) && str_contains( $websiteRenderer, '--metis-marker-count' ) && str_contains( $websiteRenderer, 'min-width:500px' ) && str_contains( $websiteRenderer, 'height:100%' ) && str_contains( $websiteRenderer, 'visibility:hidden !important' ) && str_contains( $websiteRenderer, 'translate(0,-100%)' ) && str_contains( $websiteRenderer, '--metis-marker-index' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_marker_dropdown' ) && ! str_contains( $websiteThemeAdminCss, '--metis-marker-left' ) && ! str_contains( $websitePublicNavigation, '--metis-marker-left' ), 'Public website renderer must expose Marker Dropdown as a squared-off preset with CSS-owned marker movement and fully hidden slide-down submenus.' );
