...
$assert( str_contains( $ajaxRuntime, 'Metis_Code_Registry::search' ) && str_contains( $ajaxRuntime, '$max_results = 25' ), 'Core AJAX code lookup must include bounded keyword matches without creating a second lookup endpoint.' );
...
$assert( str_contains( $websiteThemeView, 'metis-theme-menu-style' ) && str_contains( $websiteThemeView, "'h_glide' => 'Glide Gradient'" ) && str_contains( $websiteThemeView, "'h_marker_dropdown' => 'Marker Dropdown'" ) && str_contains( $websiteThemeView, "'h_pill_dropdown' => 'Pill Dropdown'" ) && str_contains( $websiteThemeView, "'h_modern_bar' => 'Modern Bar'" ) && ! str_contains( $websiteThemeView, "'h_solid_bar' => 'Solid Bar'" ) && ! str_contains( $websiteThemeView, "'h_clean' => 'Clean'" ) && str_contains( $websiteThemeView, 'menuPresetDefinitions' ) && ! str_contains( $websiteThemeView, 'metis-theme-menu-font-size' ) && ! str_contains( $websiteThemeView, 'metis-theme-menu-color' ) && ! str_contains( $websiteThemeView, 'menuStyleFromLayout' ), 'Website theme editor must expose only governed public menu presets without custom desktop/dropdown/mobile controls or layout fallback mapping.' );
$assert( str_contains( $websiteThemeService, 'menuPresetConfig' ) && str_contains( $websiteThemeService, "'h_glide'" ) && str_contains( $websiteThemeService, "'font_size' => 19" ) && str_contains( $websiteThemeService, '$menu_mobile_breakpoint = 980' ) && ! str_contains( $websiteThemeService, 'legacyMenuStyleFromLayout' ) && ! str_contains( $websiteRenderer, 'metis-menu-mobile-overlay' ) && ! str_contains( $websiteRenderer, 'data-metis-nav-mobile-type' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_glide' ) && str_contains( $websiteRenderer, 'codepenGlideMenuCss' ) && str_contains( $websiteRenderer, ':last-child::after' ) && str_contains( $websiteRenderer, '--metis-glide-primary:var(--metis-color-primary' ) && str_contains( $websiteRenderer, '--metis-glide-accent:var(--metis-color-accent' ) && str_contains( $websiteRenderer, '--metis-glide-item-width:15rem' ) && str_contains( $websiteRenderer, 'flex:0 0 var(--metis-glide-item-width' ) && str_contains( $websiteRenderer, 'text-overflow:ellipsis' ) && str_contains( $websiteRenderer, 'stickyHeaderCss' ) && str_contains( $websiteRenderer, 'is-scrolled' ) && str_contains( $websiteRenderer, 'white-space:nowrap' ) && str_contains( $websiteRenderer, 'gap:0 !important' ) && str_contains( $websiteRenderer, 'cubic-bezier(1,.49,.09,1.29)' ) && str_contains( $websiteRenderer, '150 * $position' ) && str_contains( $websiteRenderer, 'isHomepageComparablePath' ) && str_contains( $websiteThemeView, 'metis-theme-menu-preview-row' ) && str_contains( $websiteThemeView, 'renderThemeMenuPreviewCss' ) && str_contains( $websiteThemeView, 'font_size: 19' ) && str_contains( $websiteThemeView, "removeClass('is-active is-active-ancestor')" ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_glide' ) && str_contains( $websiteThemeAdminCss, '--metis-glide-item-width:15rem' ) && ! str_contains( $websiteRenderer, '#e91e63' ) && ! str_contains( $websiteThemeAdminCss, '#e91e63' ) && ! str_contains( $websitePublicNavigation, 'setupGlideMenus' ) && ! str_contains( $websitePublicNavigation, 'item.offsetWidth' ), 'Public website renderer must render Glide Gradient as a governed preset with exact theme colors, deterministic desktop slot sizing, rendered theme preview parity, sticky shrink behavior, homepage-active suppression, and no JavaScript geometry writes.' );
$assert( str_contains( $websiteThemeView, "'h_marker_dropdown' => 'Marker Dropdown'" ) && str_contains( $websiteThemeService, "'h_marker_dropdown'" ) && str_contains( $websiteRenderer, 'markerDropdownMenuCss' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_marker_dropdown' ) && str_contains( $websiteRenderer, '--metis-marker-count' ) && str_contains( $websiteRenderer, '--metis-marker-bg:var(--metis-color-primary' ) && str_contains( $websiteRenderer, '--metis-marker-accent:var(--metis-color-accent' ) && str_contains( $websiteRenderer, 'min-width:500px' ) && str_contains( $websiteRenderer, 'height:100%' ) && str_contains( $websiteRenderer, 'visibility:hidden !important' ) && str_contains( $websiteRenderer, 'translate(0,-100%)' ) && str_contains( $websiteRenderer, '--metis-marker-index' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_marker_dropdown' ) && str_contains( $websiteThemeAdminCss, '--metis-marker-bg:var(--metis-color-primary' ) && ! str_contains( $websiteThemeAdminCss, '--metis-marker-left' ) && ! str_contains( $websiteThemeAdminCss, '#34495e' ) && ! str_contains( $websitePublicNavigation, '--metis-marker-left' ), 'Public website renderer must expose Marker Dropdown as a squared-off exact-theme-colored preset with CSS-owned marker movement and fully hidden slide-down submenus.' );
