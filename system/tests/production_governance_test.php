...
$assert( str_contains( $websiteThemeView, "'h_marker_dropdown' => 'Marker Dropdown'" ) && str_contains( $websiteThemeService, "'h_marker_dropdown'" ) && str_contains( $websiteRenderer, 'markerDropdownMenuCss' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_marker_dropdown' ) && str_contains( $websiteRenderer, '--metis-marker-width' ) && str_contains( $websiteRenderer, 'translateY(-110%)' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_marker_dropdown' ) && str_contains( $websitePublicNavigation, '--metis-marker-left' ), 'Public website renderer must expose, sanitize, render, preview, and align the theme-colored Marker Dropdown menu style.' );
