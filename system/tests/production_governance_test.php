...
$assert( str_contains( $websiteThemeView, 'metis-theme-menu-style' ) && str_contains( $websiteThemeView, "'h_glide' => 'Glide Gradient'" ) && str_contains( $websiteThemeView, "'h_solid_bar' => 'Solid Bar'" ) && str_contains( $websiteThemeView, 'menuPresetDefinitions' ) && ! str_contains( $websiteThemeView, 'metis-theme-menu-font-size' ) && ! str_contains( $websiteThemeView, 'metis-theme-menu-color' ) && ! str_contains( $websiteThemeView, 'menuStyleFromLayout' ), 'Website theme editor must expose preset-only public menu styles without custom desktop/dropdown/mobile controls or layout fallback mapping.' );
$assert( str_contains( $websiteThemeService, 'menuPresetConfig' ) && str_contains( $websiteThemeService, "'h_glide'" ) && str_contains( $websiteThemeService, '$menu_mobile_breakpoint = 980' ) && ! str_contains( $websiteThemeService, 'legacyMenuStyleFromLayout' ) && ! str_contains( $websiteRenderer, 'metis-menu-mobile-overlay' ) && ! str_contains( $websiteRenderer, 'data-metis-nav-mobile-type' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_glide' ) && str_contains( $websiteRenderer, 'codepenGlideMenuCss' ) && str_contains( $websiteRenderer, ':last-child::after' ) && str_contains( $websiteRenderer, 'font-size:1.6vw' ) && str_contains( $websiteRenderer, 'white-space:nowrap' ) && str_contains( $websiteRenderer, 'gap:0 !important' ) && str_contains( $websiteRenderer, 'cubic-bezier(1,.49,.09,1.29)' ) && str_contains( $websiteRenderer, '150 * $position' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_glide' ) && ! str_contains( $websitePublicNavigation, 'setupGlideMenus' ) && ! str_contains( $websitePublicNavigation, 'item.offsetWidth' ), 'Public website renderer must render Glide Gradient as a preset with CSS-owned alignment, fixed slide mobile behavior, and no JavaScript geometry writes.' );
$assert( str_contains( $websiteThemeView, "'h_marker_dropdown' => 'Marker Dropdown'" ) && str_contains( $websiteThemeService, "'h_marker_dropdown'" ) && str_contains( $websiteRenderer, 'markerDropdownMenuCss' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_marker_dropdown' ) && str_contains( $websiteRenderer, '--metis-marker-count' ) && str_contains( $websiteRenderer, 'width:min(900px,100%)' ) && str_contains( $websiteRenderer, 'translate(0,-100%)' ) && str_contains( $websiteRenderer, '--metis-marker-index' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_marker_dropdown' ) && ! str_contains( $websiteThemeAdminCss, '--metis-marker-left' ) && ! str_contains( $websitePublicNavigation, '--metis-marker-left' ), 'Public website renderer must expose Marker Dropdown as a preset with CSS-owned marker movement and slide-down submenu behavior.' );
