...
$assert( str_contains( $websiteThemeView, 'metis-theme-menu-style' ) && str_contains( $websiteThemeView, "'h_glide' => 'Glide Gradient'" ), 'Website theme editor must expose the public Glide Gradient menu style dropdown.' );
$assert( str_contains( $websiteThemeService, "'h_glide'" ) && str_contains( $websiteRenderer, 'metis-menu-style-h_glide' ) && str_contains( $websiteRenderer, 'codepenGlideMenuCss' ) && str_contains( $websiteRenderer, '--metis-glide-index' ) && str_contains( $websiteRenderer, '--metis-glide-width' ) && str_contains( $websiteRenderer, 'white-space:nowrap' ) && str_contains( $websiteRenderer, 'gap:0 !important' ) && str_contains( $websiteRenderer, 'cubic-bezier(1,.49,.09,1.29)' ) && str_contains( $websiteRenderer, '150 * $position' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_glide' ) && str_contains( $websitePublicNavigation, 'setupGlideMenus' ) && str_contains( $websitePublicNavigation, 'item.offsetWidth' ), 'Public website renderer must sanitize, render, preview, and preserve aligned non-wrapping CodePen-style Glide Gradient menu behavior.' );
$assert( str_contains( $websiteThemeView, "'h_marker_dropdown' => 'Marker Dropdown'" ) && str_contains( $websiteThemeService, "'h_marker_dropdown'" ) && str_contains( $websiteRenderer, 'markerDropdownMenuCss' ) && str_contains( $websiteRenderer, 'metis-menu-style-h_marker_dropdown' ) && str_contains( $websiteRenderer, '--metis-marker-width' ) && str_contains( $websiteRenderer, 'translate(0,-100%)' ) && str_contains( $websiteRenderer, '--metis-marker-index' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_marker_dropdown' ) && str_contains( $websitePublicNavigation, '--metis-marker-left' ), 'Public website renderer must expose, sanitize, render, preview, and align the theme-colored Marker Dropdown menu style.' );
