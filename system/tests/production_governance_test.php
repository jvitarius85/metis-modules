...
$assert( str_contains( $websiteThemeService, "'h_glide'" ) && str_contains( $websiteRenderer, 'metis-menu-style-h_glide' ) && str_contains( $websiteThemeAdminCss, '.metis-theme-menu-live.metis-menu-style-h_glide' ), 'Public website renderer must sanitize, render, and preview the Glide Gradient menu style.' );
