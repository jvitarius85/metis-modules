...
final class WebsiteRenderer {
    ...
    private static function pillDropdownMenuCss( string $scope ): string {
        ...
        $rules = [
            ...
            $mobile_item . '.is-open > .metis-shell-menu-sub{max-height:32rem;}',
    ...
    private static function codepenGlideMenuCss( string $scope ): string {
        ...
        $rules = [
            ...
            $mobile_item . '.has-children.is-open > .metis-shell-menu-link .metis-shell-menu-sub-indicator,' . $mobile_item . '.has-children.is-open > .metis-shell-menu-btn .metis-shell-menu-sub-indicator{transform:rotate(225deg) translate(1px,50%);}',
            ...
            $mobile_item . '.is-open > .metis-shell-menu-sub{max-height:16rem;}',
