...
final class WebsiteRenderer {
    ...
    private static function mobileFlyoutMenuHardeningCss(): string {
        return '@media (max-width: 980px){body.metis-nav-mobile-viewport .metis-shell-nav-toggle{z-index:2110 !important;}body.metis-nav-mobile-viewport .metis-shell-nav-primary{z-index:2100 !important;isolation:isolate;}body.metis-nav-mobile-viewport.metis-nav-open::before{z-index:2000 !important;pointer-events:none !important;}body.metis-nav-mobile-viewport.metis-nav-open .metis-shell-nav-primary{z-index:2100 !important;visibility:visible !important;pointer-events:auto !important;transform:translateX(0) !important;}body.metis-nav-mobile-viewport .metis-shell-nav-primary .metis-shell-menu-item.has-children:not(.is-open) > .metis-shell-menu-sub{max-height:0 !important;overflow:hidden !important;}body.metis-nav-mobile-viewport .metis-shell-nav-primary .metis-shell-menu-item.has-children.is-open > .metis-shell-menu-sub{max-height:40rem !important;overflow:hidden !important;}body.metis-nav-mobile-viewport .metis-shell-nav-primary .metis-shell-menu-item.has-children.is-open > .metis-shell-menu-link .metis-shell-menu-sub-indicator,body.metis-nav-mobile-viewport .metis-shell-nav-primary .metis-shell-menu-item.has-children.is-open > .metis-shell-menu-btn .metis-shell-menu-sub-indicator{transform:rotate(225deg) translate(1px,50%) !important;}}';
    }
