...
final class WebsiteRenderer {
    ...
    private static function codepenGlideMenuCss( string $scope ): string {
        ...
        $rules = [
            $scope . '{--metis-glide-primary:#e91e63;--metis-glide-accent:#f44336;padding:0 !important;border:0 !important;border-radius:.5rem !important;background-image:linear-gradient(to right,#e91e63 0%,#f44336 100%);box-shadow:inset .1rem .1rem .5rem rgba(0,0,0,.15),0 12px 28px rgba(15,23,42,.13);text-transform:uppercase !important;overflow:visible !important;}',
            $list . '{position:relative;display:flex !important;flex-wrap:nowrap !important;gap:0 !important;align-items:stretch !important;justify-content:flex-start !important;width:max-content;min-width:max-content;max-width:100%;margin:0 !important;padding:0 !important;list-style:none !important;overflow:visible !important;}',
            $item . '{position:relative;display:flex !important;align-items:center !important;justify-content:center !important;flex:0 0 auto !important;width:auto !important;min-width:max-content;margin:0 !important;padding:0 !important;border:0 !important;list-style:none !important;z-index:1;}',
            ...
            $item . ' > .metis-shell-menu-link,' . $item . ' > .metis-shell-menu-btn{position:relative;z-index:1;display:flex !important;align-items:center !important;justify-content:center !important;width:auto !important;min-width:max-content;min-height:0 !important;padding:2rem 1.15rem !important;border:0 !important;border-radius:0 !important;background:transparent !important;box-shadow:none !important;color:var(--metis-color-button_text,#fff) !important;font-size:max(var(--metis-menu-font-size,19px),1.35rem) !important;font-weight:500 !important;letter-spacing:0 !important;text-decoration:none !important;text-transform:uppercase !important;text-align:center;white-space:nowrap !important;line-height:1.1 !important;opacity:.7;text-shadow:0 1px 1px rgba(0,0,0,.28);transition:opacity 250ms ease,color 250ms ease,background-color 250ms ease,box-shadow 250ms ease;}',
    ...
    private static function markerDropdownMenuCss( string $scope ): string {
        ...
        $rules = [
            $scope . '{--metis-marker-count:1;--metis-marker-index:0;--metis-marker-bg:#34495e;--metis-marker-accent:#e67e22;padding:0 !important;border:0 !important;border-radius:0 !important;background:var(--metis-marker-bg) !important;box-shadow:0 12px 24px rgba(15,23,42,.13);text-transform:uppercase !important;overflow:visible !important;}',
