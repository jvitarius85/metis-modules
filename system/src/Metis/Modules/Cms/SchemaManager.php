...
final class SchemaManager {
    ...
    public static function ensureSchema(): void {
        ...
        $pages_table = \Metis_Tables::get( 'cms_pages' );
        $posts_table = \Metis_Tables::get( 'cms_posts' );
        $post_categories_table = \Metis_Tables::get( 'cms_post_categories' );
        $post_category_map_table = \Metis_Tables::get( 'cms_post_category_map' );
        $global_layouts_table = \Metis_Tables::get( 'cms_global_layouts' );
        $menus_table = \Metis_Tables::get( 'cms_menus' );
        $banners_table = \Metis_Tables::get( 'cms_banners' );
        $popups_table = \Metis_Tables::get( 'cms_popups' );
        $theme_config_table = \Metis_Tables::get( 'cms_theme_config' );
        $templates_table = \Metis_Tables::get( 'cms_templates' );
        $web_parts_table = \Metis_Tables::get( 'cms_web_parts' );
        $blocks_table = \Metis_Tables::get( 'cms_blocks' );
        $revisions_table = \Metis_Tables::get( 'cms_revisions' );
        $redirects_table = \Metis_Tables::get( 'cms_redirects' );
        ...
        \Metis_Logger::info( 'CMS schema initialized' );
    }
