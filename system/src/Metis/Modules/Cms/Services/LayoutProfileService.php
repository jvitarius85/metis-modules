...
final class LayoutProfileService {
     ...
     */
    public static function cmsProfiles(): array {
        $profiles = [];
    ...
    public static function defaultCMSProfileKey(): string {
    ...
    public static function sanitizeCMSProfile( string $key ): string {
        $candidate = metis_key_clean( $key );
        return array_key_exists( $candidate, self::cmsProfiles() ) ? $candidate : self::defaultCMSProfileKey();
    }
     ...
     */
    public static function resolveCMSProfile( string $key ): array {
        $profiles = self::cmsProfiles();
        $resolved = self::sanitizeCMSProfile( $key );
