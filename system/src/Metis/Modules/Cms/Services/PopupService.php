...
/**
 * Popup Service — manages cms modal popups.
 */
final class PopupService {

    public static function getAll( array $filters = [] ): array {
        $db     = self::db();
        $table  = \Metis_Tables::get( 'cms_popups' );
        $where  = [];
        $params = [];
    ...
    public static function getById( int $id ): ?array {
        $row = self::db()->fetchOne( "SELECT * FROM " . \Metis_Tables::get( 'cms_popups' ) . " WHERE id = %d", [ $id ] );
    ...
    public static function create( array $data ): int|false {
        ...
        $result = self::db()->insert( \Metis_Tables::get( 'cms_popups' ), $payload );
    ...
    public static function update( int $id, array $data ): bool {
        ...
        return (bool) self::db()->update( \Metis_Tables::get( 'cms_popups' ), $update, [ 'id' => $id ] );
    }

    public static function delete( int $id ): bool {
        return (bool) self::db()->delete( \Metis_Tables::get( 'cms_popups' ), [ 'id' => $id ] );
    }
