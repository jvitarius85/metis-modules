 ...
 * Import Service
 *
 * CMS import helper service.
 *
 * Heavy import execution stays in the Import module; this service gives the CMS
    ...
    public static function readiness(): array {
        ...
        return [
            ...
            'message' => $module_available
                ? 'CMS imports are routed through the Import module so content can be staged, reviewed, and published intentionally.'
                : 'The Import module is not available. CMS content can still be created manually.',
            'steps' => [
                [
                ...
                [
                    ...
                    'detail' => 'Use CMS publishing, menu, template, and redirect controls after the import is verified.',
                ],
            ],
        ];
    }
