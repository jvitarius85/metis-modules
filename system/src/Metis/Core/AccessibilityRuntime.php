...
if ( ! function_exists( 'metis_accessibility_settings' ) ) {
    function metis_accessibility_settings(): array {
        ...
        $saved_profile = metis_key_clean( (string) Core_Settings_Service::get( 'accessibility_default_profile', 'none' ) );
