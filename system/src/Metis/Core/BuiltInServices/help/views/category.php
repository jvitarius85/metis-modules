...
<section class="metis-help-hero metis-help-hero--compact">
    ...
    <h1 class="metis-page-title"><?php echo htmlspecialchars( (string) ( $category['name'] ?? '' ), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ); ?></h1>
    <p class="metis-subtitle"><?php echo count( $items ); ?> article<?php echo count( $items ) === 1 ? '' : 's'; ?> in this category.</p>
</section>
