...
<article class="metis-help-article">
    ...
    <header class="metis-help-article__header">
        ...
        <h1 class="metis-page-title"><?php echo htmlspecialchars( (string) ( $article['title'] ?? '' ), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ); ?></h1>
        <p class="metis-subtitle"><?php echo htmlspecialchars( (string) ( $article['summary'] ?? '' ), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ); ?></p>
