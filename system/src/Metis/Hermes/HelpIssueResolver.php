...
final class HelpIssueResolver {
    ...
    private function guidanceTarget( string $moduleKey, string $action, string $currentRoute, string $currentModule ): array {
        ...
        return match ( $action ) {
            'create_gl_entry', 'save_gl_entry', 'post_gl_entry', 'balance_gl_entry', 'view_accounting_module' => [
                ...
                'highlight_selector' => '[data-open-gl-modal="1"], .metis-finance-v2-app .metis-settings-card',
            ...
            'accounting_period_status' => [
                ...
                'highlight_selector' => '.metis-finance-v2-app [data-finance-fiscal-settings-form="1"], .metis-finance-v2-app .metis-settings-card',
            ...
            'create_donation', 'edit_donation' => [
                ...
                'highlight_selector' => '.metis-transactions-view, .metis-tx-table, .metis-list-content',
            ...
            'create_deposit_batch', 'balance_deposit_batch' => [
                ...
                'highlight_selector' => '[data-metis-topic="donations.deposits"], .metis-page-header, .metis-list-content',
            ...
            'send_newsletter', 'send_test_email' => [
                ...
                'highlight_selector' => '.metis-newsletter, .metis-page-header-right, .metis-page-header',
            ...
            'assign_role' => [
                ...
                'highlight_selector' => '.metis-people-search-tile, .metis-tile[href*="/people/roles"], .metis-people-dashboard',
            ...
            'run_report', 'export_report' => [
                ...
                'highlight_selector' => '[data-metis-topic$=".reports"], .metis-page-header, .metis-main',
            ...
            'save_settings' => [
                ...
                'highlight_selector' => '[data-metis-settings-form], .metis-settings-actions .metis-btn, .metis-main',
    ...
    private function catalog(): array {
        ...
        $path = \METIS_CONFIG_PATH . 'hermes/help_issue_catalog.php';
