...
function metis_calendar_quick_action_event_form( array $action = [] ): array {
    ...
    if ( empty( $workspace['ok'] ) ) {
        return [
            'title' => 'Create Event',
            'html' => '<div class="metis-alert metis-alert-error">Workspace calendar configuration is unavailable.</div>',
            'submit_action' => '',
    ...
    $html = '<form class="metis-form-grid metis-quick-action-form" data-quick-action-form="calendar_create_event">'
        . '<div class="metis-field metis-field-half"><label for="qa-event-calendar">Calendar</label><select id="qa-event-calendar" name="calendar_id" class="metis-input">' . $calendarOptions . '</select></div>'
        . '<div class="metis-field metis-field-full"><label for="qa-event-summary">Title</label><input id="qa-event-summary" name="summary" class="metis-input" type="text" required></div>'
        . '<div class="metis-field metis-field-half"><label for="qa-event-start">Start</label><input id="qa-event-start" name="start_dt" class="metis-input" type="datetime-local" value="' . metis_escape_attr( $start ) . '" required></div>'
        . '<div class="metis-field metis-field-half"><label for="qa-event-end">End</label><input id="qa-event-end" name="end_dt" class="metis-input" type="datetime-local" value="' . metis_escape_attr( $end ) . '" required></div>'
        . '<div class="metis-field metis-field-half"><label for="qa-event-type">Event Type</label><select id="qa-event-type" name="event_type" class="metis-input"><option value="general">General</option><option value="meeting">Meeting</option><option value="deadline">Deadline</option><option value="task">Task</option><option value="public">Public</option></select></div>'
        . '<div class="metis-field metis-field-half"><label for="qa-event-module">Module</label><select id="qa-event-module" name="event_module" class="metis-input"><option value="general">General</option><option value="board">Board</option><option value="calendar">Calendar</option><option value="contacts">Contacts</option><option value="newsletter">Newsletter</option><option value="people">People</option><option value="portal">Portal</option></select></div>'
        . '<div class="metis-field metis-field-full"><label for="qa-event-location">Location</label><input id="qa-event-location" name="location" class="metis-input" type="text"></div>'
        . '<div class="metis-field metis-field-full"><label for="qa-event-description">Description</label><textarea id="qa-event-description" name="description" class="metis-input" rows="5"></textarea></div>'
        . '</form>';
