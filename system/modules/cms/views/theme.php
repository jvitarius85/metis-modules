...
if ( ! metis_cms_require_view_permission( 'theme' ) ) {
    return;
}
...
$local_font_dirs = [
    ...
    METIS_MODULES_PATH . 'cms/assets/fonts',
];
$local_font_seen = [];
$local_family_seen = [];
            ...
            <div class="metis-theme-grid metis-theme-grid-wide">
                ...
                <div class="metis-theme-field metis-theme-span-2">
                    ...
                    <div class="metis-theme-menu-live" id="metis-theme-menu-live">
                        <?php echo \Metis\Modules\Cms\Services\CmsRenderer::renderThemeMenuPreviewHtml(); ?>
                    </div>
                </div>
            </div>
        </section>
...
function themeAjaxConfig(action) {
    ...
    var cmsNonces = (cms.action_nonces && typeof cms.action_nonces === 'object') ? cms.action_nonces : {};
    var coreNonces = (core.action_nonces && typeof core.action_nonces === 'object') ? core.action_nonces : {};
    var nonce = cmsNonces[action] || coreNonces[action] || cms.nonce || core.nonce || '';
    var ajaxUrl = cms.ajax_url || core.ajax_url || '/api/ajax';
...
function versionStorageKey() {
    ...
    } else if (window.metisCmsAjax && window.metisCmsAjax.current_user_id != null) {
        uid = String(window.metisCmsAjax.current_user_id);
    }
    return 'metis.cms.theme.versions.' + uid;
}
...
$('#metis-theme-save-btn').on('click', function() {
    ...
    var ajaxCfg = themeAjaxConfig('metis_cms_theme_save');
    var payload = {
        action: 'metis_cms_theme_save',
        nonce: ajaxCfg.nonce,
