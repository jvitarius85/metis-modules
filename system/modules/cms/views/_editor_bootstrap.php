...
if ( ! function_exists( 'metis_cms_editor_required_nonce_actions' ) ) {
    function metis_cms_editor_required_nonce_actions( bool $include_preview = false ): array {
        $actions = [
            'metis_cms_page_get',
            'metis_cms_page_create',
            'metis_cms_page_save',
            'metis_cms_post_get',
            'metis_cms_post_create',
            'metis_cms_post_save',
            'metis_cms_editor_properties_options',
            'metis_cms_editor_media_upload',
        ];
...
if ( ! function_exists( 'metis_cms_build_editor_bootstrap' ) ) {
    function metis_cms_build_editor_bootstrap( array $args = [] ): array {
        ...
        if ( function_exists( 'metis_runtime_create_nonce' ) ) {
            $editor_nonce = (string) metis_runtime_create_nonce( 'metis_cms' );
            if ( $editor_nonce === '' ) {
                $editor_nonce = (string) metis_runtime_create_nonce( 'metis_core' );
            }
        }

        $required_actions = metis_cms_editor_required_nonce_actions( ! empty( $args['include_preview'] ) );
...
if ( ! function_exists( 'metis_cms_render_editor_bootstrap' ) ) {
    function metis_cms_render_editor_bootstrap( array $args = [] ): void {
        $payload = metis_cms_build_editor_bootstrap( $args );
        ?>
        ...
        <div
            ...
            data-editor-context="<?php echo metis_escape_attr( (string) ( $args['editor_context'] ?? 'cms' ) ); ?>"
