...
if ( ! metis_cms_require_view_permission( 'banners' ) ) {
    return;
}
...
(function($){
    ...
    $(document).on('click', '#metis-banner-save-btn', function(){
        ...
        var payload = {
            action: 'metis_cms_banner_save',
            nonce: metisCmsAjax.nonce,
        ...
        $.post(metisCmsAjax.ajax_url, payload).done(function(r){
            if (r && r.success) {
    ...
    $(document).on('click', '.metis-banner-delete-btn', function(){
        ...
        metis_confirm('Delete this banner?', function(){
            $.post(metisCmsAjax.ajax_url, {
                action: 'metis_cms_banner_delete',
                nonce: metisCmsAjax.nonce,
                id: id
            }).done(function(r){
                if (r && r.success) {
