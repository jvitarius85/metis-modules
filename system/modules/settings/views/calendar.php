...
<p class="metis-subtitle">Choose the calendars used across the portal.</p>
<?php metis_settings_render_messages( $saved, $errors ); ?>
<?php metis_settings_render_section_nav( 'calendar' ); ?>
<form method="post" class="metis-settings-form" data-metis-settings-form="1" data-settings-section="calendar">
    ...
    <div class="metis-settings-actions">
        <button type="submit" class="metis-btn">Save Calendar Settings</button>
    </div>
</form>
<script>
(function () {
