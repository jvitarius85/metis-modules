...
?>
<div class="metis-template metis-template-centered_stack_marketing metis-template-view-homepage">
    <header class="metis-template-header metis-template-sticky-capable" role="banner">
        <div class="metis-template-header-inner">
            ...
            <nav class="metis-template-menu metis-template-menu-center" aria-label="Primary menu"><?php echo $menuHtml; ?></nav>
        </div>
    </header>
    <main class="metis-template-main<?php echo $withSidebar ? ' has-sidebar' : ''; ?>" data-view="homepage" data-sidebar-position="<?php echo metis_escape_attr($sidebarPosition); ?>">
        <div class="metis-template-main-inner">
            ...
            <?php if ($withSidebar): ?>
                <aside class="metis-template-secondary-panel"><?php echo $sidebarHtml; ?></aside>
            <?php endif; ?>
        </div>
    </main>
