...
function metis_donations_handle_manage_profile_route( Metis_Http_Request $request ): Metis_Http_Response {
    ...
    $body = '<section class="metis-donor-hero"><div>' . metis_donations_portal_logo_html() . '<p class="metis-donor-kicker">Secure Access</p><h1 class="metis-donor-title">Manage Profile</h1><p class="metis-donor-copy">Enter the email connected to your Metis profile. We will send a secure access link that expires in 15 minutes. No public account is required.</p></div></section>';
...
function metis_donations_handle_manage_access_route( Metis_Http_Request $request ): Metis_Http_Response {
    ...
    $body = '<section class="metis-donor-hero"><div>' . metis_donations_portal_logo_html() . '<p class="metis-donor-kicker">Manage Profile</p><h1 class="metis-donor-title">Welcome, ' . metis_escape_html( $name ) . '</h1><p class="metis-donor-copy">Manage your profile, newsletter subscriptions, giving history, recurring donations, and annual contribution statements.</p></div></section>' . $notice;
    ...
    $body .= '<div class="metis-donor-panel"><h2>Newsletter Subscriptions</h2><div class="metis-donor-table-wrap"><table class="metis-donor-table"><thead><tr><th>List</th><th>Status</th><th>Action</th></tr></thead><tbody>' . $newsletterRows . '</tbody></table></div></div>';
