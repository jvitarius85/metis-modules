...
if (!metis_board_can_view()) {
    echo '<div class="metis-alert metis-alert-error">You do not have permission to view board meeting details.</div>';
    return;
}
...
if (function_exists('metis_board_sync_decision_points')) {
    metis_board_sync_decision_points($meeting_id, $agenda);
}
...
<div class="metis-board-detail"
    ...
    <a class="metis-btn metis-btn-ghost" href="<?php echo metis_escape_url($back_url); ?>">Back to Board</a>

    <h1 class="metis-page-title" style="margin-top:10px;"><?php echo metis_escape_html((string) ($meeting['title'] ?? '')); ?></h1>
    <p class="metis-subtitle"><?php echo metis_escape_html((string) ($meeting['meeting_code'] ?? '')); ?> · <?php echo metis_escape_html((string) ($meeting['committee_name'] ?? 'Board-wide')); ?> · <?php echo metis_escape_html(metis_board_format_datetime((string) ($meeting['meeting_date'] ?? ''))); ?></p>

    <div id="metis-board-alert" class="metis-alert" style="display:none;"></div>

    <div class="metis-board-stats metis-board-stats--workflow">
    ...
    <section class="metis-premium-wrap metis-board-tabs-wrap">
        <div class="metis-board-workflow-shell">
        <div class="metis-board-tabs" role="tablist" aria-label="Meeting workflow steps">
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab metis-board-tab-active" data-tab="overview" role="tab" aria-selected="true">1. Setup</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab" data-tab="agenda" role="tab" aria-selected="false">2. Agenda</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab" data-tab="minutes" role="tab" aria-selected="false">3. Minutes</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab" data-tab="packet" role="tab" aria-selected="false">4. Packet</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab" data-tab="voting" role="tab" aria-selected="false">5. Decisions</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab" data-tab="attendance" role="tab" aria-selected="false">6. Attendance</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-tab" data-tab="actions" role="tab" aria-selected="false">7. Actions</button>
        ...
        <div class="metis-board-tab-panels">
            <section class="metis-board-tab-panel" data-panel="overview">
                <div class="metis-board-grid-2">
                    <section class="metis-premium-wrap">
                        ...
                        <?php if ($can_manage) : ?>
                        <form id="metis-board-setup-form" class="metis-form-grid">
                            <div class="metis-field metis-field-full">
                                <label for="metis-board-setup-title">Meeting Title</label>
                                <input id="metis-board-setup-title" class="metis-input" type="text" maxlength="191" value="<?php echo metis_escape_attr((string) ($meeting['title'] ?? '')); ?>" required>
                            </div>
                            <div class="metis-field metis-field-half">
                                <label for="metis-board-setup-date">Meeting Date & Time</label>
                                <input id="metis-board-setup-date" class="metis-input" type="datetime-local" value="<?php echo metis_escape_attr($meeting_date_value !== '' ? metis_runtime_date('Y-m-d\\TH:i', strtotime($meeting_date_value)) : ''); ?>" required>
                            </div>
                            <div class="metis-field metis-field-half">
                                <label for="metis-board-setup-type">Meeting Type</label>
                                <select id="metis-board-setup-type" class="metis-select">
                            ...
                            <div class="metis-field metis-field-half">
                                ...
                                <input id="metis-board-setup-location" class="metis-input" type="text" maxlength="191" value="<?php echo metis_escape_attr((string) ($meeting['location'] ?? '')); ?>" placeholder="Meeting location">
                            </div>
                            <div class="metis-field metis-field-half">
                                <label for="metis-board-setup-status">Status</label>
                                <select id="metis-board-setup-status" class="metis-select">
                            ...
                            <div class="metis-form-actions">
                                <button type="submit" class="metis-btn">Save Setup</button>
                            </div>
                        </form>
                        <?php else : ?>
                    ...
                    <section class="metis-premium-wrap">
                        ...
                        <div class="metis-board-workspace-link-group">
                            ...
                            <div class="metis-board-workspace-link-actions">
                                <select id="metis-board-setup-calendar-select" class="metis-select">
                                    <option value="">Select calendar event</option>
                                </select>
                                <button type="button" class="metis-btn metis-btn-ghost" id="metis-board-setup-calendar-assign">Assign Event</button>
                                <button type="button" class="metis-btn metis-btn-ghost" id="metis-board-setup-calendar-generate">Generate Event</button>
                            </div>
                            <?php endif; ?>
                        </div>
                        <div class="metis-board-workspace-link-group">
                            ...
                            <?php if ($can_manage) : ?>
                            <div class="metis-board-workspace-link-actions">
                                <select id="metis-board-setup-folder-select" class="metis-select">
                                    <option value="">Select drive folder</option>
                                </select>
                                <button type="button" class="metis-btn metis-btn-ghost" id="metis-board-setup-folder-assign">Assign Folder</button>
                                <button type="button" class="metis-btn metis-btn-ghost" id="metis-board-setup-folder-generate">Generate Folder</button>
                            </div>
                            <?php endif; ?>
                        </div>
                    </section>
            ...
            <section class="metis-board-tab-panel" data-panel="agenda" hidden>
                <?php if ($can_manage) : ?>
                <form id="metis-board-agenda-form" class="metis-form-grid">
                    <div class="metis-field metis-field-full">
                        <div class="metis-board-builder-toolbar">
                            <label>Agenda Builder</label>
                            <div class="metis-board-builder-toolbar-actions">
                                <button type="button" id="metis-board-agenda-add-section" class="metis-btn metis-btn-ghost">Add Section</button>
                                <button type="button" id="metis-board-manage-workflow" class="metis-btn metis-btn-ghost">Manage Workflow Templates</button>
                            </div>
                        </div>
                        <div id="metis-board-agenda-builder" class="metis-board-agenda-builder"></div>
                        <textarea id="metis-board-agenda-json" class="metis-input" rows="2" style="display:none;"><?php echo metis_escape_html($agenda_snapshot_json); ?></textarea>
                        <template id="metis-board-agenda-section-template">
                            <div class="metis-board-agenda-section-card" data-index="">
                                <div class="metis-board-agenda-section-head">
                                    ...
                                    <button type="button" class="metis-btn-xs metis-btn-danger metis-board-agenda-remove">Remove</button>
                                </div>
                                <div class="metis-board-agenda-section-grid">
                                    <div>
                                        <label>Section Template</label>
                                        <select class="metis-select metis-board-agenda-template">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="metis-input metis-board-agenda-title" maxlength="191" placeholder="Section title">
                                    </div>
                                    <div class="metis-board-agenda-grid-full">
                                        <div class="metis-board-agenda-decision-head">
                                            ...
                                            <button type="button" class="metis-btn-xs metis-board-agenda-decision-add">Add Decision Point</button>
                                        </div>
                                        <div class="metis-board-agenda-decision-list"></div>
                                    </div>
                                    <div class="metis-board-agenda-grid-full">
                                        <label>Agenda Items (one per line)</label>
                                        <textarea class="metis-input metis-board-agenda-items" rows="4" placeholder="Item 1&#10;Item 2"></textarea>
                                    </div>
                                    <div class="metis-board-agenda-grid-full">
                                        <label>Notes (optional)</label>
                                        <textarea class="metis-input metis-board-agenda-notes" rows="2" placeholder="Section notes"></textarea>
                                    </div>
                                </div>
                            </div>
                        </template>
                        <template id="metis-board-agenda-decision-row-template">
                            <div class="metis-board-agenda-decision-row">
                                <select class="metis-select metis-board-agenda-decision-template">
                                ...
                                <input type="text" class="metis-input metis-board-agenda-decision-title" maxlength="191" placeholder="Decision text shown in packet">
                                <input type="text" class="metis-input metis-board-agenda-decision-item" maxlength="191" placeholder="Agenda item (optional)">
                                <button type="button" class="metis-btn-xs metis-btn-danger metis-board-agenda-decision-remove">Remove</button>
                            </div>
                        </template>
                    </div>
                    <div class="metis-form-actions">
                        <button type="submit" class="metis-btn">Save Agenda</button>
                        <button type="button" id="metis-board-continue-to-minutes" class="metis-btn metis-btn-ghost">Continue to Minutes</button>
                    </div>
                </form>
                <?php else : ?>
                <div class="metis-board-grid-2">
                                ...
                                ?>
                                    <div class="metis-board-agenda-item">
                                        ...
                                        <?php if (!empty($decision_labels)) : ?>
                                            <div class="metis-muted" style="margin-top:6px;"><strong>Decision points:</strong></div>
                                            <ul>
                                                <?php foreach ($decision_labels as $dp_label) : ?><li><?php echo metis_escape_html($dp_label); ?></li><?php endforeach; ?>
                                            </ul>
                                        <?php elseif ($decision_label !== '') : ?><div class="metis-muted" style="margin-top:6px;"><strong>Decision point:</strong> <?php echo metis_escape_html($decision_label); ?></div><?php endif; ?>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        <?php else : ?>
                            <p class="metis-muted">No agenda items recorded.</p>
                        <?php endif; ?>
                    </section>
                    <section class="metis-premium-wrap">
                        ...
                        <?php else : ?>
                            <p class="metis-muted">No minutes published yet.</p>
                        <?php endif; ?>
                    </section>
                </div>
                <?php endif; ?>
            ...
            <section class="metis-board-tab-panel" data-panel="minutes" hidden>
                <?php if ($can_manage) : ?>
                <form id="metis-board-minutes-form" class="metis-form-grid">
                    <div class="metis-field metis-field-full">
                        ...
                        <div class="metis-board-rich-toolbar" data-rich-toolbar="minutes">
                            <select class="metis-select" data-rich-block>
                                <option value="p">Paragraph</option>
                                <option value="h2">Heading 2</option>
                                <option value="h3">Heading 3</option>
                                <option value="blockquote">Quote</option>
                            </select>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="undo">Undo</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="redo">Redo</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="bold"><strong>B</strong></button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="italic"><em>I</em></button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="underline"><u>U</u></button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="insertUnorderedList">Bullets</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="insertOrderedList">Numbers</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="justifyLeft">Left</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="justifyCenter">Center</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="justifyRight">Right</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-link>Link</button>
                            <button type="button" class="metis-btn-xs metis-btn-ghost" data-rich-command="unlink">Unlink</button>
                        </div>
                        <div id="metis-board-detail-minutes-editor" class="metis-input metis-board-minutes-editor" contenteditable="true" aria-label="Minutes editor"></div>
                        <textarea id="metis-board-detail-minutes-html" class="metis-input" rows="14" style="display:none;"><?php echo metis_escape_html($meeting_minutes_html); ?></textarea>
                    </div>
                    <div class="metis-form-actions">
                        <button type="button" class="metis-btn metis-btn-ghost" id="metis-board-generate-minutes-draft">Populate from Agenda</button>
                        <button type="submit" class="metis-btn">Save Minutes</button>
                        <button type="button" class="metis-btn metis-btn-ghost" data-open-board-tab="packet">Continue to Packet</button>
                    </div>
                </form>
                <?php else : ?>
                <section class="metis-premium-wrap">
            ...
            <section class="metis-board-tab-panel" data-panel="packet" hidden>
                <?php if ($can_manage) : ?>
                <div class="metis-help">Save agenda and minutes first, then generate packet PDFs.</div>
                <div class="metis-board-packet-actions">
                    <button type="button" class="metis-btn metis-btn-ghost" data-open-board-tab="minutes">Back to Minutes</button>
                    <button type="button" id="metis-board-generate-packet" class="metis-btn">Generate Packet PDFs</button>
                    <button type="button" id="metis-board-resend-packet-email" class="metis-btn metis-btn-ghost">Resend Packet Email</button>
                </div>
                <form id="metis-board-packet-form" class="metis-form-grid">
                    <div class="metis-field metis-field-full">
                        ...
                        <div id="metis-board-packet-notes-editor" class="metis-input metis-board-minutes-editor" contenteditable="true" aria-label="Packet notes editor"></div>
                        <textarea id="metis-board-packet-notes" class="metis-input" rows="4" style="display:none;" placeholder="Optional board packet summary or publication notes."><?php echo metis_escape_html($packet_notes); ?></textarea>
                    </div>
                    <div class="metis-field metis-field-half">
                        <label for="metis-board-packet-prev-minutes">Prior Meeting Minutes for Approval</label>
                        <select id="metis-board-packet-prev-minutes" class="metis-select">
                        ...
                        <div class="metis-help">Defaults to the most recent prior meeting with saved minutes.</div>
                    </div>
                    <div class="metis-field metis-field-half">
                        <label for="metis-board-packet-financial-doc">Financial Source</label>
                        <select id="metis-board-packet-financial-doc" class="metis-select">
                            <option value="0">None</option>
                    ...
                    <div class="metis-form-actions">
                        <button type="submit" class="metis-btn">Save Packet Metadata</button>
                    </div>
                </form>
                <?php endif; ?>

                <section class="metis-premium-wrap metis-board-drive-wrap"
                    data-meeting-id="<?php echo metis_escape_attr((string) $meeting_id); ?>"
                    ...
                    <div class="metis-board-drive-toolbar">
                        <input type="text" id="metis-board-drive-search" class="metis-input" placeholder="Search files in current folder">
                        <button type="button" id="metis-board-drive-refresh" class="metis-btn metis-btn-ghost">Refresh</button>
                        <button type="button" id="metis-board-drive-up" class="metis-btn metis-btn-ghost" disabled>Up</button>
                        <?php if ($can_manage) : ?>
                            <button type="button" id="metis-board-drive-upload" class="metis-btn metis-btn-ghost">Upload</button>
                            <input type="file" id="metis-board-drive-upload-input" style="display:none;" />
                        <?php endif; ?>
                    </div>
                    <div class="metis-muted" id="metis-board-drive-path">Folder: loading…</div>
                    <table class="metis-premium-table metis-board-drive-table">
                        <thead>
                            <tr class="metis-premium-row metis-premium-header">
                                ...
                                <th class="metis-premium-cell" scope="col">Modified</th>
                                <th class="metis-premium-cell" scope="col">Size</th>
                                <th class="metis-premium-cell" scope="col">Actions</th>
                            </tr>
                        </thead>
                        <tbody id="metis-board-drive-rows"></tbody>
                    </table>
                </section>

                <details style="margin-top:14px;">
                    <summary><strong>Show Linked Documents</strong></summary>
                    <table class="metis-premium-table metis-board-table metis-board-linked-doc-table" style="margin-top:10px;">
                        <thead>
                            <tr class="metis-premium-row metis-premium-header"><th class="metis-premium-cell" scope="col">Linked Document</th><th class="metis-premium-cell" scope="col">Type</th><th class="metis-premium-cell" scope="col">Link</th><th class="metis-premium-cell" scope="col">Actions</th></tr>
                        </thead>
                        <tbody id="metis-board-linked-doc-rows">
                            <?php foreach ($documents as $doc) : ?>
                                <tr class="metis-premium-row">
                                    <td class="metis-premium-cell"><strong><?php echo metis_escape_html((string) ($doc['title'] ?? '')); ?></strong></td>
                                    <td class="metis-premium-cell"><?php echo metis_escape_html(function_exists('metis_board_doc_type_label') ? metis_board_doc_type_label((string) ($doc['doc_type'] ?? '')) : (string) ($doc['doc_type'] ?? '')); ?></td>
                                    <td class="metis-premium-cell"><?php if (!empty($doc['google_drive_url'])) : ?><button type="button" class="metis-btn-xs metis-btn-ghost metis-board-preview-linked-doc" data-link="<?php echo metis_escape_attr((string) $doc['google_drive_url']); ?>">Link</button><?php else : ?><span class="metis-muted">—</span><?php endif; ?></td>
                                    <td class="metis-premium-cell">
                                        <?php if ($can_manage) : ?>
                                            <button type="button" class="metis-btn-xs metis-btn-danger metis-board-unlink-doc" data-document-id="<?php echo metis_escape_attr((string) ($doc['id'] ?? '0')); ?>">Unlink</button>
                                        <?php else : ?>
                            ...
                            <?php endforeach; ?>
                            <?php if (empty($documents)) : ?><tr class="metis-premium-row"><td class="metis-premium-cell metis-muted" colspan="4">No meeting documents linked.</td></tr><?php endif; ?>
                        </tbody>
                    </table>
                </details>
            </section>
            ...
            <section class="metis-board-tab-panel" data-panel="voting" hidden>
                ...
                <div style="margin-bottom:10px;">
                    <button type="button" id="metis-board-new-decision-inline" class="metis-btn">Add Decision</button>
                </div>
                <?php endif; ?>
                <table class="metis-premium-table metis-board-table">
                    <thead>
                        <tr class="metis-premium-row metis-premium-header metis-board-decision-header"><th class="metis-premium-cell" scope="col">Decision</th><th class="metis-premium-cell" scope="col">Outcome</th><th class="metis-premium-cell" scope="col">For</th><th class="metis-premium-cell" scope="col">Against</th><th class="metis-premium-cell" scope="col">Abstain</th></tr>
                    </thead>
                    <tbody>
                    <?php foreach ($decisions as $decision) : ?>
                        ...
                        ?>
                        <tr class="metis-premium-row metis-board-decision-row"
                            ...
                            <td class="metis-premium-cell">
                                ...
                                <?php if (!empty($decision['agenda_section_title']) || !empty($decision['agenda_item_title'])) : ?>
                                    <div class="metis-muted">Section: <?php echo metis_escape_html((string) ($decision['agenda_section_title'] ?? '')); ?><?php if (!empty($decision['agenda_item_title'])) : ?> · Item: <?php echo metis_escape_html((string) ($decision['agenda_item_title'] ?? '')); ?><?php endif; ?></div>
                                <?php endif; ?>
                                <?php if (!empty($decision['decision_text'])) : ?><div class="metis-muted"><?php echo metis_escape_html((static function (string $text, int $num_words = 22, string $more = '...'): string {
    ...
    return implode(' ', array_slice($words, 0, $num_words)) . $more;
                            ...
                            <td class="metis-premium-cell">
                                <?php if ($can_manage) : ?>
                                <select class="metis-select metis-board-decision-outcome" style="max-width:160px;" disabled>
                                ...
                                <?php else : ?>
                                <span class="metis-chip"><?php echo metis_escape_html((string) ($decision['outcome'] ?? 'pending')); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="metis-premium-cell"><span class="metis-board-decision-count metis-board-decision-for" data-count="<?php echo metis_escape_attr((string) ((int) ($decision['votes_for'] ?? 0))); ?>"><?php echo metis_escape_html((string) ((int) ($decision['votes_for'] ?? 0))); ?></span></td>
                            <td class="metis-premium-cell"><span class="metis-board-decision-count metis-board-decision-against" data-count="<?php echo metis_escape_attr((string) ((int) ($decision['votes_against'] ?? 0))); ?>"><?php echo metis_escape_html((string) ((int) ($decision['votes_against'] ?? 0))); ?></span></td>
                            <td class="metis-premium-cell"><span class="metis-board-decision-count metis-board-decision-abstain" data-count="<?php echo metis_escape_attr((string) ((int) ($decision['votes_abstain'] ?? 0))); ?>"><?php echo metis_escape_html((string) ((int) ($decision['votes_abstain'] ?? 0))); ?></span></td>
                            <?php if ($can_manage && !empty($voting_members)) : ?>
                            <td class="metis-premium-cell metis-board-decision-vote-panel">
                                <details class="metis-board-vote-collapse">
                                    ...
                                    <div class="metis-help">Drag board members into vote columns. Votes save automatically.</div>
                                </details>
                            </td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                    <?php if (empty($decisions)) : ?><tr class="metis-premium-row"><td class="metis-premium-cell metis-muted" colspan="5">No decisions recorded.</td></tr><?php endif; ?>
                    </tbody>
                </table>
            </section>
                ...
                <div class="metis-board-grid-2">
                    <section class="metis-premium-wrap">
                        ...
                        <div class="metis-board-linked-list">
                            ...
                            <div><strong>Quorum Status:</strong> <span id="metis-board-quorum-status" class="metis-chip <?php echo $has_quorum ? 'metis-chip-success' : ''; ?>"><?php echo $has_quorum ? 'Met' : 'Pending'; ?></span></div>
                        </div>
                    </section>
                    <section class="metis-premium-wrap">
                        ...
                        <?php if ($can_manage) : ?>
                            <div class="metis-board-linked-list">
                                ...
                                <div class="metis-muted">When locked, attendance cannot be edited by board managers.</div>
                            </div>
                        <?php else : ?>
                            <p class="metis-muted">Attendance is <?php echo (int) ($meeting['attendance_locked'] ?? 0) === 1 ? 'locked' : 'open'; ?>.</p>
                        <?php endif; ?>
                    </section>
                </div>

                <table class="metis-premium-table metis-board-table" style="margin-top:14px;">
                    <thead>
                        <tr class="metis-premium-row metis-premium-header metis-board-attendance-header"><th class="metis-premium-cell" scope="col">Member</th><th class="metis-premium-cell" scope="col">Role</th><th class="metis-premium-cell" scope="col">Status</th><th class="metis-premium-cell" scope="col">Notes</th></tr>
                    </thead>
                    <tbody>
                    ...
                    ?>
                    <tr class="metis-premium-row metis-board-attendance-row" data-person-id="<?php echo metis_escape_attr((string) $pid); ?>">
                        <td class="metis-premium-cell"><strong><?php echo metis_escape_html((string) ($person['display_name'] ?? '')); ?></strong><div class="metis-muted"><?php echo metis_escape_html((string) ($person['email'] ?? '')); ?></div></td>
                        <td class="metis-premium-cell"><?php if ($can_manage) : ?><input class="metis-input metis-board-attendance-role" type="text" value="<?php echo metis_escape_attr($att_role); ?>" maxlength="64" style="max-width:180px;"><?php else : ?><?php echo metis_escape_html($att_role !== '' ? $att_role : '—'); ?><?php endif; ?></td>
                        <td class="metis-premium-cell">
                            <?php if ($can_manage) : ?>
                            <select class="metis-select metis-board-attendance-status" style="max-width:160px;">
                            ...
                            <?php else : ?>
                            <span class="metis-chip"><?php echo metis_escape_html($att_status); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="metis-premium-cell"><?php if ($can_manage) : ?><input class="metis-input metis-board-attendance-notes" type="text" value="<?php echo metis_escape_attr($att_notes); ?>" maxlength="255"><?php else : ?><?php echo metis_escape_html($att_notes !== '' ? $att_notes : '—'); ?><?php endif; ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if (empty($board_people)) : ?><tr class="metis-premium-row"><td class="metis-premium-cell metis-muted" colspan="4">No eligible board/staff members found.</td></tr><?php endif; ?>
                    </tbody>
                </table>
            </section>

            <section class="metis-board-tab-panel" data-panel="actions" hidden>
                <?php if ($can_manage) : ?><div style="margin-bottom:10px;"><button type="button" id="metis-board-new-action-inline" class="metis-btn">Add Action Item</button></div><?php endif; ?>
                <table class="metis-premium-table metis-board-table metis-board-actions-table">
                    <thead>
                        <tr class="metis-premium-row metis-premium-header"><th class="metis-premium-cell" scope="col">Action Item</th><th class="metis-premium-cell" scope="col">Owner</th><th class="metis-premium-cell" scope="col">Due</th><th class="metis-premium-cell" scope="col">Status</th><th class="metis-premium-cell" scope="col">Action</th></tr>
                    </thead>
                    <tbody id="metis-board-action-rows">
                    ...
                    <?php endforeach; ?>
                    <?php if (empty($actions)) : ?><tr class="metis-premium-row"><td class="metis-premium-cell metis-muted" colspan="5">No action items for this meeting.</td></tr><?php endif; ?>
                    </tbody>
                </table>
            </section>
        </div>
    ...
    <div class="metis-modal">
        ...
        <form id="metis-board-decision-form" class="metis-form-grid">
            <div class="metis-field metis-field-half">
                ...
                <select id="metis-board-decision-meeting" class="metis-select" required>
            ...
            <div class="metis-field metis-field-half"><label for="metis-board-decision-section">Agenda Section</label><input id="metis-board-decision-section" class="metis-input" type="text" maxlength="191" placeholder="Optional"></div>
            <div class="metis-field metis-field-half"><label for="metis-board-decision-item">Agenda Item</label><input id="metis-board-decision-item" class="metis-input" type="text" maxlength="191" placeholder="Optional"></div>
...
<div id="metis-board-action-modal" class="metis-modal-backdrop" aria-hidden="true">
    <div class="metis-modal">
        ...
        <form id="metis-board-action-form" class="metis-form-grid">
            <div class="metis-field metis-field-half"><label for="metis-board-action-meeting">Meeting</label><select id="metis-board-action-meeting" class="metis-select"><option value="<?php echo metis_escape_attr((string) $meeting_id); ?>"><?php echo metis_escape_html((string) ($meeting['meeting_code'] ?? '') . ' - ' . (string) ($meeting['title'] ?? '')); ?></option></select></div>
    ...
    <div class="metis-modal" style="max-width:560px;">
        ...
        <form class="metis-form-grid" id="metis-board-drive-folder-form">
            <div class="metis-field metis-field-full">
                ...
                <input id="metis-board-drive-folder-name" class="metis-input" type="text" required />
            </div>
            <div class="metis-field metis-field-full">
            ...
            <div class="metis-form-actions">
                ...
                <button type="submit" class="metis-btn">Create Folder</button>
            </div>
        </form>
    </div>
</div>
...
<div class="metis-modal-backdrop" id="metis-board-doc-meta-modal" aria-hidden="true">
    <div class="metis-modal" style="max-width:640px;">
        ...
        <form class="metis-form-grid" id="metis-board-doc-meta-form">
            <div class="metis-field metis-field-full" id="metis-board-doc-meta-file-wrap">
                <label for="metis-board-doc-meta-file">Document</label>
                <input id="metis-board-doc-meta-file" class="metis-input" type="file" />
            </div>
            <div class="metis-field metis-field-full">
                <label for="metis-board-doc-meta-title">Item Name</label>
                <input id="metis-board-doc-meta-title" class="metis-input" type="text" maxlength="191" required />
            </div>
            <div class="metis-field metis-field-full">
                <label for="metis-board-doc-meta-type">Item Type</label>
                <select id="metis-board-doc-meta-type" class="metis-select">
            ...
            <div class="metis-form-actions">
                <button type="button" class="metis-btn metis-btn-ghost metis-board-cancel">Cancel</button>
                <button type="submit" class="metis-btn" id="metis-board-doc-meta-submit">Save Document</button>
            </div>
        </form>
    </div>
</div>
...
<div class="metis-modal-backdrop" id="metis-board-drive-preview-modal" aria-hidden="true">
    <div class="metis-modal" style="max-width:1080px;">
        ...
        <div class="metis-form-actions">
            <a id="metis-board-drive-preview-open" class="metis-btn metis-btn-ghost" href="#" target="_blank" rel="noopener">Open in new tab</a>
            <a id="metis-board-drive-preview-download" class="metis-btn metis-btn-ghost" href="#" target="_blank" rel="noopener">Download</a>
            <button type="button" class="metis-btn metis-board-cancel">Close</button>
        </div>
    </div>
</div>
...
<div class="metis-modal-backdrop" id="metis-board-workflow-modal" aria-hidden="true">
    <div class="metis-modal" style="max-width:1080px;">
        ...
        <div class="metis-board-workflow-modal-tabs" role="tablist" aria-label="Workflow template groups">
            <button type="button" class="metis-btn metis-btn-ghost metis-board-workflow-tab-btn is-active" data-workflow-tab="agenda">Agenda Sections</button>
            <button type="button" class="metis-btn metis-btn-ghost metis-board-workflow-tab-btn" data-workflow-tab="decision">Decision Templates</button>
        </div>
        <div class="metis-board-workflow-modal-panels">
            <section class="metis-premium-wrap metis-board-workflow-tab-panel" data-workflow-panel="agenda">
                <h4 class="metis-people-section-title" style="margin:0 0 8px;">Agenda Sections</h4>
                <div class="metis-help" style="margin-bottom:8px;">Define reusable meeting sections used in agenda builder.</div>
                <div id="metis-board-agenda-template-list" class="metis-board-template-list"></div>
                <form id="metis-board-agenda-template-form" class="metis-form-grid" style="margin-top:10px;">
                    <input type="hidden" id="metis-board-agenda-template-id" value="0">
                    <div class="metis-field metis-field-half"><label for="metis-board-agenda-template-name">Name</label><input id="metis-board-agenda-template-name" class="metis-input" type="text" maxlength="191" required></div>
                    <div class="metis-field metis-field-half"><label for="metis-board-agenda-template-sort">Sort Order</label><input id="metis-board-agenda-template-sort" class="metis-input" type="number" min="0" value="0"></div>
                    <div class="metis-field metis-field-full"><label for="metis-board-agenda-template-items">Default Items (one per line)</label><textarea id="metis-board-agenda-template-items" class="metis-input" rows="3"></textarea></div>
                    <div class="metis-field metis-field-full"><label><input id="metis-board-agenda-template-required" type="checkbox"> Required in new meetings</label></div>
                    <div class="metis-form-actions"><button type="button" class="metis-btn metis-btn-ghost" id="metis-board-agenda-template-reset">Clear</button><button type="submit" class="metis-btn">Save Section</button></div>
                </form>
            </section>
            <section class="metis-premium-wrap metis-board-workflow-tab-panel" data-workflow-panel="decision" hidden>
                <h4 class="metis-people-section-title" style="margin:0 0 8px;">Decision Templates</h4>
                <div class="metis-help" style="margin-bottom:8px;">Typical board decision points available in agenda builder.</div>
                <div id="metis-board-decision-template-list" class="metis-board-template-list"></div>
                <form id="metis-board-decision-template-form" class="metis-form-grid" style="margin-top:10px;">
                    <input type="hidden" id="metis-board-decision-template-id" value="0">
                    <div class="metis-field metis-field-half"><label for="metis-board-decision-template-name">Title</label><input id="metis-board-decision-template-name" class="metis-input" type="text" maxlength="191" required></div>
                    <div class="metis-field metis-field-half"><label for="metis-board-decision-template-sort">Sort Order</label><input id="metis-board-decision-template-sort" class="metis-input" type="number" min="0" value="0"></div>
                    <div class="metis-field metis-field-full"><label for="metis-board-decision-template-description">Description</label><textarea id="metis-board-decision-template-description" class="metis-input" rows="3"></textarea></div>
                    <div class="metis-form-actions"><button type="button" class="metis-btn metis-btn-ghost" id="metis-board-decision-template-reset">Clear</button><button type="submit" class="metis-btn">Save Decision Template</button></div>
                </form>
            </section>
        </div>
        <div class="metis-form-actions">
