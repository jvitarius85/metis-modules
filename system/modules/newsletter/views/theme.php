...
<div class="metis-newsletter" data-can-manage="<?php echo $can_manage ? '1' : '0'; ?>">
    <h1 class="metis-page-title">Newsletter Theme</h1>

    <section class="metis-premium-wrap metis-newsletter-theme-card" id="metis-newsletter-theme-card">
        <div class="metis-newsletter-theme-head">
            <div>
                <div class="metis-newsletter-theme-title">Shared Newsletter Controls</div>
            </div>
            <?php if ($can_manage) : ?><button type="button" class="metis-btn" id="metis-newsletter-save-theme-defaults">Save & Activate</button><?php endif; ?>
        </div>
                ...
                <section class="metis-newsletter-theme-section-card metis-newsletter-theme-section-card--general" id="metis-newsletter-theme-general">
                    ...
                    <div class="metis-newsletter-theme-form metis-newsletter-theme-form--two">
                        ...
                        <div class="metis-field">
                            ...
                            <input id="metis-newsletter-theme-font-size" class="metis-input metis-input-wide" type="range" min="10" max="28" step="1" value="<?php echo metis_escape_attr((string) $newsletter_theme_defaults['font_size']); ?>">
                        ...
                        <div class="metis-field">
                            ...
                            <select id="metis-newsletter-theme-canvas-bg" class="metis-input metis-input-wide">
                        ...
                        <div class="metis-field">
                            ...
                            <select id="metis-newsletter-theme-text-color" class="metis-input metis-input-wide">
                                <?php foreach ($newsletter_color_options as $value => $label) : ?>
                        ...
                        <div class="metis-field">
                            ...
                            <select id="metis-newsletter-theme-divider-color" class="metis-input metis-input-wide">
                        ...
                        <div class="metis-field">
                            ...
                            <select id="metis-newsletter-theme-divider-style" class="metis-input metis-input-wide">
                        ...
                        <div class="metis-field">
                            ...
                            <input id="metis-newsletter-theme-divider-weight" class="metis-input metis-input-wide" type="range" min="1" max="6" step="1" value="<?php echo metis_escape_attr((string) ((int) ($newsletter_theme_defaults['divider_weight'] ?? 1))); ?>">
                    ...
                    <section class="metis-newsletter-theme-section-card" id="metis-newsletter-theme-<?php echo metis_escape_attr($section_key); ?>">
                        ...
                        <div class="metis-newsletter-theme-form metis-newsletter-theme-form--two">
                            <div class="metis-field">
                                ...
                                <select id="metis-newsletter-theme-<?php echo metis_escape_attr($section_key); ?>-bg" class="metis-input metis-input-wide">
                                    <?php foreach ($newsletter_color_options as $value => $label) : ?>
                            ...
                            <div class="metis-field">
                                ...
                                <select id="metis-newsletter-theme-<?php echo metis_escape_attr($section_key); ?>-text-color" class="metis-input metis-input-wide">
                                    <?php foreach ($newsletter_color_options as $value => $label) : ?>
                            ...
                            <div class="metis-field metis-newsletter-theme-padding-group">
                                ...
                                <div class="metis-theme-box4 metis-newsletter-theme-box4" data-padding-group="<?php echo metis_escape_attr($section_key); ?>">
                                    ...
                                    <div class="metis-theme-box4-grid">
                                        <input type="text" class="metis-input metis-theme-box4-input" data-side="top" placeholder="T" value="<?php echo metis_escape_attr((string) $pad[0]); ?>">
                                        <input type="text" class="metis-input metis-theme-box4-input" data-side="right" placeholder="R" value="<?php echo metis_escape_attr((string) $pad[1]); ?>">
                                        <input type="text" class="metis-input metis-theme-box4-input" data-side="bottom" placeholder="B" value="<?php echo metis_escape_attr((string) $pad[2]); ?>">
                                        <input type="text" class="metis-input metis-theme-box4-input" data-side="left" placeholder="L" value="<?php echo metis_escape_attr((string) $pad[3]); ?>">
                                    </div>
                                </div>
    ...
    <div id="metis-newsletter-theme-inline-image-modal" class="metis-modal-backdrop metis-featured-image-modal" role="dialog" aria-modal="true" aria-hidden="true" aria-label="Inline Image Picker">
        <div class="metis-modal metis-featured-image-modal__dialog">
            <div class="metis-modal-header">
                <div>
                    <h2 class="metis-modal-title">Insert Image</h2>
                    <div id="metis-newsletter-theme-inline-image-count" class="metis-featured-image-modal__count">Loading images...</div>
                </div>
                <button type="button" class="metis-modal-close" id="metis-newsletter-theme-inline-image-close" aria-label="Close">&times;</button>
            </div>
            <div class="metis-modal-body">
                <div class="metis-featured-image-modal__toolbar">
                    <input id="metis-newsletter-theme-inline-image-search" class="metis-input" type="search" placeholder="Search images by name or type">
                    <select id="metis-newsletter-theme-inline-image-mime" class="metis-input">
            ...
            <div class="metis-modal-footer">
                <button type="button" class="metis-btn" id="metis-newsletter-theme-inline-image-cancel">Close</button>
            </div>
        </div>
    </div>
