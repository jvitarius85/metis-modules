...
if ( ! function_exists( 'metis_finance_can_view' ) || ! metis_finance_can_view() ) {
    echo '<div class="metis-alert metis-alert-error">You do not have permission to view Finance.</div>';
    return;
}
...
>
    <h1 class="metis-page-title"><?php echo metis_escape_html( metis_current_module_view_title( 'Finance' ) ); ?></h1>
    <p class="metis-subtitle">Finance workspace for GL entry, monthly reconciliation, budget, invoicing, reports, settings, and Stripe clearing.</p>

    <div class="metis-sidebar-layout metis-finance-v2-layout">
        <aside class="metis-sidebar-layout-sidebar metis-finance-v2-layout-sidebar">
            <div class="metis-sidebar-layout-sidebar-inner metis-finance-v2-layout-sidebar-inner">
                <div class="metis-list-sidebar-actions">
                    <div class="metis-list-sidebar-label">Finance</div>
                    <nav class="metis-list-sidebar-nav" aria-label="Finance sections">
                        <?php foreach ( $section_views as $view => $label ) : ?>
                            <?php if ( $view === 'reconciliation_steps' ) { continue; } ?>
                            <a class="metis-list-sidebar-nav-item<?php echo $current_section === $view ? ' is-active' : ''; ?>" href="<?php echo metis_escape_url( $section_url( $view ) ); ?>"><?php echo metis_escape_html( $label ); ?></a>
                        <?php endforeach; ?>
                    </nav>
                </div>
        ...
        <div class="metis-sidebar-layout-content metis-finance-v2-layout-content">
            <?php if ( $current_section === 'snapshot' ) : ?>
                ...
                <section class="metis-settings-card metis-finance-v2-snapshot-card">
                    <div class="metis-settings-header"><h2>Financial Overview</h2></div>
                ...
                <section class="metis-settings-card metis-finance-v2-snapshot-card">
                    <div class="metis-settings-header"><h2>Financial Performance</h2></div>
                    <div class="metis-settings-body">
            ...
            <div class="metis-settings-header"><h2>GL Entry</h2></div>
            <div class="metis-settings-body">
                    <div class="metis-settings-actions" style="padding:0;">
                        <button type="button" class="metis-btn" data-open-gl-modal="1">Quick GL Entry</button>
                    </div>
                    <p class="metis-help">Use the quick entry modal to add multiple ledger rows at once.</p>
            ...
            <?php if ( $current_section === 'reconciliation' ) : ?>
                <section class="metis-settings-card metis-finance-v2-recon-panel is-active" data-recon-spa-panel="list">
            <div class="metis-settings-header"><h2>Reconciliation</h2></div>
            <div class="metis-settings-body">
                    <div class="metis-settings-actions" style="padding:0;">
                        <button type="button" class="metis-btn" data-recon-open-workflow="1">Start Reconciliation</button>
                        <button type="button" class="metis-btn metis-btn-ghost" data-finance-recon-reopen="1">Reopen Selected Month</button>
                        <input type="text" class="metis-input metis-finance-v2-recon-reason" data-finance-recon-reopen-reason="1" placeholder="Reason required to reopen finalized month">
                    </div>
            ...
            <?php if ( $current_section === 'reconciliation_steps' || $current_section === 'reconciliation' ) : ?>
                <section id="metis-reconciliation-workflow" class="metis-settings-card<?php echo ( $current_section === 'reconciliation' ) ? ' metis-finance-v2-recon-panel' : ''; ?>"<?php echo ( $current_section === 'reconciliation' ) ? ' data-recon-spa-panel="workflow"' : ''; ?>>
            <div class="metis-settings-header"><h2>Reconciliation Workflow</h2></div>
            <div class="metis-settings-body">
                    <?php if ( $current_section === 'reconciliation' ) : ?>
                        <div class="metis-settings-actions" style="padding:0;">
                            <button type="button" class="metis-btn metis-btn-ghost" data-recon-back-list="1">Back To Reconciliation List</button>
                        </div>
                    <?php endif; ?>
                    <?php if ( $current_section === 'reconciliation_steps' ) : ?>
                        <div class="metis-settings-actions" style="padding:0;">
                            <a href="<?php echo metis_escape_url( $recon_list_url ); ?>" class="metis-btn metis-btn-ghost">Back To Reconciliation List</a>
                        </div>
                    <?php endif; ?>
                    <div class="metis-finance-v2-step-nav" role="tablist" aria-label="Reconciliation steps">
                        <button type="button" class="metis-btn metis-btn-ghost is-active" data-recon-step-nav="setup">1) Setup Month</button>
                        <button type="button" class="metis-btn metis-btn-ghost" data-recon-step-nav="review">2) Review Transactions</button>
                        <button type="button" class="metis-btn metis-btn-ghost" data-recon-step-nav="finalize">3) Finalize</button>
                    </div>
                    <div class="metis-finance-v2-recon-summary-grid">
                        <article class="metis-finance-v2-overview-item">
                            ...
                            <dl>
                                ...
                                <div><dt>Statement</dt><dd><a href="#" class="metis-btn metis-btn-xs metis-btn-ghost" data-recon-statement-link="1" target="_blank" rel="noopener">Not Attached</a></dd></div>
                            </dl>
                        </article>
                        <article class="metis-finance-v2-overview-item">
                            <h3>Balances</h3>
                        ...
                        <form data-finance-recon-form="1" class="metis-finance-v2-form metis-finance-v2-recon-start-form">
                            <div class="metis-finance-v2-form-grid">
                                <div class="metis-field">
                                    ...
                                    <input id="finance_recon_month" name="recon_month" type="month" class="metis-input" required>
                                </div>
                                <div class="metis-field">
                                    <label for="finance_recon_starting_balance">Starting Balance (optional)</label>
                                    <input id="finance_recon_starting_balance" name="starting_balance" type="number" class="metis-input" step="0.01" placeholder="Auto from prior month if blank">
                                </div>
                                <div class="metis-field">
                                    <label for="finance_recon_statement_ending">Statement Ending Balance</label>
                                    <input id="finance_recon_statement_ending" name="statement_ending_balance" type="number" class="metis-input" step="0.01" required>
                                </div>
                                <div class="metis-field">
                                    <label for="finance_recon_file">Statement PDF</label>
                                    <input id="finance_recon_file" name="recon_file" type="file" class="metis-input" accept=".pdf,application/pdf">
                                </div>
                            </div>
                            <div class="metis-settings-actions" style="padding:0;">
                                <button type="submit" class="metis-btn" data-finance-recon-submit="1">Save Month Setup</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="metis-finance-v2-step-page" data-recon-step-page="finalize">
                        <div class="metis-settings-actions" style="padding:0;">
                            <button type="button" class="metis-btn" data-finance-recon-finalize="1">Finalize Month</button>
                        </div>
                        <p class="metis-help">Finalize is available only when difference is 0.00.</p>
                    </div>
                    <?php if ( $current_section === 'reconciliation_steps' ) : ?>
                        <div class="metis-finance-v2-grid metis-finance-v2-grid--stacked">
                            <div class="metis-finance-v2-table-wrap">
            ...
            <?php if ( $current_section === 'budget' ) : ?>
                <section class="metis-settings-card">
        <div class="metis-settings-header"><h2>Budget</h2></div>
        <div class="metis-settings-body">
            <div class="metis-finance-v2-budget-toolbar">
                <div class="metis-field">
                    <label for="finance_budget_version_selector">Version</label>
                    <select id="finance_budget_version_selector" class="metis-input" data-budget-version-selector="1"></select>
                </div>
                <div class="metis-field">
                    <label>Version Status</label>
                    <div data-budget-version-status="1" class="metis-help">-</div>
                </div>
            </div>
                ...
                <form data-finance-budget-quick-form="1" class="metis-finance-v2-form">
                    ...
                    <div class="metis-finance-v2-form-grid">
                        <div class="metis-field">
                            ...
                            <input id="budget_quick_version_label" name="version_label" type="text" class="metis-input" placeholder="FY 2026 Working v2" required>
                        </div>
                    </div>
                    <div class="metis-settings-actions" style="padding:0;">
                        <button type="submit" class="metis-btn" data-budget-quick-submit="1">Create From Previous</button>
                    </div>
                </form>
                ...
                <form data-finance-budget-version-form="1" class="metis-finance-v2-form">
                    ...
                    <div class="metis-finance-v2-form-grid">
                        <div class="metis-field">
                            ...
                            <input id="budget_version_label" name="version_label" type="text" class="metis-input" placeholder="FY 2026 Working v2" required>
                        </div>
                        <div class="metis-field">
                            <label for="budget_fiscal_year">Fiscal Year</label>
                            <input id="budget_fiscal_year" name="fiscal_year" type="number" min="2000" max="3000" class="metis-input" required>
                        </div>
                        <div class="metis-field">
                            <label for="budget_period_start">Period Start</label>
                            <input id="budget_period_start" name="period_start" type="date" class="metis-input" required>
                        </div>
                        <div class="metis-field">
                            <label for="budget_period_end">Period End</label>
                            <input id="budget_period_end" name="period_end" type="date" class="metis-input" required>
                        </div>
                    </div>
                    <div class="metis-settings-actions" style="padding:0;">
                        <button type="submit" class="metis-btn" data-budget-version-submit="1">Create Version</button>
                    </div>
                </form>
                </details>
            ...
            <div class="metis-finance-v2-table-wrap">
                ...
                <div class="metis-settings-actions" style="padding:0;">
                    <button type="button" class="metis-btn" data-budget-lines-save="1">Save Budget Lines</button>
                </div>
        </div>
                </section>
            <?php endif; ?>
        ...
        <div class="metis-settings-body">
            ...
            <?php if ( $current_section === 'invoicing' ) : ?>
                <section class="metis-settings-card">
        <div class="metis-settings-header"><h2>Invoicing</h2></div>
        <div class="metis-settings-body">
            <div class="metis-finance-v2-kpis metis-finance-v2-kpis--aging">
                ...
                <div class="metis-settings-actions" style="padding:0;">
                    <button type="button" class="metis-btn" data-open-invoice-modal="1">Create Invoice</button>
                </div>
            ...
            <?php if ( $current_section === 'reports' ) : ?>
                <section class="metis-settings-card">
        <div class="metis-settings-header"><h2>Reports (PDF)</h2></div>
        <div class="metis-settings-body">
            <form data-finance-report-form="1" class="metis-finance-v2-form">
                <div class="metis-finance-v2-form-grid">
                    <div class="metis-field">
                        <label for="finance_report_type">Report</label>
                        <select id="finance_report_type" name="report_type" class="metis-input">
                    ...
                    <div class="metis-field">
                        ...
                        <select id="finance_report_period" name="period_code" class="metis-input">
                    ...
                    <div class="metis-field">
                        ...
                        <select id="finance_report_orientation" name="orientation" class="metis-input">
            ...
            <?php if ( $current_section === 'stripe_clearing' ) : ?>
                <section class="metis-settings-card">
            <div class="metis-settings-header"><h2>Stripe Clearing</h2></div>
        <div class="metis-settings-body">
            ...
            <p class="metis-help">Stripe webhooks feed clearing activity. This screen is for auto-match monitoring and unresolved exceptions.</p>
            <div class="metis-settings-actions" style="padding:0;">
                <button type="button" class="metis-btn" data-finance-stripe-auto-match="1">Run Auto-Match</button>
                <button type="button" class="metis-btn metis-btn-ghost" data-finance-stripe-refresh="1">Refresh</button>
            </div>
    ...
    <div id="metis-finance-gl-modal" class="metis-modal-backdrop" aria-hidden="true">
        <div class="metis-modal metis-finance-v2-modal-inner">
            ...
            <form data-finance-gl-form="1" class="metis-finance-v2-form">
                ...
                <div class="metis-settings-actions" style="padding:0;">
                    <button type="button" class="metis-btn metis-btn-ghost" data-gl-add-row="1">Add Row</button>
                    <button type="submit" class="metis-btn" data-finance-gl-submit="1">Save Entries</button>
                    <button type="button" class="metis-btn metis-btn-ghost" data-close-gl-modal="1">Close</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <form data-finance-invoice-form="1" class="metis-finance-v2-form">
                <div class="metis-finance-v2-form-grid">
                    <div class="metis-field">
                        ...
                        <input id="invoice_customer_name" name="customer_name" type="text" class="metis-input" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_customer_email">Customer Email</label>
                        <input id="invoice_customer_email" name="customer_email" type="email" class="metis-input" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_issued_date">Issue Date</label>
                        <input id="invoice_issued_date" name="issued_date" type="date" class="metis-input" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_due_date">Due Date</label>
                        <input id="invoice_due_date" name="due_date" type="date" class="metis-input" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_line_description">Line Description</label>
                        <input id="invoice_line_description" name="line_description" type="text" class="metis-input" placeholder="Monthly program services" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_line_quantity">Qty</label>
                        <input id="invoice_line_quantity" name="line_quantity" type="number" min="0.01" step="0.01" class="metis-input" value="1.00" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_line_unit_amount">Unit Amount</label>
                        <input id="invoice_line_unit_amount" name="line_unit_amount" type="number" min="0" step="0.01" class="metis-input" required>
                    </div>
                    <div class="metis-field">
                        <label for="invoice_notes">Notes (optional)</label>
                        <input id="invoice_notes" name="notes" type="text" class="metis-input" placeholder="Stripe payment only">
                    </div>
                </div>
                <div class="metis-settings-actions" style="padding:0;">
                    <button type="submit" class="metis-btn" data-finance-invoice-submit="1">Create Invoice</button>
                    <button type="button" class="metis-btn metis-btn-ghost" data-close-invoice-modal="1">Close</button>
                </div>
            </form>
        </div>
    </div>
