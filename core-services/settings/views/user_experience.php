...
<p class="metis-subtitle">Configure profile rules and accessibility defaults.</p>
<?php metis_settings_render_messages( $saved, $errors ); ?>
<?php metis_settings_render_section_nav( 'user_experience' ); ?>
<form method="post" class="metis-settings-form" data-metis-settings-form="1" data-settings-section="user_experience">
    <?php metis_runtime_nonce_field( 'metis_save_settings_user_experience', 'metis_settings_nonce' ); ?>
    <div class="metis-settings-card">
        <div class="metis-settings-header"><h2>Profile Rules</h2></div>
        <div class="metis-settings-body">
            <div class="metis-field">
                ...
                <p class="metis-help">If disabled, self-service name fields remain read-only.</p>
            </div>
        </div>
    </div>
    ...
    <div class="metis-settings-actions">
        <button type="submit" class="metis-btn">Save User Experience Settings</button>
    </div>
</form>
