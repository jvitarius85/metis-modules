                ...
                ?>
                    <div class="metis-newsletter-dashboard-row" <?php if ($href !== '') : ?>data-row-href="<?php echo metis_escape_url($href); ?>"<?php endif; ?>>
                        <div class="metis-newsletter-dashboard-main">
                            ...
                            <div class="metis-muted"><?php echo metis_escape_html((string) ($sub['email'] ?? '')); ?></div>
                        ...
                        <div><span class="metis-chip metis-chip-success">ACTIVE</span></div>
                    </div>
                <?php endforeach; ?>
                <?php if (empty($recent_subscribers)) : ?><div class="metis-muted">No subscribers yet.</div><?php endif; ?>
            </div>
        </section>
                ...
                ?>
                    <div class="metis-newsletter-dashboard-row" data-row-href="<?php echo metis_escape_url($href); ?>">
                        <div class="metis-newsletter-dashboard-main">
                            ...
                            <div class="metis-muted"><?php echo metis_escape_html(metis_newsletter_format_datetime((string) ($campaign['updated_at'] ?? ''))); ?></div>
                        </div>
                        <div class="metis-newsletter-dashboard-status">
                            <span class="metis-chip <?php echo $status === 'sent' ? 'metis-chip-success' : ''; ?>"><?php echo metis_escape_html(strtoupper($status)); ?></span>
                            <span class="metis-newsletter-rate-chip"><?php echo metis_escape_html((string) $engagement); ?>%</span>
                        </div>
                    </div>
                <?php endforeach; ?>
                <?php if (empty($recent_campaigns)) : ?><div class="metis-muted">No campaigns yet.</div><?php endif; ?>
            </div>
        </section>
    </div>
    <?php },
