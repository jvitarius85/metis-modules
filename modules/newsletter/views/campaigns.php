...
<div class="metis-newsletter" data-can-manage="<?php echo metis_escape_attr($can_manage ? '1' : '0'); ?>">
    <?php if (!$compose_mode) : ?>
    <h1 class="mw-page-title"><?php echo metis_escape_html( metis_current_module_view_title( 'Newsletter Campaigns' ) ); ?></h1>
    ...
    <aside class="mw-list-sidebar">
        <div class="mw-list-sidebar-section">
            ...
            <nav class="mw-list-sidebar-nav">
                ...
                <a class="mw-list-sidebar-nav-item is-active" href="<?php echo metis_escape_url($campaigns_url); ?>">Campaigns</a>
        ...
        <div class="mw-list-sidebar-section">
            ...
            <nav class="mw-list-sidebar-nav">
                <a class="mw-list-sidebar-nav-item <?php echo $campaign_view === 'active' ? 'is-active' : ''; ?>" href="<?php echo metis_escape_url((string) $campaign_view_urls['active']); ?>">Active</a>
                <a class="mw-list-sidebar-nav-item <?php echo $campaign_view === 'archived' ? 'is-active' : ''; ?>" href="<?php echo metis_escape_url((string) $campaign_view_urls['archived']); ?>">Archived</a>
                <a class="mw-list-sidebar-nav-item <?php echo $campaign_view === 'all' ? 'is-active' : ''; ?>" href="<?php echo metis_escape_url((string) $campaign_view_urls['all']); ?>">All</a>
            </nav>
        </div>
        <div class="mw-list-sidebar-section">
        ...
        <div class="mw-list-sidebar-actions">
            <?php if ($compose_mode) : ?>
                <a href="<?php echo metis_escape_url($campaigns_url); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">&larr; Back to Campaigns</a>
            <?php else : ?>
    ...
    <section class="mw-premium-table metis-newsletter-table" id="metis-newsletter-campaigns-panel">
        ...
        <div id="metis-newsletter-campaign-rows">
            ...
            ?>
                <div class="mw-premium-row metis-newsletter-row <?php echo $is_unsent ? 'is-draft' : ''; ?>" data-search="<?php echo metis_escape_attr($search_blob); ?>"
                    ...
                    <div class="mw-premium-cell">
                        ...
                        <div class="mw-muted"><?php echo metis_escape_html((string) ($campaign['campaign_code'] ?? '')); ?></div>
                    </div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($campaign['subject'] ?? '')); ?></div>
                    <div class="mw-premium-cell">
                        <?php if (!empty($row_lists)) : ?>
                            <div class="metis-newsletter-chip-wrap">
                                <?php foreach ($row_lists as $list_row) : ?>
                                    <span class="mw-chip"><?php echo metis_escape_html((string) ($list_row['name'] ?? '')); ?></span>
                                <?php endforeach; ?>
                            </div>
                        <?php else : ?><span class="mw-muted">—</span><?php endif; ?>
                    </div>
                    <div class="mw-premium-cell"><span class="mw-chip"><?php echo metis_escape_html($status); ?></span></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html((string) ((int) ($campaign['total_recipients'] ?? 0))); ?></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html(metis_newsletter_format_datetime((string) ($campaign['updated_at'] ?? ''))); ?></div>
                    <?php if ($can_manage) : ?>
                        <div class="mw-premium-cell metis-newsletter-actions-cell">
                            <?php if ($status !== 'archived') : ?>
                                <button class="mw-btn-xs metis-newsletter-test-campaign" type="button" data-campaign-id="<?php echo metis_escape_attr((string) $campaign_id); ?>">Test</button>
                            <?php endif; ?>
                            <?php if (!$is_sentish && $status !== 'queued' && $status !== 'scheduled') : ?>
                                <button class="mw-btn-xs metis-newsletter-edit-campaign" type="button" data-campaign-code="<?php echo metis_escape_attr((string) ($campaign['campaign_code'] ?? '')); ?>" data-campaign-id="<?php echo metis_escape_attr((string) $campaign_id); ?>">Edit</button>
                            <?php endif; ?>
                            <?php if (!$is_sentish) : ?>
                                <button class="mw-btn-xs metis-newsletter-queue-campaign" type="button" data-campaign-id="<?php echo metis_escape_attr((string) $campaign_id); ?>">Send</button>
                                <button class="mw-btn-xs mw-btn-danger metis-newsletter-delete-campaign" type="button" data-campaign-id="<?php echo metis_escape_attr((string) $campaign_id); ?>">Delete</button>
                            <?php elseif ($status === 'sent') : ?>
                                <button class="mw-btn-xs mw-btn-danger metis-newsletter-archive-campaign" type="button" data-campaign-id="<?php echo metis_escape_attr((string) $campaign_id); ?>">Archive</button>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
