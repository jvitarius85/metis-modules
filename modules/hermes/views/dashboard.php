...
<div class="metis-hermes-health" data-hermes-dashboard>
    <section class="mw-module-layout-header metis-hermes-hero">
        <div class="metis-hermes-hero-copy">
            <span class="metis-hermes-eyebrow">Hermes System Health</span>
            <h1 class="mw-page-title"><?php echo metis_escape_html( metis_current_module_label( 'Hermes' ) ); ?></h1>
            <p class="mw-subtitle">Hermes aggregates Diagnostic Engine findings and worker framework state into permission-aware health surfaces, without relying on dashboard AJAX or legacy CMS API calls.</p>
        </div>
    ...
    <section class="mw-stats-row metis-hermes-overview-grid">
        <article class="mw-stat-card metis-hermes-stat-card">
            <span class="mw-stat-label metis-hermes-stat-label">Module Health</span>
            <strong class="mw-stat-value"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['module_count'] ?? 0 ) ) ); ?></strong>
            <span class="mw-stat-sub metis-hermes-stat-note">Hermes context packs under watch</span>
        </article>
        <article class="mw-stat-card metis-hermes-stat-card">
            <span class="mw-stat-label metis-hermes-stat-label">Alerts</span>
            <strong class="mw-stat-value"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['high_alert_count'] ?? 0 ) ) ); ?></strong>
            <span class="mw-stat-sub metis-hermes-stat-note"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['alert_count'] ?? 0 ) ) ); ?> active alerts total</span>
        </article>
        <article class="mw-stat-card metis-hermes-stat-card">
            <span class="mw-stat-label metis-hermes-stat-label">Integrations</span>
            <strong class="mw-stat-value"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['integration_failure_count'] ?? 0 ) ) ); ?></strong>
            <span class="mw-stat-sub metis-hermes-stat-note">Cross-surface failures requiring attention</span>
        </article>
        <article class="mw-stat-card metis-hermes-stat-card">
            <span class="mw-stat-label metis-hermes-stat-label">Workers</span>
            <strong class="mw-stat-value"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['worker_issue_count'] ?? 0 ) ) ); ?></strong>
            <span class="mw-stat-sub metis-hermes-stat-note">Cron or queue issues detected</span>
        </article>
        <article class="mw-stat-card metis-hermes-stat-card">
            <span class="mw-stat-label metis-hermes-stat-label">Reconciliation</span>
            <strong class="mw-stat-value"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['reconciliation_anomaly_count'] ?? 0 ) ) ); ?></strong>
            <span class="mw-stat-sub metis-hermes-stat-note">Open anomalies across finance snapshots</span>
        </article>
        <article class="mw-stat-card metis-hermes-stat-card">
            <span class="mw-stat-label metis-hermes-stat-label">Permissions</span>
            <strong class="mw-stat-value"><?php echo metis_escape_html( metis_number_format( (int) ( $overview['permission_issue_count'] ?? 0 ) ) ); ?></strong>
            <span class="mw-stat-sub metis-hermes-stat-note">Manifest or access mismatches</span>
        </article>
    </section>
