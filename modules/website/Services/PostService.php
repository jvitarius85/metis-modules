...
final class PostService {
    ...
    public static function create( array $data ): ?Post {
        ...
        if ( function_exists( 'metis_entity_id_service' ) ) {
            $insert = \metis_entity_id_service()->assignForInsert( 'website_post', $insert );
        } else {
            $insert['post_code'] = \metis_generate_code( 'WBP', $table, 'post_code' );
        }
        ...
        if ( function_exists( 'metis_entity_id_service' ) ) {
            \metis_entity_id_service()->register( 'website_post', $new_id, (string) ( $insert['post_code'] ?? '' ) );
        }
    ...
    public static function delete( int $id ): bool {
        return (bool) self::db()->delete( \Metis_Tables::get( 'website_posts' ), [ 'id' => $id ] );
    }
    ...
    private static function hasColumn( string $column ): bool {
        if ( self::$columnMap === null ) {
            $rows = self::db()->fetchAll( 'SHOW COLUMNS FROM ' . \Metis_Tables::get( 'website_posts' ) );
            self::$columnMap = [];
