...
final class WebsiteRenderer {
    ...
    private static function publicBaseCss(): string {
        return implode( "\n", [
            ...
            '.metis-structured-events-wrap--calendar{width:min(1200px,calc(100vw - 32px));max-width:100%;margin:0 auto;}',
            ...
            '.metis-structured-events-month-head{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:6px;}',
            ...
            '.metis-structured-events-month-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:8px;align-items:stretch;}',
            ...
            '.metis-structured-events-peek:not(.is-all-day){display:block;background:var(--metis-color-accent,#ff7542);border:1px solid color-mix(in srgb,var(--metis-color-primary,#485bc7) 24%,transparent);border-radius:12px;padding:5px 6px;box-shadow:none;max-width:100%;overflow:hidden;}',
