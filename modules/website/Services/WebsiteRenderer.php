...
final class WebsiteRenderer {
    ...
    private static function publicBaseCss(): string {
        return implode( "\n", [
            ...
            '.metis-shell-header-inner{max-width:1200px;margin:0 auto;padding:14px 28px;display:flex;align-items:center;justify-content:space-between;gap:24px;}',
            ...
            '.metis-public-content .metis-transcript__row--right .metis-transcript__body,.metis-structured-section__content .metis-transcript__row--right .metis-transcript__body{text-align:left;}',
            ...
            '.metis-structured-columns{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));gap:28px;}',
            ...
            '.metis-structured-feature-grid__item{background:var(--metis-color-surface_alt,#f8fafc);border:1px solid var(--metis-color-border,#dbe3ef);border-radius:12px;padding:20px;display:flex;flex-direction:column;align-items:flex-start;justify-content:flex-start;gap:10px;height:100%;min-height:100%;overflow:hidden;}',
            '.metis-structured-feature-grid__icon{display:flex;align-items:center;justify-content:center;width:104px;height:104px;margin:0 auto 10px;color:var(--metis-color-primary,#485bc7);}',
            '.metis-structured-feature-grid__icon svg{display:block;width:68px;height:68px;}',
            '.metis-structured-feature-grid__icon svg [stroke]{stroke:currentColor;stroke-width:3.2 !important;vector-effect:non-scaling-stroke;stroke-linecap:round;stroke-linejoin:round;}',
            '.metis-structured-feature-grid__icon svg [fill]:not([fill="none"]){fill:currentColor;}',
            '.metis-structured-feature-grid__title{margin:0;font-size:1.06rem;line-height:1.24;}',
            '.metis-structured-feature-grid__text{margin:0;font-size:.95rem;line-height:1.55;}',
            '.metis-structured-feature-grid__cta{width:100%;display:flex;justify-content:center;margin-top:auto;padding-top:8px;}',
            ...
            '.metis-structured-posts-list--cards{width:100%;grid-template-columns:repeat(4,minmax(0,1fr));column-gap:20px;row-gap:42px;justify-content:stretch;align-items:stretch;padding:8px 0 18px;}',
            '@media (max-width:1100px){.metis-structured-posts-list--cards{grid-template-columns:repeat(2,minmax(0,1fr));}}',
            '@media (max-width:520px){.metis-structured-posts-list--cards{grid-template-columns:1fr;}}',
            ...
            '.metis-public-popup__dialog{position:relative;background:#fff;color:#0f172a;max-width:min(700px,92vw);max-height:calc(100vh - 72px);overflow:visible;border-radius:18px;padding:22px 18px;box-shadow:0 20px 60px rgba(2,6,23,.35);}',
            '.metis-public-popup__body{max-height:calc(100vh - 144px);overflow:auto;}',
            '.metis-public-popup__close{position:absolute;top:-14px;right:-14px;z-index:2;display:inline-flex;align-items:center;justify-content:center;inline-size:52px;block-size:52px;min-inline-size:52px;min-block-size:52px;max-inline-size:52px;max-block-size:52px;flex:0 0 52px;aspect-ratio:1/1;box-sizing:border-box;padding:0;margin:0;border:3px solid #fff;border-radius:50% !important;clip-path:circle(50% at 50% 50%);background:color-mix(in srgb,var(--metis-color-primary,#485bc7) 78%,var(--metis-color-accent,#ff7542));cursor:pointer;color:var(--metis-color-button_text,#fff);box-shadow:0 16px 34px rgba(15,23,42,.24);line-height:1;-webkit-appearance:none;appearance:none;}',
            ...
            '.metis-public-popup__dialog.has-payment-form{max-width:min(940px,96vw);max-height:calc(100vh - 44px);padding:16px 20px 20px;}',
            ...
            '@media (min-width: 981px) and (max-width: 1260px){.metis-shell-header-inner{padding-left:32px;padding-right:32px;gap:18px;}body.metis-public-site .metis-template .metis-template-sticky-capable{padding-left:24px !important;padding-right:24px !important;}body.metis-public-site .metis-template .metis-template-header-inner{gap:28px !important;}body.metis-public-site .metis-template .metis-template-nav-panel{gap:12px !important;}}',
            self::mobileFlyoutMenuCss(),
            '@media (max-width: 900px){.metis-block-grid{grid-template-columns:1fr !important;}.metis-structured-columns{grid-template-columns:1fr;gap:22px;}.metis-structured-columns__col.is-w25,.metis-structured-columns__col.is-w33,.metis-structured-columns__col.is-w50,.metis-structured-columns__col.is-w100{grid-column:1/-1;}.metis-structured-feature-grid.cols-2,.metis-structured-feature-grid.cols-3,.metis-structured-feature-grid.cols-4{grid-template-columns:repeat(2,minmax(0,1fr));}.metis-structured-cta--split,.metis-structured-hero-block{grid-template-columns:1fr;}.metis-structured-hero-block{padding:18px;}}',
            '@media (max-width: 720px){.metis-structured-events-wrap--week .metis-structured-events-week-grid,.metis-structured-events-wrap--calendar .metis-structured-events-month-head,.metis-structured-events-wrap--calendar .metis-structured-events-month-grid{display:none;}.metis-structured-events-wrap--week .metis-structured-events-mobile-list,.metis-structured-events-wrap--calendar .metis-structured-events-mobile-list{display:grid;}.metis-structured-events__nav{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;align-items:start;}.metis-structured-events__nav-title{grid-column:1/-1;order:1;justify-self:center;}.metis-structured-events__nav>.metis-structured-events__nav-btn{order:2;justify-self:stretch;width:100%;}.metis-structured-events__nav-actions{order:3;justify-self:stretch;justify-content:stretch;}.metis-structured-events__nav-actions .metis-structured-events__nav-btn{width:100%;}.metis-structured-feature-grid{gap:16px;}.metis-structured-feature-grid__item{padding:16px;gap:8px;}.metis-structured-feature-grid__icon{width:88px;height:88px;margin-bottom:6px;}.metis-structured-feature-grid__icon svg{width:58px;height:58px;}.metis-public-content .metis-structured-posts-list__title,.metis-structured-section__content .metis-structured-posts-list__title{font-size:.96rem;line-height:1.24;}.metis-public-content .metis-structured-posts-list__excerpt,.metis-structured-section__content .metis-structured-posts-list__excerpt{font-size:.86rem;line-height:1.42;}}',
            ...
            '@media (max-width: 560px){.metis-structured-feature-grid.cols-2,.metis-structured-feature-grid.cols-3,.metis-structured-feature-grid.cols-4{grid-template-columns:repeat(2,minmax(0,1fr));}.metis-structured-feature-grid__item{padding:14px;}.metis-structured-feature-grid__icon{width:80px;height:80px;}.metis-structured-feature-grid__icon svg{width:54px;height:54px;}.metis-structured-feature-grid__title{font-size:.96rem;line-height:1.2;}.metis-structured-feature-grid__text{font-size:.84rem;line-height:1.4;}.metis-structured-feature-grid__cta-btn{min-width:0;width:100%;padding:10px 12px;font-size:.92rem;}}',
            '@media (max-width: 390px){.metis-structured-feature-grid.cols-2,.metis-structured-feature-grid.cols-3,.metis-structured-feature-grid.cols-4{grid-template-columns:1fr;}}',
        ] );
    }
    ...
    private static function mobileFlyoutMenuCss(): string {
        return '@media (max-width: 980px){'
            ...
            . 'body.metis-nav-mobile-viewport .metis-shell-nav-toggle{display:inline-flex !important;position:relative !important;top:auto !important;right:auto !important;z-index:4200 !important;justify-self:end !important;align-self:center !important;margin:0 !important;border-radius:999px !important;background:var(--metis-color-primary,#485bc7) !important;color:#fff !important;border:1px solid color-mix(in srgb,var(--metis-color-primary,#485bc7) 72%,#fff) !important;box-shadow:0 12px 26px rgba(15,23,42,.18) !important;}'
            . 'body.metis-nav-mobile-viewport .metis-shell-nav-toggle-lines span{background:currentColor !important;}'
            . 'body.metis-nav-mobile-viewport .metis-shell-header-inner,body.metis-nav-mobile-viewport .metis-template .metis-template-header-inner{display:grid !important;grid-template-columns:minmax(0,1fr) auto !important;align-items:center !important;gap:12px !important;padding-right:0 !important;}'
            . 'body.metis-nav-mobile-viewport .metis-shell-brand,body.metis-nav-mobile-viewport .metis-template .metis-template-brand{min-width:0 !important;max-width:100% !important;}'
            . 'body.metis-nav-mobile-viewport .metis-shell-brand-logo-header,body.metis-nav-mobile-viewport .metis-template .metis-template-brand-logo{max-height:68px !important;max-width:220px !important;}'
    ...
    private static function codepenGlideMenuCss( string $scope ): string {
        ...
        $rules = [
            ...
            $item . ':last-child::after{content:"";position:absolute;top:0;bottom:0;width:100%;right:50%;margin-right:-50%;border-radius:.5rem;background:rgba(0,0,0,.12);z-index:-1;opacity:0;transition:right 220ms cubic-bezier(.65,.2,.2,1),opacity 130ms ease;pointer-events:none;}',
            ...
            $item . '.has-children > .metis-shell-menu-link .metis-shell-menu-sub-indicator,' . $item . '.has-children > .metis-shell-menu-btn .metis-shell-menu-sub-indicator{color:currentColor;border-color:currentColor;transition:transform 180ms ease;}',
        ...
        for ( $position = 1; $position <= 12; $position++ ) {
            $rules[] = $item . ':is(:hover,:focus-within,.is-open) > .metis-shell-menu-sub > .metis-shell-menu-item:nth-child(' . $position . '){transition-delay:' . ( 65 * $position ) . 'ms;}';
        }
