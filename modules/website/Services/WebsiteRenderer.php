...
final class WebsiteRenderer {
    ...
    private static function publicBaseCss(): string {
        return implode( "\n", [
            ...
            '.metis-public-content .metis-transcript__row--right .metis-transcript__body,.metis-structured-section__content .metis-transcript__row--right .metis-transcript__body{text-align:right;}',
            ...
            '.metis-structured-feature-grid{display:grid;gap:20px;}',
            ...
            '.metis-structured-feature-grid__item{background:var(--metis-color-surface_alt,#f8fafc);border:1px solid var(--metis-color-border,#dbe3ef);border-radius:12px;padding:18px;display:flex;flex-direction:column;align-items:flex-start;justify-content:flex-start;gap:0;height:100%;min-height:100%;overflow:hidden;}',
            '.metis-structured-feature-grid__icon{display:flex;align-items:center;justify-content:center;width:88px;height:88px;margin:0 auto 18px;color:var(--metis-color-primary,#485bc7);}',
            '.metis-structured-feature-grid__icon svg{display:block;width:52px;height:52px;}',
            '.metis-structured-feature-grid__icon svg [stroke]{stroke:currentColor;stroke-width:2.8;vector-effect:non-scaling-stroke;stroke-linecap:round;stroke-linejoin:round;}',
            '.metis-structured-feature-grid__icon svg [fill]:not([fill="none"]){fill:currentColor;}',
            '.metis-structured-feature-grid__title{margin:0 0 8px;font-size:1.06rem;line-height:1.24;}',
            '.metis-structured-feature-grid__text{margin:0 0 10px;font-size:.95rem;line-height:1.55;}',
            ...
            '@media (max-width: 560px){.metis-structured-feature-grid.cols-2,.metis-structured-feature-grid.cols-3,.metis-structured-feature-grid.cols-4{grid-template-columns:1fr;}}',
        ] );
    }
