...
if ( ! metis_website_require_view_permission( 'categories' ) ) {
    return;
}
...
<div class="metis-website-status-grid metis-website-management-stats">
    ...
    <section class="metis-website-status-card">
        <span class="metis-website-status-label">Active</span>
        <strong><?php echo metis_escape_html( (string) $active_categories ); ?></strong>
        <span>Selectable in the post editor.</span>
    </section>
    <section class="metis-website-status-card">
        <span class="metis-website-status-label">Assigned Posts</span>
