...
$branding_field_defs = [
    'mw_primary' => [ 'label' => 'Primary', 'default' => '#485bc7' ],
    'mw_primary_dark' => [ 'label' => 'Primary Dark', 'default' => '#3246a7' ],
    'mw_accent' => [ 'label' => 'Accent', 'default' => '#ff7542' ],
    'mw_bg' => [ 'label' => 'Background', 'default' => '#f5f6fa' ],
    'mw_surface' => [ 'label' => 'Surface', 'default' => '#ffffff' ],
    'mw_border' => [ 'label' => 'Border', 'default' => '#e0e2ea' ],
    'mw_text' => [ 'label' => 'Text', 'default' => '#1f2330' ],
    'mw_text_muted' => [ 'label' => 'Muted Text', 'default' => '#6d7485' ],
    'mw_header_bg' => [ 'label' => 'Header Background', 'default' => '#eceeff' ],
    'mw_row_odd_bg' => [ 'label' => 'Row Odd Background', 'default' => '#ffffff' ],
    'mw_row_even_bg' => [ 'label' => 'Row Even Background', 'default' => '#f8f9fd' ],
    'mw_row_hover_bg' => [ 'label' => 'Row Hover Background', 'default' => '#eef2ff' ],
    'mw_sidebar_bg' => [ 'label' => 'Sidebar Background', 'default' => '#16192b' ],
    'mw_sidebar_icon_color' => [ 'label' => 'Sidebar Icon', 'default' => '#7a82a6' ],
    'mw_sidebar_active_color' => [ 'label' => 'Sidebar Active', 'default' => '#a8b4ff' ],
];
$branding_palette = [];
...
$branding_binding_defaults = [
    ...
    'border' => 'mw_border',
    'link' => 'mw_primary',
    'link_hover' => 'mw_primary_dark',
    'button_text' => 'mw_surface',
    'form_bg' => 'mw_surface',
    'card_bg' => 'mw_surface',
    'card_border' => 'mw_border',
];

$color_defaults = [
    'primary'       => $branding_palette['mw_primary'],
    'accent'        => $branding_palette['mw_accent'],
    'text'          => $branding_palette['mw_text'],
    'muted'         => $branding_palette['mw_text_muted'],
    'bg'            => $branding_palette['mw_bg'],
    'surface'       => $branding_palette['mw_surface'],
    'border'        => $branding_palette['mw_border'],
    'success'       => '#198754',
    'warning'       => '#b54708',
    'danger'        => '#dc3545',
    'link'          => '#2b59ff',
...
$local_font_dirs = [
    METIS_ROOT . '/assets/fonts',
    METIS_ROOT . '/modules/website/assets/fonts',
];
$local_font_seen = [];
$local_family_seen = [];
...
<div class="mw-page-header">
    <div class="mw-page-header-left">
        <h1 class="mw-page-title">Theme</h1>
        <p class="mw-subtitle"><?php echo $theme ? 'Active theme loaded.' : 'Create and activate a design system theme.'; ?></p>
    </div>
    <div class="mw-page-header-right">
        <button class="mw-btn mw-btn-ghost" id="metis-theme-reset-btn">Reset</button>
    </div>
</div>
        ...
        <section class="metis-theme-card" data-section="typography">
            ...
            <div class="metis-theme-grid metis-theme-grid-wide">
                <div class="metis-theme-field">
                    ...
                    <select id="metis-theme-body-font" class="mw-input">
                ...
                <div class="metis-theme-field">
                    ...
                    <select id="metis-theme-heading-font" class="mw-input">
                        <?php foreach ( $font_options as $value => $label ) : ?>
                ...
                <div class="metis-theme-field">
                    ...
                    <input type="number" id="metis-theme-base-size" class="mw-input" min="12" max="24" value="<?php echo metis_escape_attr( (string) $typography['base_size'] ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Line height</label>
                    <select id="metis-theme-line-height" class="mw-input">
                ...
                <div class="metis-theme-field">
                    ...
                    <select id="metis-theme-heading-weight" class="mw-input">
                ...
                <div class="metis-theme-field metis-theme-span-2">
                    ...
                    <div class="metis-theme-inline-grid">
                        <input type="text" id="metis-theme-custom-font-name" class="mw-input" placeholder="Font family name">
                        <input type="file" id="metis-theme-custom-font-file" class="mw-input" accept=".woff,.woff2,font/woff,font/woff2">
                    </div>
        ...
        <section class="metis-theme-card" data-section="layout">
            ...
            <div class="metis-theme-grid">
                <div class="metis-theme-field">
                    ...
                    <input type="number" id="metis-theme-max-width" class="mw-input" min="720" max="1920" value="<?php echo metis_escape_attr( (string) ( $global_styles['layout']['max_width'] ?? 1200 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Container width (px)</label>
                    <input type="number" id="metis-theme-container-width" class="mw-input" min="640" max="1600" value="<?php echo metis_escape_attr( (string) ( $global_styles['layout']['container_width'] ?? 860 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Spacing preset</label>
                    <select id="metis-theme-spacing-preset" class="mw-input">
                ...
                <div class="metis-theme-field">
                    ...
                    <input type="number" id="metis-theme-bp-sm" class="mw-input" min="360" max="2400" value="<?php echo metis_escape_attr( (string) ( $global_styles['layout_tokens']['breakpoints']['sm'] ?? 640 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Breakpoint MD (px)</label>
                    <input type="number" id="metis-theme-bp-md" class="mw-input" min="360" max="2400" value="<?php echo metis_escape_attr( (string) ( $global_styles['layout_tokens']['breakpoints']['md'] ?? 768 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Breakpoint LG (px)</label>
                    <input type="number" id="metis-theme-bp-lg" class="mw-input" min="360" max="2400" value="<?php echo metis_escape_attr( (string) ( $global_styles['layout_tokens']['breakpoints']['lg'] ?? 1024 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Breakpoint XL (px)</label>
                    <input type="number" id="metis-theme-bp-xl" class="mw-input" min="360" max="2400" value="<?php echo metis_escape_attr( (string) ( $global_styles['layout_tokens']['breakpoints']['xl'] ?? 1280 ) ); ?>">
                </div>
                <?php foreach ( $spacing_defaults as $key => $default ) : ?>
                    <div class="metis-theme-field">
                        ...
                        <input type="text" class="mw-input metis-theme-spacing" data-key="<?php echo metis_escape_attr( $key ); ?>" value="<?php echo metis_escape_attr( (string) ( $spacing[ $key ] ?? $default ) ); ?>">
                    </div>
                <?php endforeach; ?>
            </div>
        </section>
        ...
        <section class="metis-theme-card" data-section="components">
            ...
            <div class="metis-theme-grid metis-theme-grid-wide">
                <div class="metis-theme-field">
                    ...
                    <input type="number" id="metis-theme-btn-radius" class="mw-input" min="0" max="40" value="<?php echo metis_escape_attr( (string) ( $global_styles['components']['buttons']['radius'] ?? 8 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    ...
                    <div class="metis-theme-box4 metis-theme-box4--tight" data-component="buttons_padding">
                        ...
                        <div class="metis-theme-box4-grid">
                            <input type="text" class="mw-input metis-theme-box4-input" data-side="top" placeholder="T">
                            <input type="text" class="mw-input metis-theme-box4-input" data-side="right" placeholder="R">
                            <input type="text" class="mw-input metis-theme-box4-input" data-side="bottom" placeholder="B">
                            <input type="text" class="mw-input metis-theme-box4-input" data-side="left" placeholder="L">
                        </div>
                    </div>
                </div>
                <div class="metis-theme-field">
                ...
                <div class="metis-theme-field">
                    ...
                    <input type="number" id="metis-theme-card-radius" class="mw-input" min="0" max="40" value="<?php echo metis_escape_attr( (string) ( $global_styles['components']['cards']['radius'] ?? 12 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Form radius</label>
                    <input type="number" id="metis-theme-form-radius" class="mw-input" min="0" max="24" value="<?php echo metis_escape_attr( (string) ( $global_styles['components']['forms']['radius'] ?? 8 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Form border width</label>
                    <input type="number" id="metis-theme-form-border" class="mw-input" min="0" max="6" value="<?php echo metis_escape_attr( (string) ( $global_styles['components']['forms']['border'] ?? 1 ) ); ?>">
                </div>
                <div class="metis-theme-field">
                    <label class="metis-theme-label">Link underline</label>
                    <select id="metis-theme-link-underline" class="mw-input">
                    ...
                    <div class="metis-theme-menu-group">
                        ...
                        <div class="metis-theme-grid">
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-layout" class="mw-input">
                            ...
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-alignment" class="mw-input">
                            ...
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-container" class="mw-input">
                    ...
                    <div class="metis-theme-menu-group">
                        ...
                        <div class="metis-theme-grid">
                            <div class="metis-theme-field">
                                ...
                                <input type="number" id="metis-theme-menu-font-size" class="mw-input" min="11" max="28" value="<?php echo metis_escape_attr( (string) ( $menu_desktop['font_size'] ?? 14 ) ); ?>">
                            </div>
                            <div class="metis-theme-field">
                                <label class="metis-theme-label">Item spacing</label>
                                <select id="metis-theme-menu-spacing" class="mw-input">
                            ...
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-hover-style" class="mw-input">
                            ...
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-active-style" class="mw-input">
                    ...
                    <div class="metis-theme-menu-group">
                        ...
                        <div class="metis-theme-grid">
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-dropdown-behavior" class="mw-input">
                            ...
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-dropdown-animation" class="mw-input">
                    ...
                    <div class="metis-theme-menu-group">
                        ...
                        <div class="metis-theme-grid">
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-mobile-type" class="mw-input">
                    ...
                    <div class="metis-theme-menu-group">
                        ...
                        <div class="metis-theme-grid">
                            <div class="metis-theme-field">
                                ...
                                <select id="metis-theme-menu-chevron-style" class="mw-input">
        ...
        <section class="metis-theme-card" data-section="advanced">
            ...
            <div class="metis-theme-grid metis-theme-grid-wide">
                <div class="metis-theme-field metis-theme-span-2">
                    ...
                    <input type="text" id="metis-theme-title-format" class="mw-input" value="<?php echo metis_escape_attr( (string) ( $global_styles['global_settings']['title_format'] ?? '{page} | {site}' ) ); ?>" placeholder="{page} | {site}">
                </div>
                <div class="metis-theme-field metis-theme-span-2">
                    <label class="metis-theme-label">Theme portability</label>
                    <div class="metis-theme-preset-row">
                        <button type="button" class="mw-btn mw-btn-ghost" id="metis-theme-export-btn">Export Theme</button>
                        <button type="button" class="mw-btn mw-btn-ghost" id="metis-theme-import-btn">Import Theme</button>
                ...
                <div class="metis-theme-field metis-theme-span-2">
                    ...
                    <div class="metis-theme-inline-grid">
                        <select id="metis-theme-version-select" class="mw-input">
                            <option value="">Select saved snapshot</option>
                        </select>
                        <button type="button" class="mw-btn mw-btn-ghost" id="metis-theme-version-apply-btn">Apply Snapshot</button>
                    </div>
                </div>
                <div class="metis-theme-field metis-theme-span-2">
                ...
                <div class="metis-theme-field metis-theme-span-2">
                    ...
                    <textarea id="metis-theme-custom-css" class="mw-input" rows="8" placeholder=".metis-block-hero { border-radius: 18px; }"><?php echo esc_textarea( (string) ( $global_styles['advanced']['custom_css'] ?? '' ) ); ?></textarea>
                </div>
                <div class="metis-theme-field metis-theme-span-2">
                    <label class="metis-theme-label">Token editor (one per line: token-name: value)</label>
                    <textarea id="metis-theme-token-editor" class="mw-input" rows="8" placeholder="radius-lg: 20px&#10;shadow-soft: 0 8px 24px rgba(0,0,0,.08)"><?php
                        $token_lines = [];
...
<div class="metis-theme-floating-actions">
    <button class="mw-btn mw-btn-primary" id="metis-theme-save-btn">Save &amp; Activate</button>
</div>
    ...
    elementOrder.forEach(function(el) {
        ...
        elementFieldMap.forEach(function(field) {
            ...
            if (field.key === 'font_size') {
                ...
                html.push('<select class="mw-input metis-theme-element-input" id="' + id + '" data-element="' + el + '" data-prop="' + field.key + '">');
                ...
                html.push('<input type="hidden" class="metis-theme-element-input" id="' + id + '" data-element="' + el + '" data-prop="' + field.key + '">');
                html.push('<select class="mw-input metis-theme-color-token" data-element="' + el + '" data-prop="' + field.key + '">');
                ...
                html.push('<input type="text" class="mw-input metis-theme-box4-input" data-side="top" placeholder="T">');
                html.push('<input type="text" class="mw-input metis-theme-box4-input" data-side="right" placeholder="R">');
                html.push('<input type="text" class="mw-input metis-theme-box4-input" data-side="bottom" placeholder="B">');
                html.push('<input type="text" class="mw-input metis-theme-box4-input" data-side="left" placeholder="L">');
                html.push('</div>');
                html.push('</div>');
            } else if (field.key === 'border') {
                html.push('<input type="hidden" class="metis-theme-element-input" id="' + id + '" data-element="' + el + '" data-prop="' + field.key + '">');
                html.push('<div class="metis-theme-inline-grid">');
                html.push('<select class="mw-input metis-theme-border-width" data-element="' + el + '"><option value="0">None</option><option value="1">Hairline</option><option value="2">Thin</option><option value="3">Medium</option><option value="4">Thick</option></select>');
                html.push('<select class="mw-input metis-theme-border-style" data-element="' + el + '"><option value="solid">Solid</option><option value="dashed">Dashed</option><option value="dotted">Dotted</option><option value="double">Double</option><option value="none">None</option></select>');
                html.push('<select class="mw-input metis-theme-border-color" data-element="' + el + '"><option value="var(--metis-color-border,#d8deea)">Border</option><option value="var(--metis-color-text,#1a1f2b)">Text</option><option value="var(--metis-color-primary,#485bc7)">Primary</option><option value="var(--metis-color-accent,#ff7542)">Accent</option><option value="var(--metis-color-link,#2b59ff)">Link</option><option value="#000000">Black</option></select>');
                html.push('</div>');
            } else if (field.key === 'text_decoration') {
                html.push('<input type="hidden" class="metis-theme-element-input" id="' + id + '" data-element="' + el + '" data-prop="' + field.key + '">');
                html.push('<div class="metis-theme-inline-grid">');
                html.push('<select class="mw-input metis-theme-textdec-type" data-element="' + el + '"><option value="none">None</option><option value="underline">Underline</option><option value="line-through">Strikethrough</option><option value="overline">Overline</option></select>');
                html.push('<select class="mw-input metis-theme-textdec-color" data-element="' + el + '"><option value="currentColor">Match text</option><option value="var(--metis-color-link,#2b59ff)">Link</option><option value="var(--metis-color-primary,#485bc7)">Primary</option><option value="var(--metis-color-accent,#ff7542)">Accent</option><option value="var(--metis-color-text,#1a1f2b)">Text</option></select>');
                html.push('</div>');
            } else {
                html.push('<input type="text" class="mw-input metis-theme-element-input" id="' + id + '" data-element="' + el + '" data-prop="' + field.key + '">');
            }
            html.push('</div>');
        });
        html.push('</div>');
...
function rebuildStyledSelects() {
    ...
    $('select.mw-input').each(function() {
        ...
        html.push('<button type="button" class="mw-input metis-theme-selectx-trigger">');
            ...
            '<div class="metis-theme-field">' +
                ...
                '<div class="metis-theme-color-wrap">' +
                    ...
                    '<div class="metis-theme-binding-dropdown" data-key="' + key + '">' +
                        '<button type="button" class="mw-input mw-input-sm metis-theme-binding-trigger" data-key="' + key + '">' +
