...
<div id="metis-templates-view" class="metis-config-view">
    <div class="mw-page-header">
        <div class="mw-page-header-left">
            <h1 class="mw-page-title">Templates</h1>
            <p class="mw-subtitle">Set the site-wide default template for new content. Pages and posts can choose a different template in their own editor.</p>
        </div>
    </div>

    <section class="mw-premium-wrap metis-layout-gallery-card">
        ...
        <div class="metis-layout-gallery-actions">
            ...
            <button type="button" class="mw-btn mw-btn-ghost" id="metis-layout-preview-open">Open Full Preview</button>
        </div>
    </section>
    ...
    <div id="metis-layout-preview-modal" class="metis-layout-preview-modal" hidden>
        ...
        <div class="metis-layout-preview-dialog">
            <div class="metis-layout-preview-topbar">
                <button type="button" class="mw-btn mw-btn-ghost" data-action="close">&larr; Back to templates</button>
                ...
                <div class="metis-layout-preview-controls">
                    <select id="metis-layout-preview-select" class="mw-input mw-input-sm">
                        <?php foreach ( $templates as $template ) :
                            $slug = metis_key_clean( (string) ( $template['slug'] ?? '' ) );
                            if ( $slug === '' ) {
                                continue;
                    ...
                    <select id="metis-layout-preview-source" class="mw-input mw-input-sm">
