...
?>
<div class="metis-template metis-template-hero_split_glass metis-template-view-homepage">
    ...
    <?php if ($heroHtml !== ''): ?>
        <section class="metis-template-region metis-template-region-hero metis-template-hero-band" aria-label="Hero">
            <div class="metis-template-hero-inner"><?php echo $heroHtml; ?></div>
        </section>
    <?php endif; ?>
