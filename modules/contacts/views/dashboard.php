...
<div class="metis-contacts" data-can-manage="<?php echo metis_escape_attr( $can_manage ? '1' : '0' ); ?>">
    <h1 class="mw-page-title"><?php echo metis_escape_html( metis_current_module_label( 'Contacts' ) ); ?></h1>
    ...
    <aside class="mw-list-sidebar">
        ...
        <div class="mw-list-sidebar-actions">
            ...
            <button id="metis-contact-batch-btn" type="button" class="mw-btn mw-btn-xs">Batch Add</button>
        </div>
        <?php endif; ?>
    </aside>
    ...
    <div id="metis-contact-batch-panel" style="display:none; margin-bottom:14px;">
        <div class="mbe-toolbar">
            ...
            <button type="button" id="metis-contact-batch-close" class="mw-btn mw-btn-xs mw-btn-ghost">Close</button>
        </div>
    ...
    <div class="mw-premium-table metis-contacts-table">
        <div class="mw-premium-row mw-premium-header">
            <div class="mw-premium-cell mw-sortable mw-sort-active mw-sort-asc" id="sort-name" data-sort-key="name">Name</div>
            ...
            <?php if ( ! empty( $rows ) ) : ?>
                ...
                ?>
                    <div class="mw-premium-row metis-contact-row <?php echo ! empty( $row->did ) ? 'metis-contact-is-donor' : ''; ?>"
                        ...
                        <div class="mw-premium-cell"><?php echo metis_escape_html( (string) $row->email ); ?></div>
                        <div class="mw-premium-cell"><?php echo metis_escape_html( $updated_ts ? metis_runtime_date( 'M j, Y g:i a', $updated_ts ) : '—' ); ?></div>
                    </div>
                <?php endforeach; ?>
            <?php else : ?>
