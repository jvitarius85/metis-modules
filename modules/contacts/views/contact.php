...
<div class="metis-contact-detail" data-contact-cid="<?php echo metis_escape_attr( (string) ( $contact->cid ?? '' ) ); ?>">
    <div class="mw-space-between" style="margin-bottom: 14px;">
        <div>
            <h1 class="mw-page-title metis-inline-editable" data-field="full_name" data-raw-value="<?php echo metis_escape_attr( $full_name ); ?>" style="margin-bottom: 8px;" title="Double-click to edit name"><?php echo metis_escape_html( $full_name ); ?></h1>
            <div class="mw-muted">CID: <?php echo metis_escape_html( (string) ( $contact->cid ?? '—' ) ); ?></div>
        </div>
        <div class="mw-flex metis-top-actions">
            <?php if ( $is_donor && $donor_profile_url !== '' ) : ?>
                <a href="<?php echo metis_escape_url( $donor_profile_url ); ?>" class="mw-btn metis-top-action-btn">View Donor Profile</a>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <a href="<?php echo metis_escape_url( metis_portal_url( 'contacts' ) ); ?>" class="mw-btn metis-top-action-btn">Back to Contacts</a>
        </div>
    </div>
                        ...
                        <?php if ( $related_cid !== '' ) : ?>
                            <span class="metis-chip metis-relationship-chip">
                                <a class="metis-chip-link" href="<?php echo metis_escape_url( metis_contacts_detail_url( $related_cid ) ); ?>">
                                    ...
                                    <?php if ( $type !== '' ) : ?><span class="mw-muted">(<?php echo metis_escape_html( $type ); ?>)</span><?php endif; ?>
                                    <?php if ( $notes_text !== '' ) : ?><span class="mw-muted"> - <?php echo metis_escape_html( $notes_text ); ?></span><?php endif; ?>
                                </a>
                                <?php if ( metis_contacts_can_manage() ) : ?>
                                    <button
                                        type="button"
...
<?php if ( metis_contacts_can_manage() ) : ?>
    <div id="metis-contact-detail-modal" class="metis-contacts-modal" aria-hidden="true">
        <div class="metis-contacts-modal-inner">
            ...
            <form id="metis-contact-detail-form" data-contact-cid="<?php echo metis_escape_attr( (string) $contact->cid ); ?>" class="metis-contact-form">
                ...
                <div class="metis-contact-tab-panel is-active" data-tab-panel="basic">
                    <div class="metis-contact-field metis-contact-field-half">
                        ...
                        <input id="metis-detail-first-name" class="mw-input" type="text" required value="<?php echo metis_escape_attr( (string) $contact->first_name ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-half">
                        <label for="metis-detail-last-name">Last Name</label>
                        <input id="metis-detail-last-name" class="mw-input" type="text" required value="<?php echo metis_escape_attr( (string) $contact->last_name ); ?>">
                    </div>
                    ...
                    <div class="metis-contact-field metis-contact-field-half">
                        ...
                        <input id="metis-detail-phone" class="mw-input" type="text" value="<?php echo metis_escape_attr( $phone_display ); ?>" placeholder="xxx-xxx-xxxx">
                    </div>
                    <div class="metis-contact-field metis-contact-field-half">
                        <label for="metis-detail-preferred-name">Preferred Name</label>
                        <input id="metis-detail-preferred-name" class="mw-input" type="text" value="<?php echo metis_escape_attr( $preferred_name_display ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-full">
                        <label for="metis-detail-preferred-contact-method">Preferred Contact Method</label>
                        <input id="metis-detail-preferred-contact-method" class="mw-input" type="text" value="<?php echo metis_escape_attr( $preferred_contact_method_display ); ?>">
                    </div>
                </div>
                <div class="metis-contact-tab-panel" data-tab-panel="details">
                    <div class="metis-contact-field metis-contact-field-full">
                        <label for="metis-detail-address">Address</label>
                        <input id="metis-detail-address" class="mw-input" type="text" value="<?php echo metis_escape_attr( $address_display ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-half">
                        <label for="metis-detail-city">City</label>
                        <input id="metis-detail-city" class="mw-input" type="text" value="<?php echo metis_escape_attr( $city_display ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-half">
                    ...
                    <div class="metis-contact-field metis-contact-field-half">
                        ...
                        <input id="metis-detail-zip" class="mw-input" type="text" value="<?php echo metis_escape_attr( $zip_display ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-half">
                        <label for="metis-detail-birthday">Birthday</label>
                        <input id="metis-detail-birthday" class="mw-input" type="date" value="<?php echo metis_escape_attr( $birthday_display ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-half">
                        <label for="metis-detail-household-id">Household ID</label>
                        <input id="metis-detail-household-id" class="mw-input" type="text" value="<?php echo metis_escape_attr( $household_id_display ); ?>">
                    </div>
                    <div class="metis-contact-field metis-contact-field-full">
