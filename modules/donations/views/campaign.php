...
if ( $cid === '' ) : ?>
    ...
    <a href="<?php echo metis_escape_url( $base_url . '/campaigns/' ); ?>" class="mw-btn mw-btn-xs">← Back to Campaigns</a>
    <?php return;
endif;
...
<p><a href="<?php echo metis_escape_url( $base_url . '/campaigns/' ); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">← All Campaigns</a></p>

<!-- PAGE HEADER -->
<div class="mw-space-between mw-campaign-detail-header">
    <div>
        <h1 class="mw-page-title mw-campaign-title"><?php echo metis_escape_html( $campaign->cname ); ?></h1>
        <div class="mw-flex mw-campaign-header-badges">
            ...
            <?php endif; ?>
            <span class="mw-muted mw-campaign-cid"><?php echo metis_escape_html( $cid ); ?></span>
        </div>
    </div>
    <div class="mw-flex mw-campaign-header-actions">
        <button type="button" class="mw-btn mw-btn-xs mw-btn-ghost" id="mw-edit-campaign-btn">Edit Campaign</button>
    </div>
</div>

<!-- KPI SUMMARY CARDS -->
<div class="mw-report-kpis mw-campaign-kpis">
    ...
    <div class="mw-kpi-card">
        ...
        <div class="mw-progress-bar-wrap mw-campaign-progress-wrap">
...
<div class="mw-campaign-detail-grid">
    ...
    <div class="mw-campaign-detail-card">
        <div class="mw-campaign-card-header">
            <h2 class="mw-section-title mw-campaign-card-title">Annual Goals</h2>
        ...
        <div id="mw-goals-list">
                ...
                ?>
                    <div class="mw-goal-row" data-year="<?php echo $yr_num; ?>">
                        <div class="mw-goal-year-label">
                            <?php echo $yr_num; ?>
                            <?php if ( $yr_num === $current_year ) echo '<span class="mw-badge blue mw-campaign-current-badge">Current</span>'; ?>
                        </div>
                        ...
                        <?php endif; ?>
                        <?php if ( $yr_goal ) : ?>
                            <button type="button" class="mw-goal-edit-btn mw-muted" data-year="<?php echo $yr_num; ?>" data-amount="<?php echo metis_escape_attr( $yr_goal ); ?>">Edit</button>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            ...
            <?php else : ?>
                <p class="mw-muted mw-campaign-empty-history">No giving history yet for this campaign.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="mw-campaign-detail-card">
        ...
        <div class="mw-campaign-info-grid">
            ...
            <div class="mw-info-row">
                ...
                <div>
                    <a href="<?php echo metis_escape_url( 'https://mobilizewaco.org' . $campaign->url ); ?>" target="_blank" class="mw-batch-link mw-campaign-donation-link">
        ...
        <!-- SHORTCODE -->
        <div class="mw-campaign-shortcode-wrap">
            <div class="small-label mw-campaign-shortcode-label">Shortcode</div>
            <div class="mw-shortcode-wrap">
                <code class="mw-shortcode" id="mw-shortcode-val">[mw_campaign_progress cid="<?php echo metis_escape_attr( $cid ); ?>"]</code>
                <button type="button" class="mw-btn mw-btn-xs mw-btn-ghost" id="mw-copy-shortcode">Copy</button>
            </div>
            <p class="mw-muted mw-campaign-shortcode-help">
...
<!-- DESCRIPTION -->
<div class="mw-campaign-detail-card mw-campaign-detail-card-spaced">
    <div class="mw-campaign-card-header">
        <h2 class="mw-section-title mw-campaign-card-title">Campaign Description</h2>
    ...
    <div id="mw-desc-display">
        <?php if ( $campaign->cdesc ) : ?>
            <div class="mw-campaign-desc-body"><?php echo metis_runtime_kses_post( $campaign->cdesc ); ?></div>
        <?php else : ?>
            <p class="mw-muted">No description set. Click Edit to add one.</p>
        <?php endif; ?>
    </div>
    <!-- Editor wrapper: hidden until Edit clicked. Quill WYSIWYG. -->
    <div id="mw-desc-editor" class="mw-campaign-desc-editor">
        <div id="mw-quill-editor" class="mw-campaign-quill-host"></div>
        <div class="mw-flex mw-campaign-desc-actions">
...
<div class="mw-campaign-detail-card mw-campaign-detail-card-spaced">
    ...
    <div class="mw-premium-table mw-batch-table">
        ...
        <?php if ( ! empty( $transactions ) ) : ?>
            ...
            ?>
                <div class="mw-premium-row mw-batch-row mw-clickable-row"
                     data-href="<?php echo metis_escape_url( $tx_url ); ?>">
                    <div><?php echo metis_escape_html( $display_date ); ?></div>
                    <div>
                        <div><?php echo metis_escape_html( $donor_name ?: 'Unknown' ); ?></div>
                        <div class="mw-muted mw-campaign-tx-did"><?php echo metis_escape_html( $t->did ?: '' ); ?></div>
                    </div>
...
<!-- GOAL MODAL -->
<div id="mw-goal-modal" class="mw-modal-overlay mw-campaign-modal-hidden">
    <div class="mw-modal">
        ...
        <div class="mw-modal-body">
            <div class="mw-report-field mw-campaign-goal-field-first">
                <label>Year</label>
        ...
        <div class="mw-modal-footer">
            ...
            <button type="button" class="mw-btn mw-btn-xs mw-btn-danger mw-campaign-goal-delete" id="mw-goal-delete-btn">Remove Goal</button>
        </div>
        <div id="mw-goal-status" class="mw-report-status mw-campaign-status"></div>
    </div>
</div>

<!-- EDIT CAMPAIGN MODAL -->
<div id="mw-edit-campaign-modal" class="mw-modal-overlay mw-campaign-modal-hidden">
    <div class="mw-modal mw-modal--wide">
        ...
        <div class="mw-modal-body">
            <div class="mw-edit-form-grid">
                <div class="mw-report-field">
                    ...
                    <input type="text" id="mw-edit-cname" class="mw-input" value="<?php echo metis_escape_attr( $campaign->cname ); ?>">
                </div>
                <div class="mw-report-field">
                    <label>Type</label>
                ...
                <div class="mw-report-field">
                    ...
                    <input type="text" id="mw-edit-url" class="mw-input" value="<?php echo metis_escape_attr( $campaign->url ?? '' ); ?>" placeholder="/join/donate/">
                </div>
                <div class="mw-report-field">
                    <label>Status</label>
        ...
        <div id="mw-edit-status" class="mw-report-status mw-campaign-status"></div>
    </div>
</div>
...
(function () {
    ...
    document.getElementById('mw-edit-save-btn')?.addEventListener('click', async function () {
        ...
        if (data.success) {
            ...
            const nextName = document.getElementById('mw-edit-cname')?.value || '';
            const titleEl = document.querySelector('.mw-campaign-title');
            if (titleEl && nextName) {
