...
if ( $tid === '' ) : ?>
    ...
    <a href="<?php echo metis_escape_url( $base_url . '/transactions/' ); ?>" class="mw-btn mw-btn-xs">← Back</a>
    <?php return;
endif;
...
<h1 class="mw-page-title">Transaction <?php echo metis_escape_html( $transaction->tid ); ?></h1>
<p class="mw-subtitle">Detailed record for this donation.</p>
<p><a href="<?php echo metis_escape_url( $donor_url ); ?>" class="mw-btn mw-btn-xs">← Back to Donor</a></p>
...
<div class="mw-premium-row mw-transaction-summary">
    <div class="mw-premium-cell">
        ...
        <?php if ( $transaction->email ) : ?>
            <div class="mw-muted mw-transaction-meta-text"><?php echo metis_escape_html( $transaction->email ); ?></div>
        <?php endif; ?>
    </div>
    <div class="mw-premium-cell">
...
<div class="mw-premium-row mw-transaction-details">
    ...
    <div class="mw-premium-cell">
        ...
        <div>
            ...
            <?php if ( $batch_code ) : ?>
                <div class="mw-transaction-batch-row">
                    <span class="mw-muted">Batch:</span>
                    <a href="<?php echo metis_escape_url( $batch_url ); ?>" class="mw-batch-link">
...
<div class="mw-premium-row mw-transaction-financial">
    ...
    <div class="mw-premium-cell">
        ...
        <?php if ( $total_refunded_raw > 0 ) : ?>
            <div class="mw-muted mw-transaction-meta-text">
    ...
    <?php if ( ! empty( $refunds ) ) : ?>
        ...
        <?php foreach ( $refunds as $r ) : ?>
            <div class="mw-refund-row">
                ...
                <div class="mw-ref-col"><?php echo $r->created_at ? metis_escape_html( date( 'm/d/Y H:i', strtotime( $r->created_at ) ) ) : '—'; ?></div>
                <div class="mw-ref-col"><?php echo metis_escape_html( $r->display_name ?: 'System' ); ?></div>
                <div class="mw-ref-col"><?php echo metis_escape_html( ucfirst( $r->source ?: 'manual' ) ); ?></div>
                <div class="mw-ref-col"><?php echo metis_escape_html( $r->reason ?: '—' ); ?></div>
            </div>
        <?php endforeach; ?>
    <?php else : ?>
        <p class="mw-muted">No refunds recorded for this transaction.</p>
    <?php endif; ?>
    <div class="mw-refund-actions mw-transaction-actions-row">
...
<div class="mw-premium-row mw-transaction-notes">
            ...
            <?php foreach ( $notes as $n ) : ?>
                <li class="mw-note-item">
                    <div class="mw-note-meta">
                        <span class="mw-note-author"><?php echo metis_escape_html( $n->display_name ?: 'System' ); ?></span>
                        <span class="mw-note-date mw-muted"> · <?php echo $n->created_at ? metis_escape_html( date( 'm/d/Y H:i', strtotime( $n->created_at ) ) ) : '—'; ?></span>
                    </div>
                    <div class="mw-note-body"><?php echo nl2br( metis_escape_html( $n->note ) ); ?></div>
                </li>
            <?php endforeach; ?>
        </ul>
    <?php else : ?>
    ...
    <?php endif; ?>
    <div class="mw-notes-actions mw-transaction-actions-row">
