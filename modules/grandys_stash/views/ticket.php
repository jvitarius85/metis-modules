...
if ( ! is_array( $ticket ) ) {
    ...
    echo '<div class="mw-alert mw-alert-error">Ticket not found.</div>';
    return;
}
...
<div class="metis-stash-app metis-stash-ticket-page"
    ...
    <div class="metis-stash-ticket-page-head">
        <div>
            <a class="mw-btn mw-btn-xs mw-btn-ghost" href="<?php echo metis_escape_url( metis_grandys_stash_base_url() ); ?>">Back to Inbox</a>
            <h1 class="mw-page-title"><?php echo metis_escape_html( (string) ( $ticket['code'] ?? 'Ticket' ) ); ?></h1>
            <p class="mw-subtitle"><?php echo metis_escape_html( $submit_name !== '' ? $submit_name : 'Review ticket details and complete next actions.' ); ?></p>
        </div>
    </div>
        ...
        <div class="metis-stash-ticket-main">
            ...
            <div class="metis-stash-ticket-section">
                ...
                <div class="metis-stash-reply-form">
                    <label><span>Reply subject</span><input class="mw-input" type="text" id="metis-stash-reply-subject" placeholder="[GST-000123] Grandy's Stash Update"></label>
                    <label><span>Reply message</span><textarea class="mw-input" id="metis-stash-reply-input" placeholder="Type your email reply..." rows="5"></textarea></label>
                    <div class="metis-stash-form-actions">
                        <button type="button" class="mw-btn mw-btn-xs" id="metis-stash-reply-submit">Send reply</button>
                    </div>
                </div>
                <?php endif; ?>
            </div>
            <div class="metis-stash-ticket-section">
                ...
                <div class="metis-stash-note-form">
                    <textarea class="mw-input" id="metis-stash-note-input" placeholder="Add a note..." rows="2"></textarea>
                    <button type="button" class="mw-btn mw-btn-xs" id="metis-stash-note-submit">Add note</button>
                </div>
                <?php endif; ?>
            </div>
            <div class="metis-stash-ticket-section">
                ...
                <form id="metis-stash-ticket-form" class="metis-stash-form" autocomplete="off">
                    ...
                    <div class="metis-stash-form-row">
                        <label><span>Assigned to</span>
                            <select class="mw-select" name="assigned_to" id="metis-stash-ticket-assignee">
                    ...
                    <div class="metis-stash-form-actions">
                        <button type="submit" class="mw-btn">Save ticket</button>
                    </div>
                </form>
            </div>
            <?php endif; ?>
