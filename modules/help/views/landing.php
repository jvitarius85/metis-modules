...
<section class="metis-help-hero">
    ...
    <h1 class="mw-page-title">How can we help?</h1>
    <p class="mw-subtitle">Search practical guidance for Metis modules, account access, admin workflows, and common fixes.</p>
    <form class="metis-help-search-form" action="<?php echo htmlspecialchars( metis_home_url( '/admin/help/search' ), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ); ?>" method="get">
        ...
        <input id="help-search-home" class="mw-input" type="search" name="q" placeholder="Search help by module, task, or issue">
        <button class="mw-btn" type="submit">Search Help</button>
    </form>
</section>
