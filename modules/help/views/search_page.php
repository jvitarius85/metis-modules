...
<section class="metis-help-hero metis-help-hero--compact">
    ...
    <h1 class="metis-page-title">Help Search</h1>
    <p class="metis-subtitle">Search the Help library by title, module, action, or likely user phrase.</p>
    <form class="metis-help-search-form" action="<?php echo htmlspecialchars( metis_home_url( '/admin/help/search' ), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ); ?>" method="get">
        ...
        <input id="help-search-query" class="metis-input" type="search" name="q" value="<?php echo htmlspecialchars( (string) $search_query, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8' ); ?>" placeholder="Search help by module, task, or issue">
        <label class="screen-reader-text" for="help-search-category">Filter by category</label>
        <select id="help-search-category" class="metis-input" name="category" aria-label="Help category">
        ...
        <button class="metis-btn" type="submit">Search</button>
    </form>
</section>
