...
<form method="post" class="mw-settings-form" data-metis-settings-form="1" data-settings-section="branding">
    <?php metis_runtime_nonce_field( 'metis_save_settings_branding', 'metis_settings_nonce' ); ?>
    <div class="mw-settings-card">
        <div class="mw-settings-header"><h2>Branding</h2></div>
                ...
                <?php foreach ( $theme_color_fields as $key => $field ) : ?>
                    <div class="mw-field metis-theme-field">
                        ...
                        <div class="metis-theme-input-row">
                            ...
                            <input type="text" id="theme_colors_<?php echo metis_escape_attr( $key ); ?>_text" name="theme_colors[<?php echo metis_escape_attr( $key ); ?>]" value="<?php echo metis_escape_attr( (string) $theme_colors[ $key ] ); ?>" class="mw-input metis-theme-text" pattern="^#[A-Fa-f0-9]{6}$" inputmode="text" data-theme-color-text>
                        </div>
                        <p class="mw-help">Default: <code><?php echo metis_escape_html( (string) $field['default'] ); ?></code> for <code><?php echo metis_escape_html( (string) $field['css_var'] ); ?></code>.</p>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <div class="mw-settings-card">
        <div class="mw-settings-header"><h2>Login Screen</h2></div>
        <div class="mw-settings-body">
            <div class="mw-field">
                <label for="login_organization_name">Organization Name</label>
                <input id="login_organization_name" name="login_organization_name" class="mw-input" type="text" value="<?php echo metis_escape_attr( $login_organization_name ); ?>">
            </div>
            <div class="mw-field">
                <label for="login_welcome_text">Welcome Text</label>
                <textarea id="login_welcome_text" name="login_welcome_text" class="mw-input" rows="3"><?php echo esc_textarea( $login_welcome_text ); ?></textarea>
            </div>
            <div class="mw-field">
                <label for="login_footer_text">Footer Text</label>
                <input id="login_footer_text" name="login_footer_text" class="mw-input" type="text" value="<?php echo metis_escape_attr( $login_footer_text ); ?>">
            </div>
            <div class="mw-field">
                <label for="login_background_color">Background Color</label>
                <input id="login_background_color" name="login_background_color" class="mw-input" type="text" pattern="^#[A-Fa-f0-9]{6}$" value="<?php echo metis_escape_attr( $login_background_color ); ?>">
            </div>
            <div class="mw-field" data-settings-media-field="login_logo">
                ...
                <?php else : ?>
                    ...
                    <p class="mw-help" data-settings-media-empty="login_logo">No login logo selected.</p>
                <?php endif; ?>
                ...
                <button type="button" class="mw-btn mw-btn-ghost mw-btn-sm" data-settings-media-pick="login_logo" data-settings-media-types="image">Choose from Media Library</button>
                <button type="button" class="mw-btn mw-btn-ghost mw-btn-sm" data-settings-media-clear="login_logo">Clear selection</button>
            </div>
            <div class="mw-field" data-settings-media-field="login_background_image">
                ...
                <?php else : ?>
                    ...
                    <p class="mw-help" data-settings-media-empty="login_background_image">No background image selected.</p>
                <?php endif; ?>
                ...
                <button type="button" class="mw-btn mw-btn-ghost mw-btn-sm" data-settings-media-pick="login_background_image" data-settings-media-types="image">Choose from Media Library</button>
                <button type="button" class="mw-btn mw-btn-ghost mw-btn-sm" data-settings-media-clear="login_background_image">Clear selection</button>
            </div>
        </div>
    </div>
    <div class="mw-settings-actions">
        <button type="submit" class="mw-btn">Save Branding Settings</button>
    </div>
</form>
