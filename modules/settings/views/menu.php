...
<p class="mw-subtitle">Manage portal navigation structure, labels, icons, and visibility.</p>
...
<?php if ( empty( $is_system_admin ) ) : ?>
    <div class="mw-callout mw-callout-warning">Only system admins can manage Navigation configurations.</div>
<?php endif; ?>
<?php if ( ! empty( $is_system_admin ) ) : ?>
<form method="post" class="mw-settings-form" data-metis-settings-form="1" data-settings-section="navigation">
    ...
    <div class="mw-settings-card">
        <div class="mw-settings-header"><h2>Navigation Structure</h2></div>
        <div class="mw-settings-body">
            <p class="mw-help">Use Parent, Up, and Down controls for deterministic ordering (max depth: 2). Use ↰ on a child row to move it back to top level.</p>
            <div class="metis-menu-toolbar">
                <button type="button" class="mw-btn mw-btn-secondary mw-btn-sm" data-menu-add-group>Add Group</button>
            </div>
                            ...
                            <div class="metis-menu-item-card">
                                ...
                                <div class="metis-menu-item-fields">
                                    <div class="metis-menu-field-row">
                                        <label>Label</label>
                                        <input class="mw-input" type="text" data-menu-label value="<?php echo metis_escape_attr( (string) ( $item['label'] ?? '' ) ); ?>" <?php disabled( $is_locked ); ?>>
                                    </div>
                                    <div class="metis-menu-field-row">
                                        <label>Icon</label>
                                        ...
                                        <div class="metis-menu-icon-picker-row">
                                            ...
                                            <button type="button" class="mw-btn mw-btn-secondary mw-btn-sm" data-menu-icon-picker-toggle <?php disabled( $is_locked ); ?>>Choose Icon</button>
                                            <button type="button" class="mw-btn mw-btn-secondary mw-btn-sm" data-menu-icon-clear <?php disabled( $is_locked ); ?>>Clear</button>
                                    ...
                                    <li class="metis-menu-item metis-menu-item-child<?php echo $child_is_group ? ' is-group' : ''; ?><?php echo $child_is_locked ? ' is-locked' : ''; ?>" data-menu-item data-menu-locked="<?php echo $child_is_locked ? '1' : '0'; ?>" data-menu-is-group="<?php echo $child_is_group ? '1' : '0'; ?>" data-item-id="<?php echo metis_escape_attr( (string) ( $child['id'] ?? '' ) ); ?>" draggable="true">
                                        <div class="metis-menu-item-card">
                                            ...
                                            <div class="metis-menu-item-fields">
                                                <div class="metis-menu-field-row">
                                                    <label>Label</label>
                                                    <input class="mw-input" type="text" data-menu-label value="<?php echo metis_escape_attr( (string) ( $child['label'] ?? '' ) ); ?>" <?php disabled( $child_is_locked ); ?>>
                                                </div>
                                                <div class="metis-menu-field-row">
                                                    <label>Icon</label>
                                                    ...
                                                    <div class="metis-menu-icon-picker-row">
                                                        <div class="metis-menu-icon-preview" data-menu-icon-preview></div>
                                                        <button type="button" class="mw-btn mw-btn-secondary mw-btn-sm" data-menu-icon-picker-toggle <?php disabled( $child_is_locked ); ?>>Choose Icon</button>
                                                        <button type="button" class="mw-btn mw-btn-secondary mw-btn-sm" data-menu-icon-clear <?php disabled( $child_is_locked ); ?>>Clear</button>
                                                        <span class="metis-menu-icon-token" data-menu-icon-token></span>
                                                    </div>
                                                </div>
                                                <div class="metis-menu-field-row">
            ...
            <div class="mw-settings-card" style="margin-top:12px;">
                <div class="mw-settings-header"><h2>Unassigned Modules</h2></div>
                <div class="mw-settings-body">
                    <?php if ( empty( $unassigned ) ) : ?>
                        <p class="mw-help">All modules are assigned to the menu.</p>
                    <?php else : ?>
    ...
    <div class="mw-settings-actions">
        <button type="submit" class="mw-btn">Save Navigation</button>
    </div>
</form>
<?php endif; ?>
