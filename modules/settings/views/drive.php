...
<p class="metis-subtitle">Choose the shared drives used across the portal.</p>
<?php metis_settings_render_messages( $saved, $errors ); ?>
<?php metis_settings_render_section_nav( 'drive' ); ?>
<form method="post" class="metis-settings-form" data-metis-settings-form="1" data-settings-section="drive">
    ...
    <?php if ( $is_system_admin ) : ?>
        <div class="metis-settings-card">
            <div class="metis-settings-header"><h2>Drive Sync</h2></div>
            <div class="metis-settings-body">
                <p class="metis-help">Run an immediate listing sync for all configured drives. This refreshes the database-backed Drive cache now instead of waiting for the hourly task.</p>
                <div class="metis-settings-actions" style="justify-content:flex-start;">
                    <button type="button" class="metis-btn metis-btn-secondary" data-drive-sync-now>Sync Drive Cache Now</button>
                </div>
                <div class="metis-help" data-drive-sync-status style="margin-top:10px;"></div>
            </div>
        </div>
    <?php endif; ?>
    <div class="metis-settings-actions">
        <button type="submit" class="metis-btn">Save Drive Settings</button>
    </div>
</form>
<script>
(function () {
