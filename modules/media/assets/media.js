    ...
    function bindEvents() {
        ...
        $(document).on('click', '.metis-media-preview', function () {
            ...
            if (isImage(mime)) {
                ...
                body = '<div class="metis-media-preview-non-image"><p>' + esc(mime || 'File preview unavailable') + '</p><a class="mw-btn mw-btn-primary" href="' + esc(url) + '" target="_blank" rel="noopener noreferrer">Open File</a></div>';
            }
