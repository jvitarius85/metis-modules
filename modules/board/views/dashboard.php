...
<div class="metis-board"
    ...
    <h1 class="mw-page-title"><?php echo metis_escape_html( metis_current_module_label( 'Board' ) ); ?></h1>
    <p class="mw-subtitle">Meetings and governance actions.</p>
    ...
    <div class="mw-premium-table metis-board-table metis-board-table-main <?php echo $can_manage ? 'metis-board-table-main--manageable' : 'metis-board-table-main--readonly'; ?>">
        <div class="mw-premium-row mw-premium-header">
            ...
            <div class="mw-premium-cell mw-sortable mw-sort-active mw-sort-desc" data-sort-key="date">Date</div>
            <div class="mw-premium-cell">Type</div>
            <div class="mw-premium-cell">Status</div>
            <div class="mw-premium-cell">Open Actions</div>
        ...
        <div id="metis-board-meeting-rows">
            ...
            <div class="mw-premium-row metis-board-row <?php echo (string) ($row['status'] ?? '') === 'draft' ? 'metis-board-row-draft' : ''; ?>"
                ...
                <div class="mw-premium-cell">
                    ...
                    <div class="mw-muted"><?php echo metis_escape_html($meeting_code); ?></div>
                </div>
                <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($row['committee_name'] ?? '—')); ?></div>
                <div class="mw-premium-cell"><?php echo metis_escape_html(metis_board_format_datetime((string) ($row['meeting_date'] ?? ''))); ?></div>
                <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($row['meeting_type'] ?? 'board')); ?></div>
                <div class="mw-premium-cell"><span class="mw-chip"><?php echo metis_escape_html((string) ($row['status'] ?? 'draft')); ?></span></div>
                <div class="mw-premium-cell"><?php echo metis_escape_html((string) ((int) ($row['open_actions'] ?? 0))); ?></div>
                <?php if ($can_manage) : ?>
    ...
    <section class="mw-premium-wrap metis-board-dashboard-section">
        <header class="metis-board-dashboard-section__head">
            <h2>Action Queue</h2>
        </header>
        <div class="mw-premium-table metis-board-table metis-board-actions-table metis-board-dashboard-section__body">
            ...
            <div id="metis-board-dashboard-action-rows">
            <?php foreach ($open_actions as $action) : ?>
                ...
                <div class="mw-premium-row"
                    ...
                    <div class="mw-premium-cell"><strong><?php echo metis_escape_html((string) ($action['title'] ?? '')); ?></strong><div class="mw-muted"><?php echo metis_escape_html((string) ($action['meeting_code'] ?? '')); ?></div></div>
    ...
    <section class="mw-premium-wrap metis-board-dashboard-section">
        ...
        <div class="mw-premium-table metis-board-table metis-board-committees-table metis-board-dashboard-section__body">
            <div class="mw-premium-header">
            ...
            <div id="metis-board-committee-rows">
            <?php foreach ($committees as $committee) : ?>
                <div class="mw-premium-row" data-committee-json="<?php echo metis_escape_attr(metis_json_encode($committee)); ?>">
                    <div class="mw-premium-cell"><strong><?php echo metis_escape_html((string) ($committee['name'] ?? '')); ?></strong><div class="mw-muted"><?php echo metis_escape_html((string) ($committee['committee_code'] ?? '')); ?></div></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($committee['chair_name'] ?? '—')); ?></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html((string) ((int) ($committee['meeting_count'] ?? 0))); ?></div>
    ...
    <section class="mw-premium-wrap metis-board-dashboard-section">
        ...
        <div class="mw-premium-table metis-board-table metis-board-announcements-table metis-board-dashboard-section__body">
            <div class="mw-premium-header">
            ...
            <div id="metis-board-announcement-rows">
            <?php foreach ($recent_announcements as $an) : ?>
                <div class="mw-premium-row">
                    <div class="mw-premium-cell"><strong><?php echo metis_escape_html((string) ($an['title'] ?? '')); ?></strong><div class="mw-muted"><?php echo metis_escape_html((string) ($an['announcement_code'] ?? '')); ?></div></div>
                    <div class="mw-premium-cell"><span class="mw-chip"><?php echo metis_escape_html((string) ($an['status'] ?? 'draft')); ?></span></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html(!empty($an['publish_at']) ? metis_board_format_datetime((string) $an['publish_at']) : '—'); ?></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html(metis_board_format_datetime((string) ($an['updated_at'] ?? ''))); ?></div>
                </div>
            <?php endforeach; ?>
...
<div id="metis-board-meeting-modal" class="metis-contacts-modal" aria-hidden="true">
    <div class="metis-contacts-modal-inner">
        ...
        <form id="metis-board-meeting-form" class="metis-contact-form">
            ...
            <div class="metis-contact-field metis-contact-field-half"><label for="metis-board-meeting-committee">Committee</label><select id="metis-board-meeting-committee" class="mw-select"><option value="">Board-wide</option><?php foreach ($committees as $committee) : ?><option value="<?php echo metis_escape_attr((string) ((int) ($committee['id'] ?? 0))); ?>"><?php echo metis_escape_html((string) ($committee['name'] ?? '')); ?></option><?php endforeach; ?></select></div>
...
<div id="metis-board-committee-modal" class="metis-contacts-modal" aria-hidden="true">
    <div class="metis-contacts-modal-inner">
        ...
        <form id="metis-board-committee-form" class="metis-contact-form">
            ...
            <div class="metis-contact-field metis-contact-field-half"><label for="metis-board-committee-chair">Chair</label><select id="metis-board-committee-chair" class="mw-select"><option value="">None</option><?php foreach ($board_people as $bp) : ?><option value="<?php echo metis_escape_attr((string) ((int) ($bp['id'] ?? 0))); ?>"><?php echo metis_escape_html((string) ($bp['display_name'] ?? '')); ?></option><?php endforeach; ?></select></div>
            <div class="metis-contact-field metis-contact-field-half"><label for="metis-board-committee-newsletter-list">Newsletter List</label><select id="metis-board-committee-newsletter-list" class="mw-select"><option value="">None</option><?php foreach ($newsletter_lists as $list) : ?><option value="<?php echo metis_escape_attr((string) ((int) ($list['id'] ?? 0))); ?>"><?php echo metis_escape_html((string) ($list['name'] ?? '')); ?></option><?php endforeach; ?></select></div>
