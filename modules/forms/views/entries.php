...
<div class="metis-forms-page" data-metis-forms-entries="1">
    <header class="metis-forms-hero">
        <div>
            ...
            <h1 class="mw-page-title"><?php echo metis_escape_html( (string) ( $form['name'] ?? '' ) ); ?> Entries</h1>
            <p class="mw-subtitle">Review submissions, export the current list, and keep light-weight entry management in one place.</p>
        </div>
        <div class="metis-forms-hero__actions">
            <button type="button" class="mw-btn" data-forms-export>Export CSV</button>
        </div>
    </header>
    ...
    <section class="metis-forms-card metis-forms-table-card">
        ...
        <?php if ( empty( $entries ) ) : ?>
            <p class="mw-muted">No entries have been submitted yet.</p>
        <?php else : ?>
