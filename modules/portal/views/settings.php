        ...
        <div class="mw-settings-card">
            ...
            <div class="mw-settings-body">
                <div class="mw-field">
                    ...
                    <input type="text" id="portal_slug" name="portal_slug" class="mw-input mw-input-wide" value="<?php echo metis_escape_attr( $portal_slug ); ?>" placeholder="mw-portal">
                </div>
                <div class="mw-field">
            ...
            <div class="mw-settings-body">
                ...
                <?php else : ?>
                    <div class="mw-field">
                        ...
                        <input type="password" id="stripe_secret" name="stripe_secret" class="mw-input mw-input-wide" autocomplete="new-password" placeholder="<?php echo $stripe_connected ? metis_escape_attr( metis_mask_key( $stripe_secret ) ) : 'sk_live_••••••••••'; ?>">
                    </div>
                    <div class="mw-field">
                        <label for="stripe_webhook_secret">Stripe Webhook Signing Secret</label>
                        <input type="password" id="stripe_webhook_secret" name="stripe_webhook_secret" class="mw-input mw-input-wide" autocomplete="new-password" placeholder="<?php echo $webhook_configured ? metis_escape_attr( metis_mask_key( $webhook_secret ) ) : 'whsec_••••••••••'; ?>">
                    </div>
                    <div class="mw-field">
                    ...
                    <div class="mw-field">
                        ...
                        <div class="mw-shortcode-wrap">
                            <code class="mw-shortcode" id="mw-webhook-url"><?php echo metis_escape_html( metis_webhook_url( 'stripe' ) ); ?></code>
