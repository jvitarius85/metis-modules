...
<div class="metis-people"
    ...
    <?php metis_render_sidebar_layout([
        'sidebar' => static function () use ($can_manage) { ?>
            <div class="mw-list-sidebar-section">
                <div class="mw-list-sidebar-label">Filter Current Page</div>
            ...
            <div class="mw-list-sidebar-actions">
                ...
                <a href="<?php echo metis_escape_url(metis_portal_url('people', 'positions')); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">Manage Positions</a>
                <a href="<?php echo metis_escape_url(metis_people_base_url()); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">Dashboard</a>
            </div>
            <?php else : ?>
            <div class="mw-list-sidebar-actions">
                <a href="<?php echo metis_escape_url(metis_people_base_url()); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">Dashboard</a>
        ...
        <div id="metis-people-rows">
            ...
            ?>
                <div class="mw-premium-row metis-people-row"
                    ...
                    <div class="mw-premium-cell"><strong><?php echo metis_escape_html($p['full_name']); ?></strong><div class="mw-muted"><?php echo metis_escape_html($p['pid']); ?></div></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html($p['email']); ?></div>
                    ...
                    <?php if ($can_manage) : ?><div class="mw-premium-cell"><a href="<?php echo metis_escape_url( metis_people_person_url( (string) $p['pid'] ) ); ?>" class="mw-btn-xs">Edit</a></div><?php endif; ?>
                </div>
            <?php endforeach; ?>
        </div>
    </section>
    ...
    ?>
    <div class="mw-help" style="margin-top:10px;">
    ...
    <div class="mw-list-sidebar-actions" style="margin-top:8px;">
        <?php if ($prev_url !== '') : ?>
            <a href="<?php echo metis_escape_url($prev_url); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">Previous</a>
        <?php else : ?>
            <span class="mw-btn mw-btn-xs mw-btn-ghost" style="pointer-events:none;opacity:.5;">Previous</span>
        <?php endif; ?>
        <?php if ($next_url !== '') : ?>
            <a href="<?php echo metis_escape_url($next_url); ?>" class="mw-btn mw-btn-xs mw-btn-ghost">Next</a>
        <?php else : ?>
            <span class="mw-btn mw-btn-xs mw-btn-ghost" style="pointer-events:none;opacity:.5;">Next</span>
        <?php endif; ?>
    </div>
