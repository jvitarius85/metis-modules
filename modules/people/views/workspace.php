...
<div class="metis-people-workspace" data-can-manage="<?php echo $can_manage ? '1' : '0'; ?>">
    <h1 class="mw-page-title"><?php echo metis_escape_html( metis_current_module_view_title( 'Workspace Management' ) ); ?></h1>
    ...
    <section class="mw-premium-table metis-people-table metis-workspace-user-table">
        ...
        <div id="metis-workspace-user-rows">
            ...
            ?>
                <div
                    class="mw-premium-row metis-workspace-user-row<?php echo $person_url !== '' ? ' is-clickable' : ''; ?>"
                ...
                >
                    <div class="mw-premium-cell">
                        ...
                        <?php if ($secondary_email !== '') : ?><div class="mw-muted"><?php echo metis_escape_html($secondary_email); ?></div><?php endif; ?>
                    </div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($u['primary_email'] ?? '')); ?></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($u['org_unit_path'] ?? '/')); ?></div>
                    <div class="mw-premium-cell"><?php echo metis_escape_html(!empty($role_labels) ? implode(', ', $role_labels) : '—'); ?></div>
                    <div class="mw-premium-cell metis-workspace-status-cell">
                        <?php if ($is_suspended) : ?>
                        ...
                        <?php endif; ?>
                        <?php if ($is_hidden) : ?>
                            <span class="mw-chip">Hidden</span>
                        <?php endif; ?>
                    </div>
                    <div class="mw-premium-cell">
                        <?php
                        if ($linked_pid !== '') {
                            if ($linked_name !== '') {
                                echo '<div>' . metis_escape_html($linked_name) . '</div><div class="mw-muted">' . metis_escape_html($linked_pid) . '</div>';
                            } else {
                                echo '<div class="mw-muted">' . metis_escape_html($linked_pid) . '</div>';
                            }
                        } else {
                            echo '—';
                        }
                    ...
                    <div class="mw-premium-cell metis-workspace-user-actions">
                        <?php if ($can_manage) : ?>
                            <button
                                type="button"
                                class="mw-btn-xs metis-workspace-actions-open"
                                data-workspace-user-id="<?php echo metis_escape_attr((string) $uid); ?>"
                            >Manage</button>
                        <?php else : ?>
                    ...
                    <?php if ($can_manage) : ?>
                        <div class="metis-workspace-actions-menu" data-workspace-user-id="<?php echo metis_escape_attr((string) $uid); ?>" aria-hidden="true">
                            <?php if ($linked_pid === '') : ?>
                                <button type="button" class="mw-btn-xs mw-btn-secondary metis-workspace-flag-btn" data-workspace-user-id="<?php echo metis_escape_attr((string) $uid); ?>" data-flag="is_hidden" data-value="<?php echo metis_escape_attr($is_hidden ? '0' : '1'); ?>"><?php echo metis_escape_html($is_hidden ? 'Unhide' : 'Hide'); ?></button>
                                <button type="button" class="mw-btn-xs mw-btn-secondary metis-workspace-flag-btn" data-workspace-user-id="<?php echo metis_escape_attr((string) $uid); ?>" data-flag="is_protected" data-value="<?php echo metis_escape_attr($is_protected ? '0' : '1'); ?>"><?php echo metis_escape_html($is_protected ? 'Unprotect' : 'Protect'); ?></button>
                            <?php endif; ?>
                            <button
                                type="button"
                                class="mw-btn-xs mw-btn-secondary metis-workspace-edit-user-open"
                            ...
                            <?php if ($linked_pid !== '') : ?>
                                <button
                                    type="button"
                                    class="mw-btn-xs mw-btn-secondary metis-workspace-create-drive-folder-btn"
                                    data-person-pid="<?php echo metis_escape_attr($linked_pid); ?>"
                                >Create Drive Folder</button>
                            <?php endif; ?>
                            <button type="button" class="mw-btn-xs mw-btn-secondary metis-workspace-security-open" data-user-id="<?php echo metis_escape_attr((string) $uid); ?>" data-user-email="<?php echo metis_escape_attr((string) ($u['primary_email'] ?? '')); ?>" data-action-type="reset_password">Reset Password</button>
                            <button type="button" class="mw-btn-xs mw-btn-secondary metis-workspace-security-open" data-user-id="<?php echo metis_escape_attr((string) $uid); ?>" data-user-email="<?php echo metis_escape_attr((string) ($u['primary_email'] ?? '')); ?>" data-action-type="revoke_sessions">Revoke Sessions</button>
                            <button type="button" class="mw-btn-xs mw-btn-secondary metis-workspace-security-open" data-user-id="<?php echo metis_escape_attr((string) $uid); ?>" data-user-email="<?php echo metis_escape_attr((string) ($u['primary_email'] ?? '')); ?>" data-action-type="<?php echo metis_escape_attr($is_suspended ? 'unsuspend_account' : 'suspend_account'); ?>"><?php echo metis_escape_html($is_suspended ? 'Unsuspend' : 'Suspend'); ?></button>
                            <?php if ($linked_pid === '') : ?>
                                <button type="button" class="mw-btn-xs metis-workspace-create-person-btn" data-workspace-user-id="<?php echo metis_escape_attr((string) $uid); ?>">Create Metis User</button>
                                <button type="button" class="mw-btn-xs mw-btn-danger metis-workspace-delete-user" data-workspace-user-id="<?php echo metis_escape_attr((string) $uid); ?>" data-user-email="<?php echo metis_escape_attr((string) ($u['primary_email'] ?? '')); ?>"<?php echo $is_protected ? ' hidden' : ''; ?>>Delete Account</button>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="metis-people-role-grid" style="margin-top:14px;">
        <section class="mw-premium-wrap">
            ...
            <section class="mw-premium-table metis-people-table metis-workspace-group-table">
                ...
                <div id="metis-workspace-group-rows">
                    ...
                    ?>
                        <div class="mw-premium-row metis-workspace-group-row<?php echo $can_manage ? ' is-clickable' : ''; ?>"<?php echo $can_manage ? ' data-group-id="' . metis_escape_attr((string) $gid) . '"' : ''; ?>>
                            <div class="mw-premium-cell"><strong><?php echo metis_escape_html((string) ($g['group_name'] ?? '')); ?></strong></div>
                            <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($g['group_email'] ?? '')); ?></div>
                            <div class="mw-premium-cell"><?php echo metis_escape_html((string) ($g['description'] ?? '')); ?></div>
                            <div class="mw-premium-cell"><?php echo metis_escape_html((string) (int) ($g['member_count'] ?? 0)); ?></div>
                            <div class="mw-premium-cell">
                                <span class="mw-chip<?php echo $sync_status === 'synced' ? ' mw-chip-success' : ''; ?>"><?php echo metis_escape_html($sync_status); ?></span>
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        <section class="mw-premium-wrap">
            ...
            <div class="metis-workspace-log-grid" data-sync-page="<?php echo metis_escape_attr((string) $sync_page); ?>" data-security-page="<?php echo metis_escape_attr((string) $security_page); ?>">
                <section class="mw-premium-table metis-people-table metis-workspace-log-table">
                    <div class="mw-premium-header">
                        <div class="mw-premium-cell">Sync Job</div>
                        <div class="mw-premium-cell">Entity</div>
                        <div class="mw-premium-cell">Status</div>
                        <div class="mw-premium-cell">Time</div>
                    </div>
                    <div id="metis-workspace-sync-log-rows">
                    <?php foreach ($sync_jobs as $j) : ?>
                        ...
                        $job_status_class = in_array($effective_job_status, ['completed', 'synced'], true) ? ' mw-chip-success' : ($effective_job_status === 'failed' ? ' mw-chip-danger' : '');
                        ...
                        <div class="mw-premium-row">
                            ...
                            <div class="mw-premium-cell"><span class="mw-chip<?php echo metis_escape_attr($job_status_class); ?>"><?php echo metis_escape_html($job_status_label); ?></span></div>
                            <div class="mw-premium-cell"><?php echo metis_escape_html($job_time); ?></div>
                        </div>
                    <?php endforeach; ?>
                    <?php if (empty($sync_jobs)) : ?>
                        <div class="mw-premium-row metis-workspace-empty-row">
                            <div class="mw-premium-cell">No sync jobs.</div>
                    ...
                    <div class="metis-workspace-log-pagination">
                        <span class="mw-muted" id="metis-workspace-sync-page-label">Page <?php echo metis_escape_html((string) $sync_page); ?> of <?php echo metis_escape_html((string) $sync_total_pages); ?></span>
                ...
                <section class="mw-premium-table metis-people-table metis-workspace-log-table">
                    <div class="mw-premium-header">
                        <div class="mw-premium-cell">Security Action</div>
                        <div class="mw-premium-cell">User</div>
                        <div class="mw-premium-cell">Status</div>
                        <div class="mw-premium-cell">Time</div>
                    </div>
                    <div id="metis-workspace-security-log-rows">
                    <?php foreach ($security_actions as $s) : ?>
                        ...
                        $action_status_class = $action_status === 'completed' ? ' mw-chip-success' : ($action_status === 'failed' ? ' mw-chip-danger' : '');
                        ?>
                        <div class="mw-premium-row">
                            <div class="mw-premium-cell">
                                ...
                                <?php if ($security_reason !== '') : ?>
                                    <div class="mw-muted"><?php echo metis_escape_html('Reason: ' . $security_reason); ?></div>
                                <?php endif; ?>
                            </div>
                            <div class="mw-premium-cell">
                                <?php
                            ...
                            <div class="mw-premium-cell"><span class="mw-chip<?php echo metis_escape_attr($action_status_class); ?>"><?php echo metis_escape_html($action_status_label); ?></span></div>
                            <div class="mw-premium-cell"><?php echo metis_escape_html($action_time); ?></div>
                        </div>
                    <?php endforeach; ?>
                    <?php if (empty($security_actions)) : ?>
                        <div class="mw-premium-row metis-workspace-empty-row">
                            <div class="mw-premium-cell">No security actions.</div>
                            <div class="mw-premium-cell">—</div>
                            <div class="mw-premium-cell">—</div>
                            <div class="mw-premium-cell">—</div>
                        </div>
                    ...
                    <div class="metis-workspace-log-pagination">
                        <span class="mw-muted" id="metis-workspace-security-page-label">Page <?php echo metis_escape_html((string) $security_page); ?> of <?php echo metis_escape_html((string) $security_total_pages); ?></span>
                        <div class="metis-workspace-log-pagination-actions">
    ...
    <div id="metis-workspace-user-modal" class="metis-contacts-modal" aria-hidden="true">
        <div class="metis-contacts-modal-inner metis-people-modal-inner">
            ...
            <form id="metis-workspace-user-form" class="metis-contact-form">
                ...
                <div class="metis-contact-field metis-contact-field-half"><label for="metis-workspace-user-secondary-email">Secondary Email</label><input id="metis-workspace-user-secondary-email" class="mw-input" type="email"></div>
                ...
                <div class="metis-contact-field metis-contact-field-half"><label><input type="checkbox" id="metis-workspace-user-hidden"> Hidden (service/internal account)</label></div>
        ...
        <div class="metis-contacts-modal-inner metis-people-modal-inner">
            ...
            <form id="metis-workspace-group-form" class="metis-contact-form">
                ...
                <div class="metis-people-tabs-nav" data-tabs-root>
                    ...
                    <button type="button" class="mw-btn-xs metis-tab-btn" data-tab-target="group-advanced">Advanced Settings</button>
                </div>
                ...
                <div class="metis-tab-panel" data-tab-panel="group-permissions">
                    <div class="metis-contact-field metis-contact-field-full">
                        ...
                        <div class="metis-workspace-template-row">
                            <select id="metis-workspace-group-perm-template" class="mw-select">
                                <option value="">Custom</option>
                                <option value="board">Board</option>
                                <option value="supplies">Supplies</option>
                            </select>
                            <button type="button" id="metis-workspace-group-perm-template-apply" class="mw-btn-xs">Apply Template</button>
                            <button type="button" id="metis-workspace-group-perm-template-capture" class="mw-btn-xs mw-btn-secondary">Capture Board + Supplies</button>
                        </div>
                        <div id="metis-workspace-group-perm-template-status" class="mw-muted"></div>
                    </div>
                ...
                <div class="metis-tab-panel" data-tab-panel="group-advanced">
                    <div class="metis-workspace-adv-tabs-nav">
                        <button type="button" class="mw-btn-xs metis-workspace-adv-tab-btn is-active" data-adv-tab-target="adv-general">General</button>
                        <button type="button" class="mw-btn-xs metis-workspace-adv-tab-btn" data-adv-tab-target="adv-moderation">Member Moderation</button>
                        <button type="button" class="mw-btn-xs metis-workspace-adv-tab-btn" data-adv-tab-target="adv-privacy">Member Privacy</button>
                        <button type="button" class="mw-btn-xs metis-workspace-adv-tab-btn" data-adv-tab-target="adv-posting">Posting Policies</button>
                        <button type="button" class="mw-btn-xs metis-workspace-adv-tab-btn" data-adv-tab-target="adv-email">Email Options</button>
                    </div>
                    ...
                    <div class="metis-workspace-adv-tab-panel is-active" data-adv-tab-panel="adv-general">
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-primary-language" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-reply-to" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <input id="metis-workspace-adv-custom-reply-to" class="mw-input" type="email" placeholder="group-owner@domain.org">
                        </div>
                        <div class="metis-contact-field metis-contact-field-half">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-message-display-font" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-default-sender" class="mw-select">
                    ...
                    <div class="metis-workspace-adv-tab-panel" data-adv-tab-panel="adv-moderation">
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-join" class="mw-select">
                                <option value="INVITED_CAN_JOIN">Invited Only</option>
                                <option value="CAN_REQUEST_TO_JOIN">Can Request</option>
                                <option value="ANYONE_CAN_JOIN">Anyone</option>
                            </select>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-leave-group" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-add" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-invite" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-approve-members" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-ban-users" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-moderate-members" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-message-moderation-level" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-spam-moderation-level" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-modify-members" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                    ...
                    <div class="metis-workspace-adv-tab-panel" data-adv-tab-panel="adv-privacy">
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-view-group" class="mw-select">
                                <option value="ALL_MEMBERS_CAN_VIEW">Members</option>
                                <option value="ALL_IN_DOMAIN_CAN_VIEW">Domain</option>
                                <option value="ANYONE_CAN_VIEW">Anyone</option>
                            </select>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-view-membership" class="mw-select">
                                <option value="ALL_MANAGERS_CAN_VIEW">Managers</option>
                                <option value="ALL_MEMBERS_CAN_VIEW">Members</option>
                                <option value="ALL_IN_DOMAIN_CAN_VIEW">Domain</option>
                                <option value="ANYONE_CAN_VIEW">Anyone</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-discover-group" class="mw-select">
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-contact-owner" class="mw-select">
                    ...
                    <div class="metis-workspace-adv-tab-panel" data-adv-tab-panel="adv-posting">
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-post-message" class="mw-select">
                                <option value="NONE_CAN_POST">No One</option>
                                <option value="ALL_MANAGERS_CAN_POST">Managers</option>
                                <option value="ALL_MEMBERS_CAN_POST">Members</option>
                                <option value="ALL_IN_DOMAIN_CAN_POST">Domain</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-approve-messages" class="mw-select">
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="ALL_MANAGERS_CAN_APPROVE">Managers</option>
                                <option value="ALL_MEMBERS_CAN_APPROVE">Members</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-moderate-content" class="mw-select">
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-assist-content" class="mw-select">
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-delete-any-post" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-delete-topics" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-lock-topics" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-hide-abuse" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                        ...
                        <div class="metis-contact-field metis-contact-field-half">
                            ...
                            <select id="metis-workspace-adv-who-can-make-topics-sticky" class="mw-select">
                                <option value="OWNERS_AND_MANAGERS">Owners + Managers</option>
                                <option value="OWNERS_ONLY">Owners Only</option>
                                <option value="ALL_MEMBERS">All Members</option>
                                <option value="NONE">No One</option>
                    ...
                    <div class="metis-workspace-adv-tab-panel" data-adv-tab-panel="adv-email">
                        ...
                        <div class="metis-contact-field metis-contact-field-full">
                            ...
                            <textarea id="metis-workspace-adv-default-message-deny-text" class="mw-input" rows="3"></textarea>
                        </div>
                        <div class="metis-contact-field metis-contact-field-half">
                        ...
                        <div class="metis-contact-field metis-contact-field-full">
                            ...
                            <textarea id="metis-workspace-adv-custom-footer-text" class="mw-input" rows="3"></textarea>
                        </div>
                    </div>
                </div>
                <div class="metis-contact-actions">
