...
<div class="metis-people-detail" data-can-manage="<?php echo metis_escape_attr( $can_manage ? '1' : '0' ); ?>">
    ...
    <div class="metis-people-detail-header">
        <div>
            <h1 class="mw-page-title"><?php echo metis_escape_html( $is_new ? 'Add Person' : ( $full_name !== '' ? $full_name : $display_name ) ); ?></h1>
            <p class="mw-subtitle"><?php echo metis_escape_html( $is_new ? 'Create a new Metis person profile and assign access.' : 'PID: ' . (string) ( $person['pid'] ?? '' ) ); ?></p>
        </div>
        <div class="metis-top-actions">
            <a href="<?php echo metis_escape_url( metis_people_people_list_url() ); ?>" class="mw-btn mw-btn-ghost">Back to People</a>
        </div>
    </div>
    ...
    <div class="metis-people-person-grid">
        ...
        <div class="metis-people-profile-card">
            ...
            <div class="metis-people-profile-actions">
                <?php if ( $linked_donor_id !== '' ) : ?>
                    <a class="mw-btn mw-btn-ghost" style="font-size:13px;padding:6px 10px;" href="<?php echo metis_escape_url( $donor_profile_url ); ?>">Open Donor Profile</a>
                <?php endif; ?>
                <?php if ( $can_manage && ! $is_new && ! empty( $person['pid'] ) ) : ?>
                    <button type="button" class="mw-btn mw-btn-danger" style="font-size:13px;padding:6px 10px;" id="metis-people-offboard-btn" data-pid="<?php echo metis_escape_attr( (string) $person['pid'] ); ?>">Run Offboarding</button>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="metis-people-tab-content">
            ...
            <form id="metis-people-detail-form" class="metis-contact-form">
                ...
                <div class="metis-contact-field metis-contact-field-half">
                    ...
                    <input id="metis-people-first-name" class="mw-input" type="text" value="<?php echo metis_escape_attr( $first_name ); ?>" <?php disabled( ! $can_manage ); ?>>
                </div>

                <div class="metis-contact-field metis-contact-field-half">
                    <label for="metis-people-last-name">Last Name</label>
                    <input id="metis-people-last-name" class="mw-input" type="text" value="<?php echo metis_escape_attr( $last_name ); ?>" <?php disabled( ! $can_manage ); ?>>
                </div>

                <div class="metis-contact-field metis-contact-field-half">
                    <label for="metis-people-name">Display Name</label>
                    <input id="metis-people-name" class="mw-input" type="text" value="<?php echo metis_escape_attr( $display_name ); ?>" <?php disabled( ! $can_manage ); ?> required>
                </div>

                <div class="metis-contact-field metis-contact-field-half">
                    <label for="metis-people-email">Email</label>
                    <input id="metis-people-email" class="mw-input" type="email" value="<?php echo metis_escape_attr( $person_email ); ?>" <?php disabled( ! $can_manage ); ?> required>
                </div>
                ...
                <div class="metis-contact-field metis-contact-field-half">
                    ...
                    <input id="metis-people-linked-donor-id" class="mw-input" type="text" value="<?php echo metis_escape_attr( $linked_donor_id ); ?>" placeholder="Search donor by name, email, or ID" list="metis-people-donor-list" autocomplete="off" <?php disabled( ! $can_manage ); ?>>
                    <datalist id="metis-people-donor-list"></datalist>
                    <div id="metis-people-linked-donor-name" class="mw-muted"><?php echo metis_escape_html( $linked_donor_name ); ?></div>
                </div>
                ...
                <div class="metis-contact-field metis-contact-field-full">
                    <details>
                        ...
                        <div class="metis-contact-form" style="margin-top:10px;">
                            <div class="metis-contact-field metis-contact-field-half">
                                <label for="metis-people-manager-pid">Manager PID</label>
                                <input id="metis-people-manager-pid" class="mw-input" type="text" value="<?php echo metis_escape_attr( $manager_pid ); ?>" <?php disabled( ! $can_manage ); ?>>
                            </div>

                            <div class="metis-contact-field metis-contact-field-half">
                                <label for="metis-people-department">Department</label>
                                <input id="metis-people-department" class="mw-input" type="text" value="<?php echo metis_escape_attr( $department ); ?>" <?php disabled( ! $can_manage ); ?>>
                            </div>

                            <div class="metis-contact-field metis-contact-field-half">
                                <label for="metis-people-board-term-start">Board Term Start</label>
                                <input id="metis-people-board-term-start" class="mw-input" type="date" value="<?php echo metis_escape_attr( $board_term_start ); ?>" <?php disabled( ! $can_manage ); ?>>
                            </div>

                            <div class="metis-contact-field metis-contact-field-half">
                                <label for="metis-people-board-term-end">Board Term End</label>
                                <input id="metis-people-board-term-end" class="mw-input" type="date" value="<?php echo metis_escape_attr( $board_term_end ); ?>" <?php disabled( ! $can_manage ); ?>>
                            </div>

                            <div class="metis-contact-field metis-contact-field-half">
                                <label for="metis-people-volunteer-area">Volunteer Area</label>
                                <input id="metis-people-volunteer-area" class="mw-input" type="text" value="<?php echo metis_escape_attr( $volunteer_area ); ?>" <?php disabled( ! $can_manage ); ?>>
                            </div>
                        </div>
                    </details>
                </div>
                ...
                <div class="metis-contact-field metis-contact-field-half" id="metis-people-board-position-wrap" <?php if ( empty( $person['is_board'] ) ) : ?>hidden<?php endif; ?>>
                    <label for="metis-people-board-position">Board Position</label>
                    <select id="metis-people-board-position" class="mw-select" <?php disabled( ! $can_manage ); ?>>
                ...
                <div class="metis-contact-field metis-contact-field-half" id="metis-people-staff-position-wrap" <?php if ( empty( $person['is_staff'] ) ) : ?>hidden<?php endif; ?>>
                    <label for="metis-people-staff-position">Staff Position</label>
                    <select id="metis-people-staff-position" class="mw-select" <?php disabled( ! $can_manage ); ?>>
                ...
                <div class="metis-contact-field metis-contact-field-half" id="metis-people-volunteer-position-wrap" <?php if ( empty( $person['is_volunteer'] ) ) : ?>hidden<?php endif; ?>>
                    <label for="metis-people-volunteer-position">Volunteer Position</label>
                    <select id="metis-people-volunteer-position" class="mw-select" <?php disabled( ! $can_manage ); ?>>
                ...
                <?php if ( $can_manage ) : ?>
                    <div class="metis-contact-actions">
                        <a href="<?php echo metis_escape_url( metis_people_people_list_url() ); ?>" class="mw-btn mw-btn-ghost">Cancel</a>
                            ...
                            <div class="metis-people-role-grid" id="metis-people-role-checkboxes">
                                <?php foreach ( $metis_roles as $r ) : ?>
                                    ...
                                    <div class="metis-people-role-row">
                                        ...
                                        <select class="mw-select metis-role-window-preset" data-role-key="<?php echo metis_escape_attr( $role_key ); ?>" <?php disabled( ! $can_manage ); ?>>
                                            <option value="">Custom</option>
                                            <option value="always">Always</option>
                                            <option value="30d">30 days</option>
                                            <option value="90d">90 days</option>
                                        </select>
                                        <input type="datetime-local" class="mw-input metis-role-start" data-role-key="<?php echo metis_escape_attr( $role_key ); ?>" value="<?php echo metis_escape_attr( $start_val ); ?>" <?php disabled( ! $can_manage ); ?>>
                                        <input type="datetime-local" class="mw-input metis-role-end" data-role-key="<?php echo metis_escape_attr( $role_key ); ?>" value="<?php echo metis_escape_attr( $end_val ); ?>" <?php disabled( ! $can_manage ); ?>>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                            ...
                            <div class="metis-people-check-grid">
                                <?php if ( ! empty( $effective_permissions ) ) : ?>
                                    <?php foreach ( $effective_permissions as $perm ) : ?>
                                        <span class="mw-chip"><?php echo metis_escape_html( (string) ( $perm['permission_key'] ?? '' ) ); ?></span>
                                    <?php endforeach; ?>
                                <?php else : ?>
                        ...
                        <div class="metis-contact-field metis-contact-field-full">
                            ...
                            <div class="metis-chip-wrap" id="metis-people-drive-folder-wrap">
                                <?php if ( $drive_folder_id !== '' ) : ?>
                                    <span class="mw-chip" id="metis-people-drive-folder-name"><?php echo metis_escape_html( $drive_folder_name !== '' ? $drive_folder_name : $drive_folder_id ); ?></span>
                                    <?php if ( $drive_folder_url !== '' ) : ?>
                                        <a id="metis-people-drive-folder-open" class="mw-btn-xs" href="<?php echo metis_escape_url( $drive_folder_url ); ?>">Open in Drive</a>
                                    <?php endif; ?>
                                <?php else : ?>
                                    ...
                                    <div class="metis-chip-wrap">
                                        <?php if ( ! empty( $workspace_linked_roles ) ) : ?>
                                            <?php foreach ( $workspace_linked_roles as $workspace_role_key ) : ?>
                                                ...
                                                ?>
                                                <span class="mw-chip"><?php echo metis_escape_html( $workspace_role_label ); ?></span>
                                            <?php endforeach; ?>
                                        <?php else : ?>
                                ...
                                <?php if ( ! empty( $person_passkey_rows ) ) : ?>
                                    <?php foreach ( $person_passkey_rows as $pk ) : ?>
                                        <div class="metis-people-mini-item">
                                            ...
                                            <div class="mw-muted">Created: <?php echo metis_escape_html( (string) ( $pk['created_at'] ?? '' ) ); ?><?php echo ! empty( $pk['last_used_at'] ) ? ' | Last used: ' . metis_escape_html( (string) $pk['last_used_at'] ) : ''; ?></div>
                                            <?php if ( $can_manage && empty( $pk['revoked_at'] ) ) : ?>
                                                <div class="metis-people-mini-actions">
                                                    <button type="button" class="mw-btn-xs mw-btn-danger metis-passkey-revoke" data-id="<?php echo metis_escape_attr( (string) ( $pk['id'] ?? '' ) ); ?>">Revoke</button>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; ?>
                            ...
                            <?php foreach ( $person_lifecycle_tasks as $task_row ) : ?>
                                <div class="metis-people-mini-item">
                                    ...
                                    <?php if ( $can_manage && (string) ( $task_row['status'] ?? '' ) !== 'completed' ) : ?>
                                        <div class="metis-people-mini-actions">
                                            <button type="button" class="mw-btn-xs metis-task-complete" data-id="<?php echo metis_escape_attr( (string) ( $task_row['id'] ?? '' ) ); ?>">Mark Complete</button>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                        ...
                        <?php if ( ! empty( $person_activity_rows ) ) : ?>
                            <?php foreach ( $person_activity_rows as $row ) : ?>
                                <div class="metis-people-mini-item">
                                    ...
                                    <div class="mw-muted"><?php echo metis_escape_html( (string) ( $row['created_at'] ?? '' ) ); ?></div>
                                </div>
                            <?php endforeach; ?>
                        <?php else : ?>
                        ...
                        <?php if ( ! empty( $person_request_rows ) ) : ?>
                            <?php foreach ( $person_request_rows as $row ) : ?>
                                <div class="metis-people-mini-item">
                                    ...
                                    <div class="mw-muted"><?php echo metis_escape_html( (string) ( $row['reason'] ?? '' ) ); ?></div>
                                </div>
                            <?php endforeach; ?>
                        <?php else : ?>
                        ...
                        <?php if ( ! empty( $person_document_rows ) ) : ?>
                            <?php foreach ( $person_document_rows as $row ) : ?>
                                <div class="metis-people-mini-item">
                                    ...
                                    <?php if ( $can_manage ) : ?>
                                        <div class="metis-people-mini-actions">
                                            <button type="button" class="mw-btn-xs mw-btn-danger metis-doc-delete" data-id="<?php echo metis_escape_attr( (string) ( $row['id'] ?? '' ) ); ?>">Delete</button>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                        ...
                        <?php if ( ! empty( $person_emergency_rows ) ) : ?>
                            <?php foreach ( $person_emergency_rows as $row ) : ?>
                                <div class="metis-people-mini-item">
                                    ...
                                    <div class="mw-muted"><?php echo metis_escape_html( (string) ( $row['reason'] ?? '' ) ); ?> <?php echo ! empty( $row['revoked_at'] ) ? '(Revoked)' : ''; ?></div>
                                    <?php if ( $can_manage && empty( $row['revoked_at'] ) ) : ?>
                                        <div class="metis-people-mini-actions">
                                            <button type="button" class="mw-btn-xs mw-btn-danger metis-emergency-revoke" data-id="<?php echo metis_escape_attr( (string) ( $row['id'] ?? '' ) ); ?>">Revoke</button>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
...
<div id="metis-people-drive-picker-modal" class="metis-contacts-modal" aria-hidden="true">
    <div class="metis-contacts-modal-inner metis-people-modal-inner metis-people-drive-picker-inner">
        ...
        <div class="metis-contact-form">
            <div class="metis-contact-field metis-contact-field-full">
                <div class="mw-muted" id="metis-people-drive-picker-subtitle">Choose a folder from the <?php echo metis_escape_html( $drive_users_root_name ); ?> container.</div>
            </div>
            <div class="metis-contact-field metis-contact-field-full">
                <div class="metis-people-drive-picker-toolbar">
                    ...
                    <div id="metis-people-drive-picker-path" class="mw-chip"><?php echo metis_escape_html( $drive_users_root_name ); ?></div>
                </div>
            </div>
            <div class="metis-contact-field metis-contact-field-full">
...
<div id="metis-people-offboard-modal" class="metis-contacts-modal" aria-hidden="true">
    <div class="metis-contacts-modal-inner metis-people-modal-inner">
        ...
        <div class="metis-contact-actions">
            ...
            <button type="button" id="metis-people-offboard-confirm" class="mw-btn mw-btn-danger" data-pid="<?php echo metis_escape_attr( (string) $person['pid'] ); ?>">Run Offboarding</button>
        </div>
    </div>
</div>
<?php endif; ?>
...
<div id="metis-people-avatar-modal" class="metis-contacts-modal" aria-hidden="true">
    <div class="metis-contacts-modal-inner metis-people-modal-inner">
        ...
        <div class="metis-contact-form">
            ...
            <div class="metis-contact-field metis-contact-field-full">
                <div class="mw-muted">Drag the photo inside the circle and use the zoom control or mouse wheel to crop it.</div>
            </div>
            <div class="metis-contact-field metis-contact-field-full">
