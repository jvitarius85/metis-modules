...
<div class="metis-people-ops">
    ...
    <h1 class="mw-page-title"><?php echo metis_escape_html( metis_current_module_view_title( 'Bulk Actions' ) ); ?></h1>
    <p class="mw-subtitle">Run bulk updates across roles, position/type, Workspace groups, and Stripe access.</p>
    ...
    <div class="metis-people-bulk-layout">
        <aside class="mw-premium-wrap metis-people-bulk-sidebar">
            ...
            <div class="metis-contact-field metis-contact-field-full">
                ...
                <input id="metis-bulk-person-search" type="text" class="mw-input" placeholder="Name, PID, email">
            </div>
            <div class="metis-people-bulk-sidebar-actions">
                <button type="button" id="metis-bulk-select-all" class="mw-btn mw-btn-secondary">Select All Visible</button>
                <button type="button" id="metis-bulk-clear-all" class="mw-btn mw-btn-ghost">Clear</button>
            </div>
            <div class="mw-muted metis-people-bulk-selected">Selected: <strong id="metis-bulk-selected-count">0</strong></div>
                ...
                ?>
                    <label class="metis-people-bulk-person-item" data-search="<?php echo metis_escape_attr($search_blob); ?>">
                        ...
                        <span class="metis-people-bulk-person-text">
                            ...
                            <span class="mw-muted"><?php echo metis_escape_html($person_pid); ?></span>
                        </span>
                    </label>
                <?php endforeach; ?>
            </div>
        ...
        <div class="metis-people-bulk-main">
            <section class="mw-premium-wrap metis-people-bulk-rowbox">
                <form id="metis-bulk-role-form" class="metis-people-bulk-rowform">
                    ...
                    <div class="metis-people-bulk-rowfields">
                        <div class="metis-people-bulk-field"><label for="metis-bulk-action">Action</label><select id="metis-bulk-action" class="mw-select"><option value="assign">Assign</option><option value="remove">Remove</option></select></div>
                        <div class="metis-people-bulk-field"><label for="metis-bulk-role">Role</label><select id="metis-bulk-role" class="mw-select"><option value="">Select role</option><?php foreach($roles as $role): ?><option value="<?php echo metis_escape_attr((string)$role['role_key']); ?>"><?php echo metis_escape_html((string)$role['role_name']); ?></option><?php endforeach; ?></select></div>
                    </div>
                    <button type="submit" class="mw-btn">Apply</button>
                </form>
            </section>
            ...
            <section class="mw-premium-wrap metis-people-bulk-rowbox">
                <form id="metis-bulk-profile-form" class="metis-people-bulk-rowform">
                    ...
                    <div class="metis-people-bulk-rowfields">
                        <div class="metis-people-bulk-field"><label for="metis-bulk-position-type">Position Type</label><select id="metis-bulk-position-type" class="mw-select"><option value="">Select type</option><option value="board">Board</option><option value="staff">Staff</option><option value="volunteer">Volunteer</option><option value="clear">Clear Position</option></select></div>
                        <div class="metis-people-bulk-field"><label for="metis-bulk-position-value">Position</label><select id="metis-bulk-position-value" class="mw-select"><option value="">Select position</option><?php foreach ($positions as $position) : $group_key = metis_key_clean((string) ($position['group_key'] ?? '')); $position_label = trim((string) ($position['position_label'] ?? '')); if ($position_label === '' || !in_array($group_key, ['board', 'staff', 'volunteer'], true)) continue; ?><option value="<?php echo metis_escape_attr($position_label); ?>" data-group="<?php echo metis_escape_attr($group_key); ?>"><?php echo metis_escape_html(ucfirst($group_key) . ': ' . $position_label); ?></option><?php endforeach; ?></select></div>
                    </div>
                    <button type="submit" class="mw-btn">Apply</button>
                </form>
            </section>
                ...
                <form id="metis-bulk-workspace-user-form" class="metis-people-bulk-rowform">
                    ...
                    <div class="metis-people-bulk-rowfields">
                        <div class="metis-people-bulk-field">
                            ...
                            <select id="metis-bulk-workspace-user-action" class="mw-select">
                        ...
                        <div class="metis-people-bulk-field" id="metis-bulk-org-unit-field">
                            ...
                            <select id="metis-bulk-org-unit" class="mw-select">
                                <option value="/">/</option>
            ...
            <section class="mw-premium-wrap metis-people-bulk-rowbox">
                <form id="metis-bulk-workspace-group-form" class="metis-people-bulk-rowform">
                    ...
                    <div class="metis-people-bulk-rowfields metis-people-bulk-rowfields-3">
                        <div class="metis-people-bulk-field"><label for="metis-bulk-workspace-group-action">Action</label><select id="metis-bulk-workspace-group-action" class="mw-select"><option value="assign">Assign</option><option value="remove">Remove</option></select></div>
                        <div class="metis-people-bulk-field"><label for="metis-bulk-workspace-group">Workspace Group</label><select id="metis-bulk-workspace-group" class="mw-select"><option value="">Select group</option><?php foreach($workspace_groups as $group): ?><option value="<?php echo metis_escape_attr((string)$group['group_email']); ?>"><?php echo metis_escape_html((string)$group['group_name'] . ' (' . (string)$group['group_email'] . ')'); ?></option><?php endforeach; ?></select></div>
                        <div class="metis-people-bulk-field"><label for="metis-bulk-workspace-member-role">Member Role</label><select id="metis-bulk-workspace-member-role" class="mw-select"><option value="member">Member</option><option value="manager">Manager</option><option value="owner">Owner</option></select></div>
                    </div>
                    <button type="submit" class="mw-btn">Apply</button>
                </form>
            </section>
            ...
            <section class="mw-premium-wrap metis-people-bulk-rowbox">
                <form id="metis-bulk-stripe-role-form" class="metis-people-bulk-rowform">
                    ...
                    <div class="metis-people-bulk-rowfields">
                        <div class="metis-people-bulk-field"><label for="metis-bulk-stripe-action">Action</label><select id="metis-bulk-stripe-action" class="mw-select"><option value="set">Set Role</option><option value="clear">Clear Role</option></select></div>
                        <div class="metis-people-bulk-field"><label for="metis-bulk-stripe-role">Stripe Role</label><select id="metis-bulk-stripe-role" class="mw-select"><option value="">No Stripe Access</option><?php foreach($stripe_roles as $role): ?><option value="<?php echo metis_escape_attr((string)$role['role_key']); ?>"><?php echo metis_escape_html((string)$role['role_name']); ?></option><?php endforeach; ?></select></div>
                    </div>
                    <button type="submit" class="mw-btn">Apply</button>
                </form>
            </section>
            ...
            <section class="mw-premium-wrap metis-people-bulk-rowbox">
                <form id="metis-bulk-offboard-form" class="metis-people-bulk-rowform">
                    ...
                    <button type="submit" class="mw-btn mw-btn-danger">Apply</button>
                </form>
            </section>
            <?php endif; ?>
        </div>
