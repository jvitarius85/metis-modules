...
function metis_security_enforce_ajax_request(): void {
    ...
    $ajax_action = isset( $_REQUEST['action'] ) ? sanitize_key( metis_runtime_unslash( $_REQUEST['action'] ) ) : '';
    ...
    if ( $module === null ) {
        metis_runtime_send_json_error( [ 'message' => 'Unregistered enclave action.' ], 403 );
    }
