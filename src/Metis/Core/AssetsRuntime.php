...
metis_on('metis_assets_enqueue', function () {
    ...
    $domain = sanitize_key( (string) metis_get_query_var( 'metis_domain' ) );
    ...
    metis_runtime_register_style_alias(
        ...
        metis_runtime_asset_url(
            'theme.css',
            sanitize_key( (string) metis_get_query_var( 'metis_domain' ) ),
            sanitize_key( (string) metis_get_query_var( 'metis_view' ) )
        ),
        [],
        $asset_version
    );
...
", $theme_lines ) . "
    ...
    metis_runtime_localize_script( 'metis-core', 'metisAjax', [
        ...
        'site_url'      => function_exists( 'metis_home_url' ) ? rtrim( (string) metis_home_url( '/' ), '/' ) : rtrim( (string) get_home_url(), '/' ),
    ] );
    ...
    if ( $domain === 'website' && $view === 'editor' ) {
        $editor_style_handle = 'metis-editor-block-editor';
        $editor_script_handle = 'metis-editor-block-editor';
        $props_script_handle = 'metis-editor-properties-panel';
        $builder_style_handle = 'metis-editor-page-builder';
        $builder_script_handle = 'metis-editor-page-builder';
        $launcher_script_handle = 'metis-editor-shell-launcher';

        metis_runtime_enqueue_style(
            $editor_style_handle,
            $asset_base_url . 'assets/js/editor/block-editor.css',
            [ 'metis-core' ],
            (string) @filemtime( METIS_ROOT . '/assets/js/editor/block-editor.css' ) ?: $asset_version
        );

        metis_runtime_enqueue_script(
            $editor_script_handle,
            $asset_base_url . 'assets/js/editor/block-editor.js',
            [ 'metis-core' ],
            (string) @filemtime( METIS_ROOT . '/assets/js/editor/block-editor.js' ) ?: $asset_version,
            true
        );

        metis_runtime_enqueue_script(
            $props_script_handle,
            $asset_base_url . 'assets/js/editor/properties-panel.js',
            [ 'metis-core', $editor_script_handle ],
            (string) @filemtime( METIS_ROOT . '/assets/js/editor/properties-panel.js' ) ?: $asset_version,
            true
        );

        metis_runtime_enqueue_style(
            $builder_style_handle,
            $asset_base_url . 'assets/js/editor/page-builder.css',
            [ 'metis-core', $editor_style_handle ],
            (string) @filemtime( METIS_ROOT . '/assets/js/editor/page-builder.css' ) ?: $asset_version
        );

        metis_runtime_enqueue_script(
            $builder_script_handle,
            $asset_base_url . 'assets/js/editor/page-builder.js',
            [ 'metis-core', $editor_script_handle, $props_script_handle ],
            (string) @filemtime( METIS_ROOT . '/assets/js/editor/page-builder.js' ) ?: $asset_version,
            true
        );

        metis_runtime_enqueue_script(
            $launcher_script_handle,
            $asset_base_url . 'assets/js/editor/editor-shell-launcher.js',
            [ 'metis-core', $builder_script_handle ],
            (string) @filemtime( METIS_ROOT . '/assets/js/editor/editor-shell-launcher.js' ) ?: $asset_version,
            true
        );

        metis_runtime_localize_script( $builder_script_handle, 'metisWebsiteAjax', [
            'ajax_url' => metis_ajax_endpoint_url(),
