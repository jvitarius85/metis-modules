...
function metis_router_handle_runtime_asset_request( Metis_Http_Request $request ): Metis_Http_Response {
    ...
    $batch_asset_map = [
        'batch-entry.js' => [
            METIS_ROOT . '/assets/js/core/batch-entry/batch-entry.validation.js',
            METIS_ROOT . '/assets/js/core/batch-entry/batch-entry.totals.js',
            METIS_ROOT . '/assets/js/core/batch-entry/batch-entry.renderer.js',
            METIS_ROOT . '/assets/js/core/batch-entry/batch-entry.js',
        ],
        'batch-entry.css' => [
            METIS_ROOT . '/assets/css/core/batch-entry.css',
        ],
    ];
...
function metis_router_log_security_failure( Metis_Http_Request $request, string $code, int $status ): void {
    ...
    $input = $request->input();
    $token_fields = [ 'csrf_token', 'metis_action_nonce', '_wpnonce', 'security', '_ajax_nonce', 'nonce' ];
    $token_debug = [];
...
function metis_router_handle_batch_request( Metis_Http_Request $request ): Metis_Http_Response {
    require_once METIS_ROOT . '/src/Metis/Core/Api/Batch/BatchValidator.php';
    require_once METIS_ROOT . '/src/Metis/Core/Api/Batch/BatchProcessor.php';
    require_once METIS_ROOT . '/src/Metis/Core/Api/Batch/BatchResponse.php';
    require_once METIS_ROOT . '/src/Metis/Core/Api/Batch/BatchController.php';
