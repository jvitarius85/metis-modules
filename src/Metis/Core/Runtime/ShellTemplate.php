...
<header class="mw-topbar" id="mw-topbar">
    <div class="mw-topbar-left">
        <a class="mw-topbar-logo" href="<?php echo metis_escape_url( metis_portal_url() ); ?>" aria-label="<?php echo metis_escape_attr( metis_portal_name() ); ?>">
            <?php if ( $portal_logo_url !== '' ) : ?>
                <img src="<?php echo metis_escape_attr( $portal_logo_url ); ?>" alt="<?php echo metis_escape_attr( metis_portal_name() ); ?>" class="mw-topbar-logo-img">
            <?php else : ?>
                <span class="mw-topbar-logo-text"><?php echo metis_escape_html( metis_portal_name() ); ?></span>
            <?php endif; ?>
        </a>
        <?php if ( $domain !== '' ) : ?>
            <span class="mw-topbar-sep">|</span>
            <span class="mw-topbar-module"><?php echo metis_escape_html( $module_label ); ?></span>
        <?php endif; ?>
    </div>
    ...
    <div class="mw-topbar-right">
        <div class="mw-code-search" id="metis-code-search">
            ...
            <div class="mw-code-result" id="metis-code-result" style="display:none;" role="status" aria-live="polite"></div>
        </div>
        <div class="mw-topbar-controls">
            <div class="mw-help-actions">
                <div class="mw-quick-actions" id="mw-quick-actions">
                    <button
                        type="button"
                        class="mw-help-search-trigger"
                        id="mw-quick-actions-trigger"
                        aria-label="Open quick actions"
                        aria-haspopup="menu"
                        aria-expanded="false"
                        aria-controls="mw-quick-actions-panel"
                    >
                        Quick Actions
                    </button>
                    <div class="mw-quick-actions-panel" id="mw-quick-actions-panel" role="menu" aria-label="Quick actions" hidden>
                        <div id="mw-quick-actions-list" aria-label="Quick actions"></div>
                    </div>
                </div>
            ...
            <?php if ( $accessibility_ui_enabled ) : ?>
                <div class="mw-accessibility">
                    ...
                    <section class="mw-accessibility-panel" id="mw-accessibility-panel" hidden aria-labelledby="mw-accessibility-panel-title">
                        <div class="mw-accessibility-panel-header">
                            <h2 id="mw-accessibility-panel-title">Accessibility</h2>
...
<aside class="mw-sidebar" id="mw-sidebar" role="navigation" aria-label="Main navigation">
    <div class="mw-sidebar-top">
        <a class="mw-sidebar-item mw-sidebar-profile" href="<?php echo metis_escape_url( metis_portal_url( 'profile' ) ); ?>" data-tooltip="<?php echo metis_escape_attr( $user_name ); ?>">
            <span class="mw-sidebar-avatar-wrap">
                <img class="mw-sidebar-avatar" src="<?php echo metis_escape_url( (string) ( $user_avatar_payload['url'] ?? '' ) ); ?>" alt="<?php echo metis_escape_attr( $user_name !== '' ? $user_name : 'Profile' ); ?>">
            </span>
            <span class="mw-sidebar-label"><?php echo metis_escape_html( $user_name ); ?></span>
        </a>
    </div>
