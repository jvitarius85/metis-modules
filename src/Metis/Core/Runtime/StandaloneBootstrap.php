...
function metis_runtime_nonce_field( string $action = '', string $name = '_wpnonce' ): void {
    echo '<input type="hidden" name="' . esc_attr( $name ) . '" value="' . esc_attr( metis_runtime_create_nonce( $action ) ) . '">';
}
