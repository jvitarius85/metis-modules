...
1. The search request path was wrong for the new requirement.
   ...
   - Required path: `/enclave/help/search.php`
...
- Added `/enclave/help/search.php` with Secure Enclave enforcement
...
- Direct execution of `/enclave/help/search.php` returned JSON success for an authenticated request
- Direct execution of `/enclave/help/search.php` returned JSON `Authentication required.` for an unauthenticated request instead of a fatal
